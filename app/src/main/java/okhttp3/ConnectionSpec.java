...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m3386deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m3388deprecated_tlsVersions() {
        return tlsVersions();
    }
