...
public class XMLEventAllocatorBase implements XMLEventAllocator {
    ...
    public StartDocument allocateXMLDeclaration(XMLStreamReader xMLStreamReader) throws XMLStreamException {
        ...
        if (characterEncodingScheme != null && version != null && !zIsStandalone) {
            return this.factory.createStartDocument(characterEncodingScheme, version, zIsStandalone);
        }
    ...
    public XMLEvent allocate(XMLStreamReader xMLStreamReader) throws XMLStreamException {
        switch (xMLStreamReader.getEventType()) {
            ...
            case 10:
            default:
                throw new XMLStreamException(new StringBuffer("Unable to allocate event[").append(xMLStreamReader.getEventType()).append(" , ").append(ElementTypeNames.getEventTypeString(xMLStreamReader.getEventType())).append("]").toString());
            case 11:
