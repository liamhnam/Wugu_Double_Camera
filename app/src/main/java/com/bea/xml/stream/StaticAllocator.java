...
public class StaticAllocator implements XMLEventAllocator {
    ...
    ProcessingInstructionEvent f467pi = new ProcessingInstructionEvent();
    ...
    public ProcessingInstruction allocatePI(XMLStreamReader xMLStreamReader) throws XMLStreamException {
        this.f467pi.setTarget(xMLStreamReader.getPITarget());
        this.f467pi.setData(xMLStreamReader.getPIData());
        return this.f467pi;
    }
    ...
    public StartDocument allocateXMLDeclaration(XMLStreamReader xMLStreamReader) throws XMLStreamException {
        ...
        if (characterEncodingScheme != null && version != null && !zIsStandalone) {
            this.startDoc.setEncoding(characterEncodingScheme);
            this.startDoc.setVersion(version);
            this.startDoc.setStandalone(zIsStandalone);
            return this.startDoc;
        }
    ...
    public XMLEvent allocate(XMLStreamReader xMLStreamReader) throws XMLStreamException {
        switch (xMLStreamReader.getEventType()) {
            ...
            case 10:
            default:
                throw new XMLStreamException(new StringBuffer("Unable to allocate event[").append(ElementTypeNames.getEventTypeString(xMLStreamReader.getEventType())).append("]").toString());
            case 11:
