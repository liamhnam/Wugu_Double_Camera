...
public class SubReader extends ReaderDelegate {
    ...
    public static void print(XMLStreamReader xMLStreamReader, int i) throws XMLStreamException {
        System.out.print(new StringBuffer("[").append(i).append("]Sub: ").append(ElementTypeNames.getEventTypeString(xMLStreamReader.getEventType())).toString());
        if (xMLStreamReader.hasName()) {
            System.out.println(new StringBuffer("->").append(xMLStreamReader.getLocalName()).toString());
        } else if (xMLStreamReader.hasText()) {
            System.out.println(new StringBuffer("->[").append(xMLStreamReader.getText()).append("]").toString());
        } else {
            System.out.println();
        }
    }
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        while (mXParser.moveToStartElement()) {
            System.out.println(new StringBuffer("SE->").append(mXParser.getName()).toString());
