...
public final class CircularQueue extends AbstractCollection {
    ...
    private CircularQueue(CircularQueue circularQueue) {
        ...
        Object[] objArr = new Object[circularQueue.f470q.length];
        this.f470q = objArr;
        System.arraycopy(circularQueue.f470q, 0, objArr, 0, objArr.length);
    }
    ...
    private boolean expandQueue() {
        ...
        if (i4 != 0) {
            System.arraycopy(objArr, 0, this.f470q, i - i4, i4);
        }
        this.consumerIndex = 0;
    ...
    public Object peek() {
        ...
        return this.f470q[this.consumerIndex];
    }

    @Override
    public void clear() {
        Arrays.fill(this.f470q, (Object) null);
        this.size = 0;
        this.producerIndex = 0;
        this.consumerIndex = 0;
    }
    ...
    public String toString() {
        ...
        if (this.size > 0) {
            ...
            for (int i = 0; i < this.size; i++) {
                stringBuffer.append("\n\t");
                stringBuffer.append(this.f470q[(this.consumerIndex + i) & this.bitmask].toString());
            }
        }
    ...
    public Iterator iterator() {
        return new Iterator() {
            ...
            private final int f471ci;

            private int f472i;

            private final int f473pi;
            ...
            public Object next() {
                ...
                this.f474s = i - 1;
                Object[] objArr = CircularQueue.this.f470q;
                int i2 = this.f472i;
                Object obj = objArr[i2];
                this.f472i = (i2 + 1) & CircularQueue.this.bitmask;
                return obj;
            }
...

            {
                ...
                this.f471ci = i;
                this.f473pi = CircularQueue.this.producerIndex;
                this.f474s = CircularQueue.this.size;
                this.f472i = i;
            }

            private void checkForModification() {
                if (this.f471ci == CircularQueue.this.consumerIndex) {
                    if (this.f473pi != CircularQueue.this.producerIndex) {
