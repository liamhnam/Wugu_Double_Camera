...
public class XMLEventWriterBase implements XMLEventWriter, XMLEventConsumer {
    ...
    public void add(XMLEvent xMLEvent) throws XMLStreamException {
        switch (xMLEvent.getEventType()) {
            ...
            case 12:
            default:
                throw new XMLStreamException(new StringBuffer("Unable to add event[").append(ElementTypeNames.getEventTypeString(xMLEvent.getEventType())).append("]").toString());
            case 7:
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        while (xMLEventReaderBase.hasNext()) {
            XMLEvent xMLEventNextEvent = xMLEventReaderBase.nextEvent();
            System.out.println(new StringBuffer("about to add:[").append(xMLEventNextEvent).append("];").toString());
            xMLEventWriterBase.add(xMLEventNextEvent);
        }
