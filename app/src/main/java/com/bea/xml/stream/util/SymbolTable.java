...
public class SymbolTable {
    ...
    public String toString() {
        ...
        String string = "";
        while (it.hasNext()) {
            string = new StringBuffer().append(string).append((Symbol) it.next()).append("\n").toString();
        }
        return string;
    }
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        System.out.println(new StringBuffer("1 x:").append(symbolTable.get("x")).toString());
        System.out.println(new StringBuffer("1 y:").append(symbolTable.get("y")).toString());
        symbolTable.openScope();
        ...
        System.out.println(new StringBuffer("3 x:").append(symbolTable.get("x")).toString());
        symbolTable.closeScope();
        System.out.println(new StringBuffer("2 x:").append(symbolTable.get("x")).toString());
        System.out.println(new StringBuffer("2 y:").append(symbolTable.get("y")).toString());
