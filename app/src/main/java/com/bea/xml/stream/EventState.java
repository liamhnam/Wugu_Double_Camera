...
public class EventState {
    ...
    public String toString() {
        ...
        stringBuffer.append(new StringBuffer("[").append(ElementTypeNames.getEventTypeString(this.type)).append("]").toString());
        if (this.qname != null) {
            stringBuffer.append(new StringBuffer("[name='").append(this.qname).append("']").toString());
        }
        ...
        if (this.data != null) {
            stringBuffer.append(new StringBuffer(",data=[").append(this.data).append("]").toString());
        }
        if (this.extraData != null) {
            stringBuffer.append(new StringBuffer(",extradata=[").append(this.extraData).append("]").toString());
        }
