...
public final class JobTriggersSupported implements AttributeCollection {
    ...
    public final JobTriggersSupported copy(KeywordOrName presetName2) {
        return new JobTriggersSupported(presetName2);
    }

    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof JobTriggersSupported) && Intrinsics.areEqual(this.presetName, ((JobTriggersSupported) other).presetName);
        }
        return true;
    }
    ...
    public JobTriggersSupported(KeywordOrName keywordOrName) {
        this.presetName = keywordOrName;
    }

    public JobTriggersSupported(KeywordOrName keywordOrName, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            keywordOrName = null;
        }
        this(keywordOrName);
    ...
    @Metadata(m1291bv = {1, 0, 3}, m1292d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001a\u0010\f\u001a\u00020\u00022\u0010\u0010\r\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u000f0\u000eH\u0016R\u0016\u0010\u0004\u001a\u00020\u00008\u0006X\u0087\u0004¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00020\u0007X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0010\u0010\n\u001a\u00020\u000b8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m1293d2 = {"Lcom/hp/jipp/model/JobTriggersSupported$Companion;", "Lcom/hp/jipp/encoding/AttributeCollection$Converter;", "Lcom/hp/jipp/model/JobTriggersSupported;", "()V", "Types", "getTypes$annotations", "cls", "Ljava/lang/Class;", "getCls", "()Ljava/lang/Class;", "presetName", "Lcom/hp/jipp/encoding/KeywordOrNameType;", "convert", "attributes", "", "Lcom/hp/jipp/encoding/Attribute;", "jipp-core"}, m1294k = 1, m1295mv = {1, 4, 0})
    public static final class Companion implements AttributeCollection.Converter<JobTriggersSupported> {
        ...
        @Override
        public JobTriggersSupported convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            return new JobTriggersSupported((KeywordOrName) extractOne(attributes, JobTriggersSupported.presetName));
        }

        @Override
        public Class<JobTriggersSupported> getCls() {
            return JobTriggersSupported.cls;
        }
    }
    ...
    static {
        ...
        INSTANCE = companion;
        cls = JobTriggersSupported.class;
        Types = companion;
        presetName = new KeywordOrNameType("preset-name");
    }

    public String toString() {
        return "JobTriggersSupported(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
