...
public final class PrintAccuracySupported implements AttributeCollection {
    ...
    public static PrintAccuracySupported copy$default(PrintAccuracySupported printAccuracySupported, String str, Integer num, Integer num2, Integer num3, int i, Object obj) {
        if ((i & 1) != 0) {
            str = printAccuracySupported.accuracyUnits;
        }
        if ((i & 2) != 0) {
            num = printAccuracySupported.xAccuracy;
        }
        if ((i & 4) != 0) {
            num2 = printAccuracySupported.yAccuracy;
        }
        if ((i & 8) != 0) {
            num3 = printAccuracySupported.zAccuracy;
        }
        return printAccuracySupported.copy(str, num, num2, num3);
    }
    ...
    public final PrintAccuracySupported copy(String accuracyUnits2, Integer xAccuracy2, Integer yAccuracy2, Integer zAccuracy2) {
        return new PrintAccuracySupported(accuracyUnits2, xAccuracy2, yAccuracy2, zAccuracy2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PrintAccuracySupported)) {
            return false;
        }
        PrintAccuracySupported printAccuracySupported = (PrintAccuracySupported) other;
        return Intrinsics.areEqual(this.accuracyUnits, printAccuracySupported.accuracyUnits) && Intrinsics.areEqual(this.xAccuracy, printAccuracySupported.xAccuracy) && Intrinsics.areEqual(this.yAccuracy, printAccuracySupported.yAccuracy) && Intrinsics.areEqual(this.zAccuracy, printAccuracySupported.zAccuracy);
    }
    ...
    public PrintAccuracySupported(String str, Integer num, Integer num2, Integer num3) {
    ...
    public PrintAccuracySupported(String str, Integer num, Integer num2, Integer num3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            str = null;
        }
        if ((i & 2) != 0) {
    ...
    @Metadata(m1291bv = {1, 0, 3}, m1292d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001a\u0010\u0010\u001a\u00020\u00022\u0010\u0010\u0011\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00130\u0012H\u0016R\u0016\u0010\u0004\u001a\u00020\u00008\u0006X\u0087\u0004¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0003R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00020\tX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0010\u0010\f\u001a\u00020\r8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u00020\r8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000f\u001a\u00020\r8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, m1293d2 = {"Lcom/hp/jipp/model/PrintAccuracySupported$Companion;", "Lcom/hp/jipp/encoding/AttributeCollection$Converter;", "Lcom/hp/jipp/model/PrintAccuracySupported;", "()V", "Types", "getTypes$annotations", "accuracyUnits", "Lcom/hp/jipp/encoding/KeywordType;", "cls", "Ljava/lang/Class;", "getCls", "()Ljava/lang/Class;", "xAccuracy", "Lcom/hp/jipp/encoding/IntType;", "yAccuracy", "zAccuracy", "convert", "attributes", "", "Lcom/hp/jipp/encoding/Attribute;", "jipp-core"}, m1294k = 1, m1295mv = {1, 4, 0})
    public static final class Companion implements AttributeCollection.Converter<PrintAccuracySupported> {
        ...
        @Override
        public PrintAccuracySupported convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            return new PrintAccuracySupported((String) extractOne(attributes, PrintAccuracySupported.accuracyUnits), (Integer) extractOne(attributes, PrintAccuracySupported.xAccuracy), (Integer) extractOne(attributes, PrintAccuracySupported.yAccuracy), (Integer) extractOne(attributes, PrintAccuracySupported.zAccuracy));
        }

        @Override
        public Class<PrintAccuracySupported> getCls() {
            return PrintAccuracySupported.cls;
        }
    }
    ...
    static {
        ...
        INSTANCE = companion;
        cls = PrintAccuracySupported.class;
        Types = companion;
    ...
    public String toString() {
        return "PrintAccuracySupported(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
