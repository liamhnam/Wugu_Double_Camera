...
public final class ImpressionsCol implements AttributeCollection {
    ...
    public final ImpressionsCol copy(Integer blank2, Integer blankTwoSided2, Integer fullColor2, Integer fullColorTwoSided2, Integer highlightColor2, Integer highlightColorTwoSided2, Integer monochrome2, Integer monochromeTwoSided2) {
        return new ImpressionsCol(blank2, blankTwoSided2, fullColor2, fullColorTwoSided2, highlightColor2, highlightColorTwoSided2, monochrome2, monochromeTwoSided2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImpressionsCol)) {
            return false;
        }
        ImpressionsCol impressionsCol = (ImpressionsCol) other;
        return Intrinsics.areEqual(this.blank, impressionsCol.blank) && Intrinsics.areEqual(this.blankTwoSided, impressionsCol.blankTwoSided) && Intrinsics.areEqual(this.fullColor, impressionsCol.fullColor) && Intrinsics.areEqual(this.fullColorTwoSided, impressionsCol.fullColorTwoSided) && Intrinsics.areEqual(this.highlightColor, impressionsCol.highlightColor) && Intrinsics.areEqual(this.highlightColorTwoSided, impressionsCol.highlightColorTwoSided) && Intrinsics.areEqual(this.monochrome, impressionsCol.monochrome) && Intrinsics.areEqual(this.monochromeTwoSided, impressionsCol.monochromeTwoSided);
    }
    ...
    public ImpressionsCol(Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8) {
        this.blank = num;
    ...
    public ImpressionsCol(Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, int i, DefaultConstructorMarker defaultConstructorMarker) {
        Integer num9;
        Integer num10;
        Integer num11;
        Integer num12;
    ...
    @Metadata(m1291bv = {1, 0, 3}, m1292d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001a\u0010\u0013\u001a\u00020\u00022\u0010\u0010\u0014\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00160\u0015H\u0016R\u0016\u0010\u0004\u001a\u00020\u00008\u0006X\u0087\u0004¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0003R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00020\nX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0010\u0010\r\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000f\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0011\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0012\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, m1293d2 = {"Lcom/hp/jipp/model/ImpressionsCol$Companion;", "Lcom/hp/jipp/encoding/AttributeCollection$Converter;", "Lcom/hp/jipp/model/ImpressionsCol;", "()V", "Types", "getTypes$annotations", MediaPrePrinted.blank, "Lcom/hp/jipp/encoding/IntType;", "blankTwoSided", "cls", "Ljava/lang/Class;", "getCls", "()Ljava/lang/Class;", "fullColor", "fullColorTwoSided", "highlightColor", "highlightColorTwoSided", "monochrome", "monochromeTwoSided", "convert", "attributes", "", "Lcom/hp/jipp/encoding/Attribute;", "jipp-core"}, m1294k = 1, m1295mv = {1, 4, 0})
    public static final class Companion implements AttributeCollection.Converter<ImpressionsCol> {
        ...
        @Override
        public ImpressionsCol convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            return new ImpressionsCol((Integer) extractOne(attributes, ImpressionsCol.blank), (Integer) extractOne(attributes, ImpressionsCol.blankTwoSided), (Integer) extractOne(attributes, ImpressionsCol.fullColor), (Integer) extractOne(attributes, ImpressionsCol.fullColorTwoSided), (Integer) extractOne(attributes, ImpressionsCol.highlightColor), (Integer) extractOne(attributes, ImpressionsCol.highlightColorTwoSided), (Integer) extractOne(attributes, ImpressionsCol.monochrome), (Integer) extractOne(attributes, ImpressionsCol.monochromeTwoSided));
        }

        @Override
        public Class<ImpressionsCol> getCls() {
            return ImpressionsCol.cls;
        }
    }
    ...
    public String toString() {
        return "ImpressionsCol(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
