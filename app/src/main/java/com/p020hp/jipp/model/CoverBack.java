...
public final class CoverBack implements AttributeCollection {
    ...
    public static CoverBack copy$default(CoverBack coverBack, String str, KeywordOrName keywordOrName, MediaCol mediaCol2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = coverBack.coverType;
        }
        if ((i & 2) != 0) {
            keywordOrName = coverBack.media;
        }
        if ((i & 4) != 0) {
            mediaCol2 = coverBack.mediaCol;
        }
        return coverBack.copy(str, keywordOrName, mediaCol2);
    }
    ...
    public final CoverBack copy(String coverType2, KeywordOrName media2, MediaCol mediaCol2) {
        return new CoverBack(coverType2, media2, mediaCol2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CoverBack)) {
            return false;
        }
        CoverBack coverBack = (CoverBack) other;
        return Intrinsics.areEqual(this.coverType, coverBack.coverType) && Intrinsics.areEqual(this.media, coverBack.media) && Intrinsics.areEqual(this.mediaCol, coverBack.mediaCol);
    }
    ...
    public CoverBack(String str, KeywordOrName keywordOrName, MediaCol mediaCol2) {
        this.coverType = str;
        this.media = keywordOrName;
        this.mediaCol = mediaCol2;
    }

    public CoverBack(String str, KeywordOrName keywordOrName, MediaCol mediaCol2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            str = null;
        }
        if ((i & 2) != 0) {
    ...
    @Metadata(m1291bv = {1, 0, 3}, m1292d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001a\u0010\u0011\u001a\u00020\u00022\u0010\u0010\u0012\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00140\u0013H\u0016R\u0016\u0010\u0004\u001a\u00020\u00008\u0006X\u0087\u0004¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00020\u0007X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0010\u0010\n\u001a\u00020\u000b8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\f\u001a\u00020\r8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m1293d2 = {"Lcom/hp/jipp/model/CoverBack$Companion;", "Lcom/hp/jipp/encoding/AttributeCollection$Converter;", "Lcom/hp/jipp/model/CoverBack;", "()V", "Types", "getTypes$annotations", "cls", "Ljava/lang/Class;", "getCls", "()Ljava/lang/Class;", "coverType", "Lcom/hp/jipp/encoding/KeywordType;", "media", "Lcom/hp/jipp/encoding/KeywordOrNameType;", "mediaCol", "Lcom/hp/jipp/encoding/AttributeCollection$Type;", "Lcom/hp/jipp/model/MediaCol;", "convert", "attributes", "", "Lcom/hp/jipp/encoding/Attribute;", "jipp-core"}, m1294k = 1, m1295mv = {1, 4, 0})
    public static final class Companion implements AttributeCollection.Converter<CoverBack> {
        ...
        @Override
        public CoverBack convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            return new CoverBack((String) extractOne(attributes, CoverBack.coverType), (KeywordOrName) extractOne(attributes, CoverBack.media), (MediaCol) extractOne(attributes, CoverBack.mediaCol));
        }

        @Override
        public Class<CoverBack> getCls() {
            return CoverBack.cls;
        }
    }
    ...
    public String toString() {
        return "CoverBack(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
