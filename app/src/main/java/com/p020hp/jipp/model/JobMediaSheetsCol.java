...
public final class JobMediaSheetsCol implements AttributeCollection {
    ...
    public static JobMediaSheetsCol copy$default(JobMediaSheetsCol jobMediaSheetsCol, Integer num, Integer num2, Integer num3, Integer num4, int i, Object obj) {
        if ((i & 1) != 0) {
            num = jobMediaSheetsCol.blank;
        }
        if ((i & 2) != 0) {
            num2 = jobMediaSheetsCol.fullColor;
        }
        if ((i & 4) != 0) {
            num3 = jobMediaSheetsCol.highlightColor;
        }
        if ((i & 8) != 0) {
            num4 = jobMediaSheetsCol.monochrome;
        }
        return jobMediaSheetsCol.copy(num, num2, num3, num4);
    }
    ...
    public final JobMediaSheetsCol copy(Integer blank2, Integer fullColor2, Integer highlightColor2, Integer monochrome2) {
        return new JobMediaSheetsCol(blank2, fullColor2, highlightColor2, monochrome2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof JobMediaSheetsCol)) {
            return false;
        }
        JobMediaSheetsCol jobMediaSheetsCol = (JobMediaSheetsCol) other;
        return Intrinsics.areEqual(this.blank, jobMediaSheetsCol.blank) && Intrinsics.areEqual(this.fullColor, jobMediaSheetsCol.fullColor) && Intrinsics.areEqual(this.highlightColor, jobMediaSheetsCol.highlightColor) && Intrinsics.areEqual(this.monochrome, jobMediaSheetsCol.monochrome);
    }
    ...
    public JobMediaSheetsCol(Integer num, Integer num2, Integer num3, Integer num4) {
        this.blank = num;
        this.fullColor = num2;
    ...
    public JobMediaSheetsCol(Integer num, Integer num2, Integer num3, Integer num4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            num = null;
        }
        if ((i & 2) != 0) {
    ...
    @Metadata(m1291bv = {1, 0, 3}, m1292d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001a\u0010\u000f\u001a\u00020\u00022\u0010\u0010\u0010\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00120\u0011H\u0016R\u0016\u0010\u0004\u001a\u00020\u00008\u0006X\u0087\u0004¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0003R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00020\tX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0010\u0010\f\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, m1293d2 = {"Lcom/hp/jipp/model/JobMediaSheetsCol$Companion;", "Lcom/hp/jipp/encoding/AttributeCollection$Converter;", "Lcom/hp/jipp/model/JobMediaSheetsCol;", "()V", "Types", "getTypes$annotations", MediaPrePrinted.blank, "Lcom/hp/jipp/encoding/IntType;", "cls", "Ljava/lang/Class;", "getCls", "()Ljava/lang/Class;", "fullColor", "highlightColor", "monochrome", "convert", "attributes", "", "Lcom/hp/jipp/encoding/Attribute;", "jipp-core"}, m1294k = 1, m1295mv = {1, 4, 0})
    public static final class Companion implements AttributeCollection.Converter<JobMediaSheetsCol> {
        ...
        @Override
        public JobMediaSheetsCol convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            return new JobMediaSheetsCol((Integer) extractOne(attributes, JobMediaSheetsCol.blank), (Integer) extractOne(attributes, JobMediaSheetsCol.fullColor), (Integer) extractOne(attributes, JobMediaSheetsCol.highlightColor), (Integer) extractOne(attributes, JobMediaSheetsCol.monochrome));
        }

        @Override
        public Class<JobMediaSheetsCol> getCls() {
            return JobMediaSheetsCol.cls;
        }
    }
    ...
    public String toString() {
        return "JobMediaSheetsCol(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
