...
public final class DocumentAccess implements AttributeCollection {
    ...
    private static final Class<DocumentAccess> cls;
    ...
    public static DocumentAccess copy$default(DocumentAccess documentAccess, List list, URI uri, String str, String str2, String str3, int i, Object obj) {
        if ((i & 1) != 0) {
            list = documentAccess.accessOauthToken;
        }
        if ((i & 2) != 0) {
            uri = documentAccess.accessOauthUri;
        }
        URI uri2 = uri;
        if ((i & 4) != 0) {
            str = documentAccess.accessPassword;
        }
        String str4 = str;
        if ((i & 8) != 0) {
            str2 = documentAccess.accessPin;
        }
        String str5 = str2;
        if ((i & 16) != 0) {
            str3 = documentAccess.accessUserName;
        }
        return documentAccess.copy(list, uri2, str4, str5, str3);
    }
    ...
    public final DocumentAccess copy(List<byte[]> accessOauthToken2, URI accessOauthUri2, String accessPassword2, String accessPin2, String accessUserName2) {
        return new DocumentAccess(accessOauthToken2, accessOauthUri2, accessPassword2, accessPin2, accessUserName2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DocumentAccess)) {
            return false;
        }
        DocumentAccess documentAccess = (DocumentAccess) other;
        return Intrinsics.areEqual(this.accessOauthToken, documentAccess.accessOauthToken) && Intrinsics.areEqual(this.accessOauthUri, documentAccess.accessOauthUri) && Intrinsics.areEqual(this.accessPassword, documentAccess.accessPassword) && Intrinsics.areEqual(this.accessPin, documentAccess.accessPin) && Intrinsics.areEqual(this.accessUserName, documentAccess.accessUserName);
    }
    ...
    public DocumentAccess(List<byte[]> list, URI uri, String str, String str2, String str3) {
    ...
    public DocumentAccess(List list, URI uri, String str, String str2, String str3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        URI uri2;
        String str4;
        String str5;
        String str6 = null;
    ...
    public static final class Companion implements AttributeCollection.Converter<DocumentAccess> {
        ...
        @Override
        public DocumentAccess convert(List<? extends Attribute<?>> attributes) {
            Intrinsics.checkNotNullParameter(attributes, "attributes");
            List listExtractAll = extractAll(attributes, DocumentAccess.accessOauthToken);
            URI uri = (URI) extractOne(attributes, DocumentAccess.accessOauthUri);
            Text text = (Text) extractOne(attributes, DocumentAccess.accessPassword);
            String value = text != null ? text.getValue() : null;
            Text text2 = (Text) extractOne(attributes, DocumentAccess.accessPin);
            String value2 = text2 != null ? text2.getValue() : null;
            Text text3 = (Text) extractOne(attributes, DocumentAccess.accessUserName);
            return new DocumentAccess(listExtractAll, uri, value, value2, text3 != null ? text3.getValue() : null);
        }

        @Override
        public Class<DocumentAccess> getCls() {
            return DocumentAccess.cls;
        }
    }
    ...
    public String toString() {
        return "DocumentAccess(" + CollectionsKt.joinToString$default(getAttributes(), null, null, null, 0, null, null, 63, null) + ')';
    }
}
