...
public final class Text implements TaggedValue, Stringable {
    ...
    public final Text copy(String value, String lang) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new Text(value, lang);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(getValue(), text.getValue()) && Intrinsics.areEqual(this.lang, text.lang);
    }
    ...
    public Text(String value, String str) {
        ...
        this.value = value;
        this.lang = str;
        this.tag = str == null ? Tag.textWithoutLanguage : Tag.textWithLanguage;
    }
    ...
    public String toString() {
        ...
        return "\"" + getValue() + "\" (" + this.lang + " text)";
    }
}
