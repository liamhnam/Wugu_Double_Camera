...
public class CallableC1776v2 implements Callable<List<C1766t2>> {

    public final RoomSQLiteQuery f1911a;

    public final C1666a3 f1912b;

    public CallableC1776v2(C1666a3 c1666a3, RoomSQLiteQuery roomSQLiteQuery) {
        this.f1912b = c1666a3;
        this.f1911a = roomSQLiteQuery;
    }
    ...
    public List<C1766t2> call() {
        ...
        String string10;
        int i10;
        this.f1912b.f884a.beginTransaction();
        try {
            Cursor cursorQuery = DBUtil.query(this.f1912b.f884a, this.f1911a, false, null);
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    if (this.f1912b.f886c != null) {
                        ...
                        HpPrintJobState hpPrintJobStateM565a = this.f1912b.f886c.m565a(cursorQuery.getInt(columnIndexOrThrow5));
                ...
                this.f1912b.f884a.setTransactionSuccessful();
                return arrayList;
            } finally {
                cursorQuery.close();
                this.f1911a.release();
            ...
            this.f1912b.f884a.endTransaction();
        }
    }
}
