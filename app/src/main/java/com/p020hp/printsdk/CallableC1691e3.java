...
public class CallableC1691e3 implements Callable<List<C1713i3>> {

    public final RoomSQLiteQuery f1191a;

    public final C1666a3 f1192b;

    public CallableC1691e3(C1666a3 c1666a3, RoomSQLiteQuery roomSQLiteQuery) {
        this.f1192b = c1666a3;
        this.f1191a = roomSQLiteQuery;
    }

    @Override
    public List<C1713i3> call() {
        C1708h3 c1708h3;
        this.f1192b.f884a.beginTransaction();
        try {
            Cursor cursorQuery = DBUtil.query(this.f1192b.f884a, this.f1191a, true, null);
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    if (cursorQuery.isNull(columnIndexOrThrow) && cursorQuery.isNull(columnIndexOrThrow2) && cursorQuery.isNull(columnIndexOrThrow3) && cursorQuery.isNull(columnIndexOrThrow4)) {
                        ...
                        this.f1192b.f886c.getClass();
                        c1708h3 = new C1708h3(UUID.fromString(string2), cursorQuery.isNull(columnIndexOrThrow2) ? null : cursorQuery.getString(columnIndexOrThrow2), this.f1192b.f886c.m567a(cursorQuery.isNull(columnIndexOrThrow3) ? null : cursorQuery.getString(columnIndexOrThrow3)), this.f1192b.f886c.m567a(cursorQuery.isNull(columnIndexOrThrow4) ? null : cursorQuery.getString(columnIndexOrThrow4)));
                    }
                ...
                this.f1192b.f884a.setTransactionSuccessful();
                return arrayList;
            } finally {
                cursorQuery.close();
                this.f1191a.release();
            ...
            this.f1192b.f884a.endTransaction();
        }
    }
}
