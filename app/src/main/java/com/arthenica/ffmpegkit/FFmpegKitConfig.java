...
public class FFmpegKitConfig {
    ...
    */
    private static void log(long r5, int r7, byte[] r8) {
        ...
        L75:
            r3 = r6
        L76:
            int[] r8 = com.arthenica.ffmpegkit.FFmpegKitConfig.C06852.$SwitchMap$com$arthenica$ffmpegkit$LogRedirectionStrategy
            int r2 = r2.ordinal()
            r8 = r8[r2]
            if (r8 == r6) goto Lb3
            r6 = 2
        ...
        L92:
            ...
            return
        L95:
            int[] r5 = com.arthenica.ffmpegkit.FFmpegKitConfig.C06852.$SwitchMap$com$arthenica$ffmpegkit$Level
            int r6 = r0.ordinal()
            r5 = r5[r6]
            switch(r5) {
                case 1: goto Lb3;
    ...
    static class C06852 {
        static final int[] $SwitchMap$com$arthenica$ffmpegkit$Level;
        static final int[] $SwitchMap$com$arthenica$ffmpegkit$LogRedirectionStrategy;
    ...
    public static String registerNewFFmpegPipe(Context context) {
        ...
        String str = MessageFormat.format("{0}{1}{2}{3}", file, File.separator, FFMPEG_KIT_NAMED_PIPE_PREFIX, Integer.valueOf(uniqueIdGenerator.getAndIncrement()));
        closeFFmpegPipe(str);
        int iRegisterNewNativeFFmpegPipe = registerNewNativeFFmpegPipe(str);
        if (iRegisterNewNativeFFmpegPipe == 0) {
            return str;
        }
        android.util.Log.e(TAG, String.format("Failed to register new FFmpeg pipe %s. Operation failed with rc=%d.", str, Integer.valueOf(iRegisterNewNativeFFmpegPipe)));
        return null;
    }
    ...
    public static void printToLogcat(int i, String str) {
        do {
            if (str.length() <= 4000) {
                ...
                int iLastIndexOf = str.substring(0, 4000).lastIndexOf(10);
                if (iLastIndexOf < 0) {
                    android.util.Log.println(i, TAG, str.substring(0, 4000));
                    str = str.substring(4000);
                } else {
                    android.util.Log.println(i, TAG, str.substring(0, iLastIndexOf));
                    str = str.substring(iLastIndexOf);
                }
            }
        } while (str.length() > 0);
    }
    ...
    */
    ...
    public static String getSafParameterForRead(Context context, Uri uri) {
        return getSafParameter(context, uri, PDPageLabelRange.STYLE_ROMAN_LOWER);
    }
    ...
    private static int safOpen(int i) {
        ...
        ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = sAFProtocolUrl.getContentResolver().openFileDescriptor(sAFProtocolUrl.getUri(), sAFProtocolUrl.getOpenMode());
        sAFProtocolUrl.setParcelFileDescriptor(parcelFileDescriptorOpenFileDescriptor);
        int fd = parcelFileDescriptorOpenFileDescriptor.getFd();
    ...
    private static void deleteExpiredSessions() {
        while (true) {
            ...
            try {
                Session sessionRemove = list.remove(0);
                if (sessionRemove != null) {
                    sessionHistoryMap.remove(Long.valueOf(sessionRemove.getSessionId()));
                }
    ...
    public static String[] parseArguments(String str) {
        ...
        boolean z2 = false;
        while (i < str.length()) {
            Character chValueOf = i > 0 ? Character.valueOf(str.charAt(i - 1)) : null;
