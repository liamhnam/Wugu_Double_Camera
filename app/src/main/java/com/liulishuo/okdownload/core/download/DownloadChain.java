...
public class DownloadChain implements Runnable {
    ...
    private final Runnable cancelRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (DownloadChain.this.finished.get() || DownloadChain.this.currentThread == null || (connection = DownloadChain.this.getConnection()) == null) {
                return;
            }
            connection.release();
        }
    ...
    public void run() {
        ...
        try {
            ...
            this.finished.set(true);
            if (this.cache.isUserCanceled()) {
                EXECUTOR.execute(this.cancelRunnable);
            }
            throw th;
        }
        EXECUTOR.execute(this.cancelRunnable);
