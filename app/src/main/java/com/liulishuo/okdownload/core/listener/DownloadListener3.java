...
public abstract class DownloadListener3 extends DownloadListener1 {
    ...
    static class C18231 {
        static final int[] $SwitchMap$com$liulishuo$okdownload$core$cause$EndCause;
    ...
    public void taskEnd(DownloadTask downloadTask, EndCause endCause, Exception exc, Listener1Assist.Listener1Model listener1Model) {
        switch (C18231.$SwitchMap$com$liulishuo$okdownload$core$cause$EndCause[endCause.ordinal()]) {
            case 1:
            ...
            case 6:
                ...
                break;
            default:
                Util.m697w("DownloadListener3", "Don't support " + endCause);
                break;
        }
    }
}
