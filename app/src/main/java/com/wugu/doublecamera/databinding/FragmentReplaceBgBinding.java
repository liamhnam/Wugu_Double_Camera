...
public final class FragmentReplaceBgBinding implements ViewBinding {
    ...
    private FragmentReplaceBgBinding(AbsoluteLayout absoluteLayout, AppCompatImageView appCompatImageView, CountdownView countdownView, PictureSplicing pictureSplicing, RecyclerView recyclerView) {
    ...
    public static FragmentReplaceBgBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentReplaceBgBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C1910R.layout.fragment_replace_bg, viewGroup, false);
        if (z) {
    ...
    public static FragmentReplaceBgBinding bind(View view) {
            ...
            if (countdownView != null) {
                ...
                if (pictureSplicing != null) {
                    ...
                    if (recyclerView != null) {
                        return new FragmentReplaceBgBinding((AbsoluteLayout) view, appCompatImageView, countdownView, pictureSplicing, recyclerView);
                    }
                }
            }
        }
