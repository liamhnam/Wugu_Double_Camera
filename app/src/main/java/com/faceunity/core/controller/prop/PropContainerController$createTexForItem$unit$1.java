...
final class PropContainerController$createTexForItem$unit$1 extends Lambda implements Function0<Unit> {
    ...
    PropContainerController$createTexForItem$unit$1(PropContainerController propContainerController, long j, String str, byte[] bArr, int i, int i2) {
        super(0);
        ...
        if (num != null) {
            ...
            this.this$0.doGLThreadAction(new Function0<Unit>() {
                ...
                public final void invoke2() {
                    ...
                    SDKController.INSTANCE.createTexForItem$fu_core_all_featureRelease(num.intValue(), this.this$0.$name, this.this$0.$rgba, this.this$0.$width, this.this$0.$height);
                }
            });
        }
    }
