...
final class ASCII85OutputStream extends FilterOutputStream {
    ...
    private static final char f2326Z = 'z';
    private int count;
    ...
    ASCII85OutputStream(OutputStream outputStream) {
        super(outputStream);
        this.lineBreak = 72;
        this.maxline = 72;
        this.count = 0;
    ...
    private void transformASCII85() {
        ...
        long j = ((long) ((bArr[3] & UByte.MAX_VALUE) | (((bArr[0] << 8) | (bArr[1] & UByte.MAX_VALUE)) << 16) | ((bArr[2] & UByte.MAX_VALUE) << 8))) & BodyPartID.bodyIdMax;
        if (j == 0) {
