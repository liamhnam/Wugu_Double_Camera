...
public class PDPageLabelRange implements COSObjectable {
    ...
    private static final COSName KEY_START = COSName.f2306ST;
    private static final COSName KEY_PREFIX = COSName.f2292P;
    private static final COSName KEY_STYLE = COSName.f2301S;
