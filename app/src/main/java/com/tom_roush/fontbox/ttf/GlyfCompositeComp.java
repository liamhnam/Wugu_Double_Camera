...
public class GlyfCompositeComp {
    ...
    protected GlyfCompositeComp(TTFDataStream tTFDataStream) throws IOException {
        this.xscale = 1.0d;
        this.yscale = 1.0d;
        this.scale01 = 0.0d;
        this.scale10 = 0.0d;
    ...
    public int scaleX(int i, int i2) {
        return Math.round((float) ((((double) i) * this.xscale) + (((double) i2) * this.scale10)));
    }

    public int scaleY(int i, int i2) {
        return Math.round((float) ((((double) i) * this.scale01) + (((double) i2) * this.yscale)));
    }
}
