...
class Scanner {
    ...
    public static final TokenType f2458GT = new TokenType(9, "GT");
    ...
    public static final TokenType f2459LT = new TokenType(14, "LT");
    ...
    public Scanner(Reader reader, boolean z, EntityExpansion entityExpansion) {
        this.f2460in = new StreamInfo("", reader);
        this.atEOF = false;
        this.trace = z;
    ...
    protected int readNextChar() throws IOException {
        Stack stack;
        int i = this.f2460in.f2462in.read();
        if (i >= 0 || (stack = this.inputStreams) == null || stack.empty()) {
            return i;
        }
        this.f2460in.f2462in.close();
        this.f2460in = (StreamInfo) this.inputStreams.pop();
        return readNextChar();
    }
    ...
    protected int peekChar() throws IOException {
        ...
        if (this.nextChar == 0) {
            ...
            this.f2460in.column++;
            if (this.nextChar == 10) {
                this.f2460in.lineNumber++;
                this.f2460in.column = 1;
            }
        }
    ...
    */
    ...
    public String getUriId() {
        return this.f2460in.f2461id;
    }

    public int getLineNumber() {
        return this.f2460in.lineNumber;
    }

    public int getColumn() {
        return this.f2460in.column;
    }
    ...
    public boolean expandEntity(String str) throws IOException {
        ...
        DTDEntity dTDEntityExpandEntity = this.expander.expandEntity(str.substring(1, str.length() - 1));
        if (dTDEntityExpandEntity == null || (reader = dTDEntityExpandEntity.getReader()) == null) {
            return false;
        }
        if (this.inputStreams == null) {
            this.inputStreams = new Stack();
        }
        this.inputStreams.push(this.f2460in);
        this.f2460in = new StreamInfo(dTDEntityExpandEntity.getExternalId(), reader);
        return true;
    }
    ...
    public void addEntity(String str, String str2) {
        this.entityExpansion.put(new StringBuffer("%").append(str).append(";").toString(), str2);
    }
}
