...
class ResourceCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    private final DataFetcherGenerator.FetcherReadyCallback f544cb;
    ...
    ResourceCacheGenerator(DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f544cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f544cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE, this.currentKey);
    }

    @Override
    public void onLoadFailed(Exception exc) {
        this.f544cb.onDataFetcherFailed(this.currentKey, exc, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE);
    }
}
