...
class DataCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    private final DataFetcherGenerator.FetcherReadyCallback f539cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f539cb = fetcherReadyCallback;
    }
    ...
    */
    ...
    public void onDataReady(Object obj) {
        this.f539cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    @Override
    public void onLoadFailed(Exception exc) {
        this.f539cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
