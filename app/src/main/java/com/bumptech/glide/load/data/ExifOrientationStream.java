...
public final class ExifOrientationStream extends FilterInputStream {
    ...
    static {
        byte[] bArr = {-1, MdbAddr.DEF_ADDR, 0, 28, SnmpConstants.NSAP_ADDRESS, 120, 105, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, SnmpConstants.SNMP_ERR_INCONSISTENTNAME, 0, 2, 0, 0, 0, 1, 0};
        EXIF_SEGMENT = bArr;
