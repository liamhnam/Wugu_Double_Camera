...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    private static final String f551ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f551ID.getBytes(CHARSET);
