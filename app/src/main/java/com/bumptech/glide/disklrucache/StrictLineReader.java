...
class StrictLineReader implements Closeable {
    ...
    private static final byte f531CR = 13;

    private static final byte f532LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    private final InputStream f533in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f533in
            monitor-enter(r0)
