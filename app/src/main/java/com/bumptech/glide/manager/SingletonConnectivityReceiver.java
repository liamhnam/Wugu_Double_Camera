...
final class SingletonConnectivityReceiver {
    ...
    private static final class FrameworkConnectivityMonitorPostApi24 implements FrameworkConnectivityMonitor {
        ...
        private final ConnectivityManager.NetworkCallback networkCallback = new C08271();

        class C08271 extends ConnectivityManager.NetworkCallback {
            C08271() {
            }
            ...
            private void postOnConnectivityChange(final boolean z) {
                Util.postOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        C08271.this.onConnectivityChange(z);
                    }
                });
            }
