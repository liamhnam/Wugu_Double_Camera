...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f536ix = readShort();
        this.header.currentFrame.f537iy = readShort();
        this.header.currentFrame.f535iw = readShort();
        this.header.currentFrame.f534ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
