...
final class DecodedBitStreamParser {
    ...
    static {
        ...
        TEXT_SHIFT3_SET_CHARS = new char[]{'`', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', Matrix.MATRIX_TYPE_RANDOM_LT, 'M', 'N', 'O', 'P', 'Q', Matrix.MATRIX_TYPE_RANDOM_REGULAR, 'S', 'T', Matrix.MATRIX_TYPE_RANDOM_UT, 'V', 'W', 'X', 'Y', Matrix.MATRIX_TYPE_ZERO, '{', '|', '}', '~', 127};
    }
    ...
    static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (modeDecodeAsciiSegment == Mode.ASCII_ENCODE) {
                ...
                int i = C15711.f666xb73eb560[modeDecodeAsciiSegment.ordinal()];
                if (i == 1) {
    ...
    static class C15711 {
        ...
        static final int[] f666xb73eb560;
        ...
        static {
            ...
            try {
                f666xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f666xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f666xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f666xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
