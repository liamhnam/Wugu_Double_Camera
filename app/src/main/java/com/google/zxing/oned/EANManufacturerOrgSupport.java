...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{400, UiPosIndexEnum.KEYBOARD_DEL}, "DE");
            ...
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{540, UiPosIndexEnum.PHOTO_BEAUTY_TWO}, "BE/LU");
            add(new int[]{UiPosIndexEnum.PHOTO_BEAUTY_POS}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{690, UiPosIndexEnum.PRINT_SIGN_REDO}, "CN");
            ...
            add(new int[]{868, 869}, StandardStructureTypes.f2382TR);
            add(new int[]{870, 879}, "NL");
            add(new int[]{880}, "KR");
            add(new int[]{885}, StandardStructureTypes.f2381TH);
            add(new int[]{888}, "SG");
            add(new int[]{890}, "IN");
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
