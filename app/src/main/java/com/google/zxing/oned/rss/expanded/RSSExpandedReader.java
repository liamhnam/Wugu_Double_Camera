...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, 143, 7, 21, 63}, new int[]{PsExtractor.PRIVATE_STREAM_1, 145, 13, 39, 117, PowerState.Code.resetMbrGraceful, BoardConst.CODE_ERR_ADDR, 205}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, SyslogAppender.LOG_LOCAL1, 197, 169, 85, 44, 132}, new int[]{185, 133, 188, PageAttribute.MediaTypeID.EPS_MTID_PLOOFING_WHITE_MAT, 4, 12, 36, 108}, new int[]{UiPosIndexEnum.HOME_REPLACE_BG_TAB, 128, 173, 97, 80, 29, 87, 50}, new int[]{PowerState.Code.resetSoftGraceful, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, TsExtractor.TS_STREAM_TYPE_DTS, 203, 187, 139, 206, 196, 166}, new int[]{76, 17, 51, 153, 37, 111, DNPPhotoPrint.OVERCOAT_FINISH_PMATTE13, 155}, new int[]{43, 129, 176, 106, ErrorCode.PrinterError.EPS_PRNERR_JPG_LIMIT, 110, 119, 146}, new int[]{16, 48, SyslogAppender.LOG_LOCAL2, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, 178, UiPosIndexEnum.HOME_COUNTDOWN, 125, 164}, new int[]{70, 210, 208, 202, SyslogAppender.LOG_LOCAL7, 130, 179, 115}, new int[]{TsExtractor.TS_STREAM_TYPE_SPLICE_INFO, 191, 151, 31, 93, 68, 204, PowerState.Code.noChange}, new int[]{148, 22, 66, 198, TsExtractor.TS_STREAM_TYPE_AC4, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, WebSocketProtocol.PAYLOAD_SHORT, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, PageAttribute.MediaTypeID.EPS_MTID_LABEL, 127, PowerState.Code.resetInit, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, TsExtractor.TS_STREAM_TYPE_E_AC3, 194, 160, 58, PageAttribute.MediaTypeID.EPS_MTID_BARYTA, 100, 89}};
