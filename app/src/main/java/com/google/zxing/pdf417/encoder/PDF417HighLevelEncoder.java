...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {SnmpConstants.CONS_SEQ, 49, 50, 51, 52, 53, 54, 55, 56, 57, 38, 13, 9, 44, 58, 35, 45, 46, 36, 47, 43, 37, 42, Base64.padSymbol, 94, 0, 32, 0, 0, 0};
    ...
    static String encodeHighLevel(String str, Compaction compaction, Charset charset) throws WriterException {
        ...
        int i = C15761.$SwitchMap$com$google$zxing$pdf417$encoder$Compaction[compaction.ordinal()];
        if (i == 1) {
    ...
    */
    ...
    private static void encodeNumeric(String str, int i, int i2, StringBuilder sb) {
        ...
        while (i3 < i2) {
            ...
            int i4 = i + i3;
            BigInteger bigInteger = new BigInteger(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE + str.substring(i4, i4 + iMin));
            do {
