...
class SearchBarAnimationHelper {
    ...
    void startOnLoadAnimation(SearchBar searchBar) {
        dispatchOnLoadAnimation(new OnLoadAnimationInvocation() {
            @Override
        ...
        secondaryViewAnimator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animator) {
                SearchBarAnimationHelper.this.dispatchOnLoadAnimation(new OnLoadAnimationInvocation() {
                    @Override
                    public final void invoke(SearchBar.OnLoadAnimationCallback onLoadAnimationCallback) {
        ...
        if (centerView instanceof AnimatableView) {
            ...
            ((AnimatableView) centerView).startAnimation(new AnimatableView.Listener() {
                @Override
            ...
            if (centerView != 0) {
                ...
                defaultCenterViewAnimator.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animator) {
    ...
    void startExpandAnimation(final SearchBar searchBar, final View view, final AppBarLayout appBarLayout, final boolean z) {
        ...
        view.post(new Runnable() {
            ...
            public final void run() {
                this.f$0.m368x1b96b119(searchBar, view, appBarLayout, z);
            }
        });
    }

    void m368x1b96b119(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z) {
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private Animator getCollapseAnimator(final SearchBar searchBar, View view, AppBarLayout appBarLayout) {
        return getExpandCollapseAnimationHelper(searchBar, view, appBarLayout).setDuration(250L).addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationStart(Animator animator) {
    ...
    static void lambda$getExpandedViewBackgroundUpdateListener$1(MaterialShapeDrawable materialShapeDrawable, View view, ValueAnimator valueAnimator) {
