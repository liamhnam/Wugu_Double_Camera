...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C1156R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C1156R.attr.badgeStyle;
    ...
    private BadgeDrawable(Context context, int i, int i2, int i3, BadgeState.State state) {
        ...
        setTextAppearanceResource(C1156R.style.TextAppearance_MaterialComponents_Badge);
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C1156R.id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C1156R.id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        if (hasNumber()) {
            i = C1156R.dimen.mtrl_badge_text_horizontal_edge_offset;
        } else {
            i = C1156R.dimen.mtrl_badge_horizontal_edge_offset;
        }
    ...
    private String getBadgeText() {
        ...
        Context context = this.contextRef.get();
        return context == null ? "" : String.format(this.state.getNumberLocale(), context.getString(C1156R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), "+");
    }
