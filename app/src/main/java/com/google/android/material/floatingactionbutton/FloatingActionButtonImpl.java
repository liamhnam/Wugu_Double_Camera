...
class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C1156R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C1156R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C1156R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C1156R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    void hide(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            animatorSetCreateDefaultAnimator.addListener(new AnimatorListenerAdapter() {
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        ObjectAnimator objectAnimatorOfObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() {
            @Override
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3, int i, int i2) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), i, this.view.getContext().getResources().getInteger(C1156R.integer.material_motion_duration_long_1)));
