...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C1156R.style.Widget_Material3_SearchBar;
    ...
    void m1558lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1156R.attr.materialSearchBarStyle);
    }
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() {
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m1558lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        Context context2 = getContext();
        validateAttributes(attributeSet);
        this.defaultNavigationIcon = AppCompatResources.getDrawable(context2, C1156R.drawable.ic_search_black_24);
        this.searchBarAnimationHelper = new SearchBarAnimationHelper();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1156R.styleable.SearchBar, i, i2, new int[0]);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        float dimension = typedArrayObtainStyledAttributes.getDimension(C1156R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SearchBar_tintNavigationIcon, true);
        if (typedArrayObtainStyledAttributes.hasValue(C1156R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(typedArrayObtainStyledAttributes.getColor(C1156R.styleable.SearchBar_navigationIconTint, -1));
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1156R.styleable.SearchBar_android_textAppearance, -1);
        String string = typedArrayObtainStyledAttributes.getString(C1156R.styleable.SearchBar_android_text);
        String string2 = typedArrayObtainStyledAttributes.getString(C1156R.styleable.SearchBar_android_hint);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C1156R.styleable.SearchBar_strokeWidth, -1.0f);
        int color = typedArrayObtainStyledAttributes.getColor(C1156R.styleable.SearchBar_strokeColor, 0);
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C1156R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C1156R.id.search_bar_text_view);
    ...
    private void initTextView(int i, String str, String str2) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C1156R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, float f, float f2, int i) {
        ...
        int color = MaterialColors.getColor(this, C1156R.attr.colorSurface);
        int color2 = MaterialColors.getColor(this, C1156R.attr.colorControlHighlight);
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        if (num != null) {
            ...
            if (drawable == this.defaultNavigationIcon) {
                i = C1156R.attr.colorOnSurfaceVariant;
            } else {
                i = C1156R.attr.colorOnSurface;
            }
    ...
    private void setDefaultMargins() {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C1156R.dimen.m3_searchbar_margin_horizontal);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C1156R.dimen.m3_searchbar_margin_vertical);
