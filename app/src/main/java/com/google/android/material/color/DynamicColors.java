...
public class DynamicColors {
    ...
    private static final int[] DYNAMIC_COLOR_THEME_OVERLAY_ATTRIBUTE = {C1156R.attr.dynamicColorThemeOverlay};
    ...
    static {
        DeviceSupportCondition deviceSupportCondition = new DeviceSupportCondition() {
            @Override
        ...
        DeviceSupportCondition deviceSupportCondition2 = new DeviceSupportCondition() {
    ...
    public static void applyToActivityIfAvailable(Activity activity, DynamicColorsOptions dynamicColorsOptions) {
        ...
        if (isDynamicColorAvailable()) {
            ...
            if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, themeOverlay)) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    if (MaterialAttributes.resolveBoolean(activity, C1156R.attr.isLightTheme, true)) {
                    ...
                    if (colorResourcesOverride == null || !colorResourcesOverride.applyIfPossible(activity, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeDarkContent))) {
                        return;
                    }
                } else {
