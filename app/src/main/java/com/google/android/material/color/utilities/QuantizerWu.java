...
public final class QuantizerWu implements Quantizer {
    ...
    public QuantizerResult quantize(int[] iArr, int i) {
        ...
        while (it.hasNext()) {
            map.put(Integer.valueOf(it.next().intValue()), 0);
        }
    ...
    double variance(Box box) {
        ...
        return (((((((this.moments[getIndex(box.f641r1, box.f639g1, box.f637b1)] - this.moments[getIndex(box.f641r1, box.f639g1, box.f636b0)]) - this.moments[getIndex(box.f641r1, box.f638g0, box.f637b1)]) + this.moments[getIndex(box.f641r1, box.f638g0, box.f636b0)]) - this.moments[getIndex(box.f640r0, box.f639g1, box.f637b1)]) + this.moments[getIndex(box.f640r0, box.f639g1, box.f636b0)]) + this.moments[getIndex(box.f640r0, box.f638g0, box.f637b1)]) - this.moments[getIndex(box.f640r0, box.f638g0, box.f636b0)]) - (((double) (((iVolume * iVolume) + (iVolume2 * iVolume2)) + (iVolume3 * iVolume3))) / ((double) volume(box, this.weights)));
    }
    ...
    Boolean cut(Box box, Box box2) {
        ...
        MaximizeResult maximizeResultMaximize = maximize(box, Direction.RED, box.f640r0 + 1, box.f641r1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize2 = maximize(box, Direction.GREEN, box.f638g0 + 1, box.f639g1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize3 = maximize(box, Direction.BLUE, box.f636b0 + 1, box.f637b1, iVolume, iVolume2, iVolume3, iVolume4);
        ...
        box2.f641r1 = box.f641r1;
        box2.f639g1 = box.f639g1;
        box2.f637b1 = box.f637b1;
        int i = C12201.f635x8739cebf[direction.ordinal()];
        if (i == 1) {
            box.f641r1 = maximizeResultMaximize.cutLocation;
            box2.f640r0 = box.f641r1;
            box2.f638g0 = box.f638g0;
            box2.f636b0 = box.f636b0;
        } else if (i == 2) {
            box.f639g1 = maximizeResultMaximize2.cutLocation;
            box2.f640r0 = box.f640r0;
            box2.f638g0 = box.f639g1;
            box2.f636b0 = box.f636b0;
        } else if (i == 3) {
            box.f637b1 = maximizeResultMaximize3.cutLocation;
            box2.f640r0 = box.f640r0;
            box2.f638g0 = box.f638g0;
            box2.f636b0 = box.f637b1;
        }
        box.vol = (box.f641r1 - box.f640r0) * (box.f639g1 - box.f638g0) * (box.f637b1 - box.f636b0);
        box2.vol = (box2.f641r1 - box2.f640r0) * (box2.f639g1 - box2.f638g0) * (box2.f637b1 - box2.f636b0);
        return true;
    }

    static class C12201 {

        static final int[] f635x8739cebf;
        ...
        static {
            ...
            try {
                f635x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f635x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box box, int[] iArr) {
        return ((((((iArr[getIndex(box.f641r1, box.f639g1, box.f637b1)] - iArr[getIndex(box.f641r1, box.f639g1, box.f636b0)]) - iArr[getIndex(box.f641r1, box.f638g0, box.f637b1)]) + iArr[getIndex(box.f641r1, box.f638g0, box.f636b0)]) - iArr[getIndex(box.f640r0, box.f639g1, box.f637b1)]) + iArr[getIndex(box.f640r0, box.f639g1, box.f636b0)]) + iArr[getIndex(box.f640r0, box.f638g0, box.f637b1)]) - iArr[getIndex(box.f640r0, box.f638g0, box.f636b0)];
    }

    static int bottom(Box box, Direction direction, int[] iArr) {
        int i;
        int i2;
        int i3 = C12201.f635x8739cebf[direction.ordinal()];
        if (i3 == 1) {
            i = (-iArr[getIndex(box.f640r0, box.f639g1, box.f637b1)]) + iArr[getIndex(box.f640r0, box.f639g1, box.f636b0)] + iArr[getIndex(box.f640r0, box.f638g0, box.f637b1)];
            i2 = iArr[getIndex(box.f640r0, box.f638g0, box.f636b0)];
        } else if (i3 == 2) {
            i = (-iArr[getIndex(box.f641r1, box.f638g0, box.f637b1)]) + iArr[getIndex(box.f641r1, box.f638g0, box.f636b0)] + iArr[getIndex(box.f640r0, box.f638g0, box.f637b1)];
            i2 = iArr[getIndex(box.f640r0, box.f638g0, box.f636b0)];
        } else if (i3 == 3) {
            i = (-iArr[getIndex(box.f641r1, box.f639g1, box.f636b0)]) + iArr[getIndex(box.f641r1, box.f638g0, box.f636b0)] + iArr[getIndex(box.f640r0, box.f639g1, box.f636b0)];
            i2 = iArr[getIndex(box.f640r0, box.f638g0, box.f636b0)];
        } else {
    ...
    static int top(Box box, Direction direction, int i, int[] iArr) {
        int i2;
        int i3;
        int i4 = C12201.f635x8739cebf[direction.ordinal()];
        if (i4 == 1) {
            i2 = (iArr[getIndex(i, box.f639g1, box.f637b1)] - iArr[getIndex(i, box.f639g1, box.f636b0)]) - iArr[getIndex(i, box.f638g0, box.f637b1)];
            i3 = iArr[getIndex(i, box.f638g0, box.f636b0)];
        } else if (i4 == 2) {
            i2 = (iArr[getIndex(box.f641r1, i, box.f637b1)] - iArr[getIndex(box.f641r1, i, box.f636b0)]) - iArr[getIndex(box.f640r0, i, box.f637b1)];
            i3 = iArr[getIndex(box.f640r0, i, box.f636b0)];
        } else if (i4 == 3) {
            i2 = (iArr[getIndex(box.f641r1, box.f639g1, i)] - iArr[getIndex(box.f641r1, box.f638g0, i)]) - iArr[getIndex(box.f640r0, box.f639g1, i)];
            i3 = iArr[getIndex(box.f640r0, box.f638g0, i)];
        } else {
            throw new IllegalArgumentException("unexpected direction " + direction);
        }
        return i2 + i3;
