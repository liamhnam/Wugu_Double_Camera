...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1156R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1156R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1156R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C1156R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, C1156R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C1156R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C1156R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C1156R.attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C1156R.attr.colorOnSurface);
