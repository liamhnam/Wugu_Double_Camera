...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C1156R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }

    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        this.messageView = (TextView) findViewById(C1156R.id.snackbar_text);
        this.actionView = (Button) findViewById(C1156R.id.snackbar_action);
    }
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C1156R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        Lb:
            ...
            int r2 = com.google.android.material.C1156R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r2)
            android.content.res.Resources r2 = r7.getResources()
            int r3 = com.google.android.material.C1156R.dimen.design_snackbar_padding_vertical
