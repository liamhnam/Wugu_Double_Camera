...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C1156R.attr.colorError, C1156R.attr.colorOnError, C1156R.attr.colorErrorContainer, C1156R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C1156R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
