...
public final class AudioCapabilitiesReceiver {
    ...
    public AudioCapabilitiesReceiver(Context context, Listener listener) {
        ...
        this.externalSurroundSoundSettingObserver = externalSurroundSoundGlobalSettingUri != null ? new ExternalSurroundSoundSettingObserver(handler, applicationContext.getContentResolver(), externalSurroundSoundGlobalSettingUri) : null;
    }
