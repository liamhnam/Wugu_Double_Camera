...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        mediaSourceHolder.activeMediaPeriodIds.remove(((MaskingMediaPeriod) mediaPeriod).f584id);
    ...
    @Override
    public void m320x365769cd(MediaSourceHolder mediaSourceHolder, MediaSource mediaSource, Timeline timeline) {
