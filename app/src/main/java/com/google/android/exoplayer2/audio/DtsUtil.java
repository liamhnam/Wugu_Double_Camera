...
public final class DtsUtil {
    ...
    private static final int[] SAMPLE_RATE_BY_SFREQ = {-1, 8000, 16000, 32000, -1, -1, 11025, 22050, 44100, -1, -1, UtilLoggingLevel.FINER_INT, 24000, 48000, -1, -1};
    private static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, UiPosIndexEnum.HOME_COUNTDOWN, 128, 192, 224, 256, 384, 448, 512, 640, ViewUtils.EDGE_TO_EDGE_FLAGS, 896, 1024, 1152, Status.Code.serverErrorInternalError, 1536, VideoRecordHelper.MAX_VIDEO_LENGTH, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
