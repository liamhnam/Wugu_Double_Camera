...
final class AtomParsers {
    ...
    public static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        long jScaleLargeTimestamp = C1041C.TIME_UNSET;
        ...
        StsdData stsd = parseStsd(containerAtomOfType2.getLeafAtomOfType(Atom.TYPE_stsd).data, tkhd.f569id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z2);
        if (z) {
            jArr = null;
            jArr2 = null;
        } else {
        ...
        return new Track(tkhd.f569id, trackTypeForHdlr, ((Long) mdhd.first).longValue(), mvhd, j3, stsd.format, stsd.requiredSampleTransformation, stsd.trackEncryptionBoxes, stsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (i5 >= 0 && i5 < i) {
                ...
                Log.m346w(TAG, "Skipped metadata with unknown key index: " + i5);
            }
    ...
    */
    ...
    static Pair<Integer, TrackEncryptionBox> parseCommonEncryptionSinfFromParent(ParsableByteArray parsableByteArray, int i, int i2) {
        ...
        if (!C1041C.CENC_TYPE_cenc.equals(string) && !C1041C.CENC_TYPE_cbc1.equals(string) && !C1041C.CENC_TYPE_cens.equals(string) && !C1041C.CENC_TYPE_cbcs.equals(string)) {
            return null;
        }
