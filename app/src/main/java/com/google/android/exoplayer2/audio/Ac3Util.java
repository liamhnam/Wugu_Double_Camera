...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, UiPosIndexEnum.HOME_COUNTDOWN, 128, 160, 192, 224, 256, UiPosIndexEnum.PAYMENT_ZHIFUBAO_IC, 384, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, DNPPhotoPrint.OVERCOAT_FINISH_PMATTE12, 139, PageAttribute.MediaTypeID.EPS_MTID_BARYTA, 208, 243, 278, 348, HttpStatus.SC_EXPECTATION_FAILED, 487, UiPosIndexEnum.PHOTO_BTN_FILTER, UiPosIndexEnum.PRINT_SIGN_CLEAR, 835, 975, 1114, 1253, 1393};
    ...
    public static int parseAc3SyncframeSize(byte[] bArr) {
        ...
        byte b = bArr[4];
        return getAc3SyncframeSize((b & SnmpConstants.ASN_PRIVATE) >> 6, b & Utf8.REPLACEMENT_BYTE);
    }

    public static int parseAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        if (((byteBuffer.get(byteBuffer.position() + 5) & 248) >> 3) > 10) {
            return BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[((byteBuffer.get(byteBuffer.position() + 4) & SnmpConstants.ASN_PRIVATE) >> 6) != 3 ? (byteBuffer.get(byteBuffer.position() + 4) & SnmpConstants.CONS_SEQ) >> 4 : 3] * 256;
        }
