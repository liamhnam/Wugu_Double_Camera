...
public final class Loader implements LoaderErrorThrower {
    ...
    static {
        ...
        RETRY = createRetryAction(false, C1041C.TIME_UNSET);
        RETRY_RESET_ERROR_COUNT = createRetryAction(true, C1041C.TIME_UNSET);
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.m343e(TAG, "Unexpected error loading stream", e2);
                if (!this.released) {
                ...
                Log.m343e(TAG, "Unexpected exception loading stream", e3);
                if (this.released) {
                    return;
                }
                obtainMessage(3, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (OutOfMemoryError e4) {
                Log.m343e(TAG, "OutOfMemory error loading stream", e4);
                if (this.released) {
                    return;
                }
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 2) {
                try {
                    ...
                    Log.m343e(TAG, "Unexpected exception handling load completed", e);
            ...
            if (loadErrorActionOnLoadError.type != 3) {
                if (loadErrorActionOnLoadError.type != 2) {
                    ...
                    if (loadErrorActionOnLoadError.retryDelayMillis != C1041C.TIME_UNSET) {
