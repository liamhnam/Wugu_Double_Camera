...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    protected TrackSelection.Definition[] selectAllTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        ...
        while (true) {
            ...
            if (2 == mappedTrackInfo.getRendererType(i4)) {
                if (!z2) {
                    TrackSelection.Definition definitionSelectVideoTrack = selectVideoTrack(mappedTrackInfo.getTrackGroups(i4), iArr[i4], iArr2[i4], parameters, true);
        ...
        while (i5 < rendererCount) {
            if (z == mappedTrackInfo.getRendererType(i5)) {
                ...
                str2 = str3;
                i2 = i5;
                Pair<TrackSelection.Definition, AudioTrackScore> pairSelectAudioTrack = selectAudioTrack(mappedTrackInfo.getTrackGroups(i5), iArr[i5], iArr2[i5], parameters, z4);
        ...
        while (i3 < rendererCount) {
            ...
            if (rendererType == 1) {
                ...
                str = str4;
                Pair<TrackSelection.Definition, TextTrackScore> pairSelectTextTrack = selectTextTrack(mappedTrackInfo.getTrackGroups(i3), iArr[i3], parameters, str);
                if (pairSelectTextTrack != null && (textTrackScore == null || ((TextTrackScore) pairSelectTextTrack.second).compareTo(textTrackScore) > 0)) {
                    ...
                    definitionArr[i3] = (TrackSelection.Definition) pairSelectTextTrack.first;
    ...
    */
    private static com.google.android.exoplayer2.trackselection.TrackSelection.Definition selectFixedVideoTrack(com.google.android.exoplayer2.source.TrackGroupArray r19, int[][] r20, com.google.android.exoplayer2.trackselection.DefaultTrackSelector.Parameters r21) {
        /*
    ...
    private static boolean rendererSupportsTunneling(int[][] iArr, TrackGroupArray trackGroupArray, TrackSelection trackSelection) {
        ...
        for (int i = 0; i < trackSelection.length(); i++) {
            if (RendererCapabilities.getTunnelingSupport(iArr[iIndexOf][trackSelection.getIndexInTrackGroup(i)]) != 32) {
                return false;
            }
        }
        return true;
    ...
    protected static String normalizeUndeterminedLanguageToNull(String str) {
        if (TextUtils.isEmpty(str) || TextUtils.equals(str, C1041C.LANGUAGE_UNDETERMINED)) {
            return null;
        }
        return str;
    }
