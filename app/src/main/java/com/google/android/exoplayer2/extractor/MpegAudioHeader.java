...
public final class MpegAudioHeader {
    ...
    private static final int[] BITRATE_V1_L3 = {32000, Priority.ERROR_INT, 48000, 56000, 64000, 80000, 96000, 112000, 128000, 160000, 192000, 224000, 256000, 320000};
    private static final int[] BITRATE_V2 = {8000, 16000, 24000, 32000, Priority.ERROR_INT, 48000, 56000, 64000, 80000, 96000, 112000, 128000, 144000, 160000};
    ...
    public static int getFrameSize(int i) {
        ...
        int i9 = SyslogAppender.LOG_LOCAL2;
        if (i2 == 3) {
            return ((i6 * SyslogAppender.LOG_LOCAL2) / i7) + i8;
        }
        if (i3 == 1) {
            i9 = 72;
        }
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        if (i3 == 3) {
            ...
            if (i2 == 3) {
                i6 = i3 == 2 ? BITRATE_V1_L2[i4 - 1] : BITRATE_V1_L3[i4 - 1];
                i7 = (i6 * SyslogAppender.LOG_LOCAL2) / i10;
            } else {
                i6 = BITRATE_V2[i4 - 1];
                i7 = ((i3 == 1 ? 72 : SyslogAppender.LOG_LOCAL2) * i6) / i10;
            }
            i8 = i7 + i11;
        }
