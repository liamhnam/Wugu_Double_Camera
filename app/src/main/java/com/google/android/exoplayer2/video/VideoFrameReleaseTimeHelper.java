...
public final class VideoFrameReleaseTimeHelper {
    ...
    public VideoFrameReleaseTimeHelper(Context context) {
        ...
        this.vsyncDurationNs = C1041C.TIME_UNSET;
        this.vsyncOffsetNs = C1041C.TIME_UNSET;
    }
    ...
    public long adjustReleaseTime(long j, long j2) {
        ...
        if (vSyncSampler == null || this.vsyncDurationNs == C1041C.TIME_UNSET) {
            return j3;
        }
        long j7 = vSyncSampler.sampledVsyncTimeNs;
        return j7 == C1041C.TIME_UNSET ? j3 : closestVsync(j3, j7, this.vsyncDurationNs) - this.vsyncOffsetNs;
    }

    private DefaultDisplayListener maybeBuildDefaultDisplayListenerV17(Context context) {
        DisplayManager displayManager = (DisplayManager) context.getSystemService(IdentifyAction.display);
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C1041C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (i == 0) {
                ...
                this.sampledVsyncTimeNs = C1041C.TIME_UNSET;
            }
        }
    }
}
