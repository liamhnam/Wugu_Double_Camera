...
public final class AdPlaybackState {
    ...
    public static final class AdGroup {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(jArrCopyOf, length, iMax, C1041C.TIME_UNSET);
            return jArrCopyOf;
        }
    }
    ...
    public AdPlaybackState(long... jArr) {
        ...
        this.contentDurationUs = C1041C.TIME_UNSET;
    }
    ...
    private boolean isPositionBeforeAdGroup(long j, int i) {
        ...
        return j3 == C1041C.TIME_UNSET || j < j3;
    }
}
