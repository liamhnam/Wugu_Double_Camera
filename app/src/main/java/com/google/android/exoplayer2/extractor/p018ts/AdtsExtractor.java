    ...
    */
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput r9) throws java.lang.InterruptedException, java.io.IOException {
        ...
        L8:
            ...
            boolean r5 = com.google.android.exoplayer2.extractor.p018ts.AdtsReader.isAdtsSyncWord(r5)
            if (r5 != 0) goto L31
        ...
        L55:
            ...
            goto L8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p018ts.AdtsExtractor.sniff(com.google.android.exoplayer2.extractor.ExtractorInput):boolean");
    }
    ...
    private void maybeOutputSeekMap(long j, boolean z, boolean z2) {
        ...
        if (z3 && this.reader.getSampleDurationUs() == C1041C.TIME_UNSET && !z2) {
            return;
        }
        ExtractorOutput extractorOutput = (ExtractorOutput) Assertions.checkNotNull(this.extractorOutput);
        if (z3 && this.reader.getSampleDurationUs() != C1041C.TIME_UNSET) {
