...
public abstract class BinarySearchSeeker {
    ...
    public static final class TimestampSearchResult {
        public static final TimestampSearchResult NO_TIMESTAMP_IN_RANGE_RESULT = new TimestampSearchResult(-3, C1041C.TIME_UNSET, -1);
        ...
        public static TimestampSearchResult targetFoundResult(long j) {
            return new TimestampSearchResult(0, C1041C.TIME_UNSET, j);
        }
    }
