...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == C1041C.TIME_UNSET) || (this.timestampAdjuster.getFirstSampleTimestampUs() != 0 && this.timestampAdjuster.getFirstSampleTimestampUs() != j2)) {
