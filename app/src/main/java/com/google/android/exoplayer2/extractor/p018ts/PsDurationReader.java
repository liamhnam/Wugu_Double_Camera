...
final class PsDurationReader {
    ...
    private long firstScrValue = C1041C.TIME_UNSET;
    private long lastScrValue = C1041C.TIME_UNSET;
    ...
    public int readDuration(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException {
        ...
        if (this.lastScrValue == C1041C.TIME_UNSET) {
    ...
    public static long readScrValueFromPack(ParsableByteArray parsableByteArray) {
        ...
        return !checkMarkerBits(bArr) ? C1041C.TIME_UNSET : readScrValueFromPackHeader(bArr);
    }
