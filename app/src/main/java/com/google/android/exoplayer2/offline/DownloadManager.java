...
public final class DownloadManager {
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandler = Util.createHandler(new Handler.Callback() {
            @Override
        ...
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() {
            @Override
    ...
    static final class InternalHandler extends Handler {
        ...
        private void initialize(int i) {
            ...
            try {
                try {
                    ...
                    Log.m343e(DownloadManager.TAG, "Failed to load index.", e);
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m343e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m343e(DownloadManager.TAG, "Failed to set manual stop reason: " + str, e2);
                    }
                }
            }
            syncTasks();
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            Download download = getDownload(downloadRequest.f582id, true);
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                Log.m342e(DownloadManager.TAG, "Failed to remove nonexistent download: " + str);
            } else {
        ...
        private void removeAllDownloads() {
            ...
            try {
                ...
                Log.m342e(DownloadManager.TAG, "Failed to load downloads.");
            }
            for (int i = 0; i < this.downloads.size(); i++) {
            ...
            try {
                ...
                Log.m343e(DownloadManager.TAG, "Failed to update index.", e);
            }
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task taskSyncQueuedDownload = this.activeTasks.get(download.request.f582id);
                int i3 = download.state;
                if (i3 == 0) {
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(downloadPutDownloadWithState.request.f582id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(download.request.f582id, task2);
                task2.start();
                return;
            }
            if (task.isRemove) {
        ...
        private void onContentLengthChanged(Task task) {
            String str = task.request.f582id;
        ...
        private void onTaskStopped(Task task) {
            ...
            if (th != null) {
                Log.m343e(DownloadManager.TAG, "Task failed: " + task.request + ", " + z, th);
            }
            Download download = (Download) Assertions.checkNotNull(getDownload(str, false));
            int i2 = download.state;
            if (i2 == 2) {
        ...
        private void onDownloadTaskStopped(Download download, Throwable th) {
            ...
            this.downloads.remove(getDownloadIndex(download2.request.f582id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            if (download.state == 7) {
                ...
                this.downloads.remove(getDownloadIndex(download.request.f582id));
                try {
                    this.downloadIndex.removeDownload(download.request.f582id);
                } catch (IOException unused) {
                    Log.m342e(DownloadManager.TAG, "Failed to remove from database");
                }
        ...
        */
        private com.google.android.exoplayer2.offline.Download putDownloadWithState(com.google.android.exoplayer2.offline.Download r2, int r3) {
            /*
                r1 = this;
                r0 = 3
                if (r3 == r0) goto La
            ...
            Lb:
                ...
                com.google.android.exoplayer2.offline.Download r2 = copyDownloadWithState(r2, r3)
                com.google.android.exoplayer2.offline.Download r2 = r1.putDownload(r2)
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.offline.DownloadManager.InternalHandler.putDownloadWithState(com.google.android.exoplayer2.offline.Download, int):com.google.android.exoplayer2.offline.Download");
        }

        private Download putDownload(Download download) {
            Assertions.checkState((download.state == 3 || download.state == 4) ? false : true);
            int downloadIndex = getDownloadIndex(download.request.f582id);
            if (downloadIndex == -1) {
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                Log.m343e(DownloadManager.TAG, "Failed to load download: " + str, e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f582id.equals(str)) {
                    return i;
                }
            }
            return -1;
