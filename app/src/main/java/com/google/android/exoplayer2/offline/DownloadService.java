        ...
        switch (action) {
            case "com.google.android.exoplayer.downloadService.action.ADD_DOWNLOAD":
                ...
                if (downloadRequest == null) {
                    Log.m342e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                } else {
            ...
            case "com.google.android.exoplayer.downloadService.action.SET_REQUIREMENTS":
                ...
                if (requirements == null) {
                    Log.m342e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                } else {
            ...
            case "com.google.android.exoplayer.downloadService.action.SET_STOP_REASON":
                if (!intent.hasExtra(KEY_STOP_REASON)) {
                    Log.m342e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                } else {
            ...
            case "com.google.android.exoplayer.downloadService.action.REMOVE_DOWNLOAD":
                if (stringExtra == null) {
                    Log.m342e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                } else {
                ...
                break;
            default:
                Log.m342e(TAG, "Ignored unrecognized action: " + action);
                break;
        }
    ...
    static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                new Handler().postAtFrontOfQueue(new Runnable() {
                    @Override
                    public final void run() {
                        this.f$0.m318x5d17c8bb(downloadService);
                    }
                });
            }
        }

        void m318x5d17c8bb(DownloadService downloadService) {
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m346w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                ...
                try {
                    ...
                    Log.m346w(DownloadService.TAG, "Failed to restart DownloadService (process is idle).");
                }
            }
        }
        ...
        private void updateScheduler() {
            ...
            if (this.downloadManager.isWaitingForRequirements()) {
                ...
                Log.m342e(DownloadService.TAG, "Scheduling downloads failed.");
                return;
            }
            this.scheduler.cancel();
        }
