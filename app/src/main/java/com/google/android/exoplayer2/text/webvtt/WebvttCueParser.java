...
public final class WebvttCueParser {
    ...
    static void parseCueSettingsList(String str, WebvttCue.Builder builder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                } else if (MediaInformation.KEY_SIZE.equals(strGroup)) {
                    builder.setWidth(WebvttParserUtil.parsePercentage(strGroup2));
                } else {
                    Log.m346w(TAG, "Unknown cue setting " + strGroup + ":" + strGroup2);
                }
            } catch (NumberFormatException unused) {
                Log.m346w(TAG, "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static boolean parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, WebvttCue.Builder builder, StringBuilder sb, List<WebvttCssStyle> list) {
        try {
            ...
            Log.m346w(TAG, "Skipping cue with bad header: " + matcher.group());
            return false;
        }
    }
    ...
    private static int parsePositionAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m346w(TAG, "Invalid anchor value: " + str);
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m346w(TAG, "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m346w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
