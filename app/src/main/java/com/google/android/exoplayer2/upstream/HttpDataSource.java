...
public interface HttpDataSource extends DataSource {
    ...
    static boolean lambda$static$0(String str) {
        ...
        return (TextUtils.isEmpty(lowerInvariant) || (lowerInvariant.contains("text") && !lowerInvariant.contains(MimeTypes.TEXT_VTT)) || lowerInvariant.contains("html") || lowerInvariant.contains(XMLConstants.XML_NS_PREFIX)) ? false : true;
    }
