...
public final class Mp3Extractor implements Extractor {
    ...
    private static final Id3Decoder.FramePredicate REQUIRED_ID3_FRAME_PREDICATE = new Id3Decoder.FramePredicate() {
        @Override
    ...
    static boolean lambda$static$1(int i, int i2, int i3, int i4, int i5) {
    ...
    public Mp3Extractor(int i, long j) {
        ...
        this.basisTimeUs = C1041C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws InterruptedException, IOException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C1041C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C1041C.TIME_UNSET) {
