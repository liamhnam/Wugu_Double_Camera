    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = C155335.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        ...
        TypeAdapter<URL> typeAdapter9 = new TypeAdapter<URL>() {
            ...
            public URL read(JsonReader jsonReader) throws IOException {
                ...
                String strNextString = jsonReader.nextString();
                if (Configurator.NULL.equals(strNextString)) {
                    return null;
                }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() {
            private JsonElement tryBeginNesting(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i = C155335.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i == 4) {
                    jsonReader.beginArray();
