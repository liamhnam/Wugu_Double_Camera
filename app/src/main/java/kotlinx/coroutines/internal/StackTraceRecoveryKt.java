...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1772constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1772constructorimpl = Result.m1772constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m1775exceptionOrNullimpl(objM1772constructorimpl) == null) {
            obj2 = objM1772constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1772constructorimpl2 = Result.m1772constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1772constructorimpl2 = Result.m1772constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1775exceptionOrNullimpl(objM1772constructorimpl2) == null) {
            obj = objM1772constructorimpl2;
        }
    ...
    private static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m1300to(cause, stackTrace);
            }
            return TuplesKt.m1300to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m1300to(e, new StackTraceElement[0]);
    }
