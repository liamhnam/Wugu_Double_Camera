...
@Metadata(m1292d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a2\u0010\u0000\u001a\u00020\u00012\u001f\b\u0004\u0010\u0002\u001a\u0019\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\u0004\u0012\u0004\u0012\u00020\u00010\u0003¢\u0006\u0002\b\u0006H\u0087Hø\u0001\u0000¢\u0006\u0002\u0010\u0007\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\b"}, m1293d2 = {"whileSelect", "", "builder", "Lkotlin/Function1;", "Lkotlinx/coroutines/selects/SelectBuilder;", "", "Lkotlin/ExtensionFunctionType;", "(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, m1294k = 2, m1295mv = {1, 6, 0}, m1297xi = 48)
public final class WhileSelectKt {

    @Metadata(m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 176)
    @DebugMetadata(m1304c = "kotlinx.coroutines.selects.WhileSelectKt", m1305f = "WhileSelect.kt", m1306i = {0}, m1307l = {37}, m1308m = "whileSelect", m1309n = {"builder"}, m1310s = {"L$0"})
    static final class C27631 extends ContinuationImpl {
        Object L$0;
        int label;
        Object result;

        C27631(Continuation<? super C27631> continuation) {
            super(continuation);
        }
    ...
    */
    public static final java.lang.Object whileSelect(kotlin.jvm.functions.Function1<? super kotlinx.coroutines.selects.SelectBuilder<? super java.lang.Boolean>, kotlin.Unit> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.selects.WhileSelectKt.C27631
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.selects.WhileSelectKt$whileSelect$1 r0 = (kotlinx.coroutines.selects.WhileSelectKt.C27631) r0
            int r1 = r0.label
