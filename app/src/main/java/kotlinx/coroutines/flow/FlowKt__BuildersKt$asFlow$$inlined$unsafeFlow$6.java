...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements Flow<T> {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", m1305f = "Builders.kt", m1306i = {0, 0}, m1307l = {115}, m1308m = "collect", m1309n = {"$this$asFlow_u24lambda_u2d11", "$this$forEach$iv"}, m1310s = {"L$0", "L$1"})
    public static final class C26411 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C26411(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) throws java.lang.Throwable {
        /*
            r7 = this;
            boolean r0 = r9 instanceof kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6.C26411
            if (r0 == 0) goto L14
            r0 = r9
            kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6$1 r0 = (kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6.C26411) r0
            int r1 = r0.label
