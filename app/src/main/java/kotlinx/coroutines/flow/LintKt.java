...
public final class LintKt {
    ...
    private static final <T> Flow<T> m3332catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m3324catch(sharedFlow, function3);
    }

    @Metadata(m1292d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m1293d2 = {"<anonymous>", "", "T", "it", ""}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 176)
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.LintKt$retry$1", m1305f = "Lint.kt", m1306i = {}, m1307l = {}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
    public static final class C27331 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        public C27331(Continuation<? super C27331> continuation) {
            super(2, continuation);
        }

        @Override
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C27331(continuation);
        }

        @Override
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C27331) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
