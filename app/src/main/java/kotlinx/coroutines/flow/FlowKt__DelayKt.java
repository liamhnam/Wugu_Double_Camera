...
final class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m3327debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m3284toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() {
            ...
            @Override
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m3284toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", m1305f = "Delay.kt", m1306i = {0, 0, 0, 0}, m1307l = {352}, m1308m = "invokeSuspend", m1309n = {"downstream", "values", "lastValue", "ticker"}, m1310s = {"L$0", "L$1", "L$2", "L$3"})
    static final class C26592<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        C26592(long j, Flow<? extends T> flow, Continuation<? super C26592> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C26592 c26592 = new C26592(this.$periodMillis, this.$this_sample, continuation);
            c26592.L$0 = coroutineScope;
            c26592.L$1 = flowCollector;
            return c26592.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                ...
                this.label = 1;
                C26592<T> c26592 = this;
                SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(c26592);
                try {
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c26592);
                }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C26592(j, flow, null));
    }
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3", m1305f = "Delay.kt", m1306i = {0, 1, 2}, m1307l = {314, 316, 317}, m1308m = "invokeSuspend", m1309n = {"$this$produce", "$this$produce", "$this$produce"}, m1310s = {"L$0", "L$0", "L$0"})
    static final class C26583 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        final long $delayMillis;
        final long $initialDelayMillis;
        private Object L$0;
        int label;

        C26583(long j, long j2, Continuation<? super C26583> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C26583 c26583 = new C26583(this.$initialDelayMillis, this.$delayMillis, continuation);
            c26583.L$0 = obj;
            return c26583;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C26583) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L57:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C26583.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C26583(j2, j, null), 1, null);
    }

    public static final <T> Flow<T> m3328sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m3284toDelayMillisLRDsOJo(j));
    }
}
