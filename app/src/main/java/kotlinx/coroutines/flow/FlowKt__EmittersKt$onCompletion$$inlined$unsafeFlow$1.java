...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1", m1305f = "Emitters.kt", m1306i = {0, 0, 1, 2}, m1307l = {114, DNPPhotoPrint.OVERCOAT_FINISH_PMATTE12, 128}, m1308m = "collect", m1309n = {"this", "$this$onCompletion_u24lambda_u2d2", Media.f729e, "sc"}, m1310s = {"L$0", "L$1", "L$0", "L$0"})
    public static final class C26611 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        Object result;

        public C26611(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        /*
            r8 = this;
            boolean r0 = r10 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1.C26611
            if (r0 == 0) goto L14
            r0 = r10
            kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1.C26611) r0
            int r1 = r0.label
