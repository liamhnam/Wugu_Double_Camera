...
@DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1", m1305f = "Zip.kt", m1306i = {}, m1307l = {273}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
public final class C2724xd7c321e6<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    final Flow[] $flows;
    final Function4 $transform$inlined;
    private Object L$0;
    int label;

    public C2724xd7c321e6(Flow[] flowArr, Continuation continuation, Function4 function4) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C2724xd7c321e6 c2724xd7c321e6 = new C2724xd7c321e6(this.$flows, continuation, this.$transform$inlined);
        c2724xd7c321e6.L$0 = obj;
        return c2724xd7c321e6;
    }

    @Override
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C2724xd7c321e6) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1$1", m1305f = "Zip.kt", m1306i = {}, m1307l = {UiPosIndexEnum.PAYMENT_DOU_YIN_IC}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
