...
@Metadata(m1292d1 = {"\u0000$\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\u0010\u0000\n\u0002\b\u0002\u001a!\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u0086@ø\u0001\u0000¢\u0006\u0002\u0010\u0004\u001aE\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\"\u0010\u0005\u001a\u001e\b\u0001\u0012\u0004\u0012\u0002H\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u0007\u0012\u0006\u0012\u0004\u0018\u00010\t0\u0006H\u0086@ø\u0001\u0000¢\u0006\u0002\u0010\n\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000b"}, m1293d2 = {"count", "", "T", "Lkotlinx/coroutines/flow/Flow;", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "predicate", "Lkotlin/Function2;", "Lkotlin/coroutines/Continuation;", "", "", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, m1294k = 5, m1295mv = {1, 6, 0}, m1297xi = 48, m1298xs = "kotlinx/coroutines/flow/FlowKt")
final class FlowKt__CountKt {

    @Metadata(m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__CountKt", m1305f = "Count.kt", m1306i = {0}, m1307l = {18}, m1308m = "count", m1309n = {"i"}, m1310s = {"L$0"})
    static final class C26511<T> extends ContinuationImpl {
        Object L$0;
        int label;
        Object result;

        C26511(Continuation<? super C26511> continuation) {
            super(continuation);
        }
    ...
    @Metadata(m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__CountKt", m1305f = "Count.kt", m1306i = {0}, m1307l = {30}, m1308m = "count", m1309n = {"i"}, m1310s = {"L$0"})
    static final class C26533<T> extends ContinuationImpl {
        Object L$0;
        int label;
        Object result;

        C26533(Continuation<? super C26533> continuation) {
            super(continuation);
        }
    ...
    */
    public static final <T> java.lang.Object count(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlin.coroutines.Continuation<? super java.lang.Integer> r5) throws java.lang.Throwable {
        /*
            boolean r0 = r5 instanceof kotlinx.coroutines.flow.FlowKt__CountKt.C26511
            if (r0 == 0) goto L14
            r0 = r5
            kotlinx.coroutines.flow.FlowKt__CountKt$count$1 r0 = (kotlinx.coroutines.flow.FlowKt__CountKt.C26511) r0
            int r1 = r0.label
    ...
    */
    public static final <T> java.lang.Object count(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlin.jvm.functions.Function2<? super T, ? super kotlin.coroutines.Continuation<? super java.lang.Boolean>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super java.lang.Integer> r6) throws java.lang.Throwable {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__CountKt.C26533
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__CountKt$count$3 r0 = (kotlinx.coroutines.flow.FlowKt__CountKt.C26533) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    @Metadata(m1292d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m1293d2 = {"<anonymous>", "", "T", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    static final class C26544<T> implements FlowCollector {

        final Ref.IntRef f2744$i;
        final Function2<T, Continuation<? super Boolean>, Object> $predicate;

        C26544(Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Ref.IntRef intRef) {
        ...
        */
        public final java.lang.Object emit(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
            ...
            L19:
                ...
                kotlinx.coroutines.flow.FlowKt__CountKt$count$4 r5 = (kotlinx.coroutines.flow.FlowKt__CountKt.C26544) r5
                kotlin.ResultKt.throwOnFailure(r6)
                goto L47
            L2e:
            ...
            L47:
                ...
                if (r6 == 0) goto L5a
                kotlin.jvm.internal.Ref$IntRef r6 = r5.f2744$i
                int r0 = r6.element
                int r0 = r0 + r3
                r6.element = r0
                kotlin.jvm.internal.Ref$IntRef r5 = r5.f2744$i
                int r5 = r5.element
            L5a:
                kotlin.Unit r5 = kotlin.Unit.INSTANCE
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__CountKt.C26544.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
}
