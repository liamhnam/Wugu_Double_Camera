...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m1305f = "Reduce.kt", m1306i = {0, 0}, m1307l = {PageAttribute.MediaTypeID.EPS_MTID_PLOOFING_WHITE_MAT}, m1308m = "emit", m1309n = {"this", "it"}, m1310s = {"L$0", "L$1"})
    public static final class C26891 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        Object result;

        public C26891(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object emit(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.C26891
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2$1 r0 = (kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.C26891) r0
            int r1 = r0.label
