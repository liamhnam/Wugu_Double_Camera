...
@Metadata(m1292d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\u00020\u0005H\u008a@"}, m1293d2 = {"<anonymous>", "", "T1", "T2", "R", "Lkotlinx/coroutines/CoroutineScope;"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
@DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1", m1305f = "Combine.kt", m1306i = {0}, m1307l = {129}, m1308m = "invokeSuspend", m1309n = {"second"}, m1310s = {"L$0"})
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            ...
            if (ChannelFlowKt.withContextUndispatched$default(coroutineScope.getCoroutineContext().plus(completableJobJob$default), Unit.INSTANCE, null, new C27472(this.$flow, coroutineContext, objThreadContextElements, receiveChannelProduce$default, this.$this_unsafeFlow, this.$transform, null), this, 4, null) == coroutine_suspended) {
    ...
    @Metadata(m1292d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u00020\u0001H\u008a@"}, m1293d2 = {"<anonymous>", "", "T1", "T2", "R", "it"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2", m1305f = "Combine.kt", m1306i = {}, m1307l = {130}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
    static final class C27472 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        final Object $cnt;
        final Flow<T1> $flow;
        ...
        C27472(Flow<? extends T1> flow, CoroutineContext coroutineContext, Object obj, ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super C27472> continuation) {
            super(2, continuation);
            this.$flow = flow;
        ...
        @Override
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C27472(this.$flow, this.$scopeContext, this.$cnt, this.$second, this.$this_unsafeFlow, this.$transform, continuation);
        }

        @Override
        public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
            return ((C27472) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        @Metadata(m1292d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0006\u0010\u0007"}, m1293d2 = {"<anonymous>", "", "T1", "T2", "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            @Metadata(m1292d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u00020\u0001H\u008a@"}, m1293d2 = {"<anonymous>", "", "T1", "T2", "R", "it"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
            @DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2$1$1", m1305f = "Combine.kt", m1306i = {}, m1307l = {132, TsExtractor.TS_STREAM_TYPE_E_AC3, TsExtractor.TS_STREAM_TYPE_E_AC3}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
            static final class C33841 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final ReceiveChannel<Object> $second;
                final FlowCollector<R> $this_unsafeFlow;
                final Function3<T1, T2, Continuation<? super R>, Object> $transform;
                final T1 $value;
                ...
                C33841(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C33841> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C33841(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }

                @Override
                public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
                    return ((C33841) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r9) throws java.lang.Throwable {
                    ...
                    L30:
                        ...
                        r8.label = r5
                        java.lang.Object r9 = r9.mo3299receiveCatchingJP2dKIU(r1)
                        if (r9 != r0) goto L41
                        return r0
                    L41:
                        ...
                        if (r5 == 0) goto L55
                        java.lang.Throwable r9 = kotlinx.coroutines.channels.ChannelResult.m3310exceptionOrNullimpl(r9)
                        if (r9 != 0) goto L54
                    ...
                    L77:
                        ...
                        return r9
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.C27472.AnonymousClass1.C33841.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            }
            ...
            */
            public final java.lang.Object emit(T1 r13, kotlin.coroutines.Continuation<? super kotlin.Unit> r14) throws java.lang.Throwable {
                ...
                L54:
                    ...
                    return r13
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.C27472.AnonymousClass1.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
        }
