...
@Metadata(m1292d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u008a@"}, m1293d2 = {"<anonymous>", "", "T1", "T2", "R", "Lkotlinx/coroutines/channels/ProducerScope;", ""}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
@DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1", m1305f = "Combine.kt", m1306i = {}, m1307l = {92}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C27481<T> implements FlowCollector {
        final ProducerScope<Object> $$this$produce;

        C27481(ProducerScope<Object> producerScope) {
        ...
        */
        public final java.lang.Object emit(T2 r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
            ...
            L48:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1.C27481.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C27481 c27481 = new C27481(producerScope);
            this.label = 1;
            if (flow.collect(c27481, this) == coroutine_suspended) {
