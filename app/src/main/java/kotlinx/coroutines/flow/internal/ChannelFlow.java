...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    */
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m1305f = "ChannelFlow.kt", m1306i = {}, m1307l = {123}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
    static final class C27412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final FlowCollector<T> $collector;
        private Object L$0;
        int label;
        final ChannelFlow<T> this$0;

        C27412(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C27412> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C27412 c27412 = new C27412(this.$collector, this.this$0, continuation);
            c27412.L$0 = obj;
            return c27412;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C27412) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static Object collect$suspendImpl(ChannelFlow channelFlow, FlowCollector flowCollector, Continuation continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C27412(flowCollector, channelFlow, null), continuation);
