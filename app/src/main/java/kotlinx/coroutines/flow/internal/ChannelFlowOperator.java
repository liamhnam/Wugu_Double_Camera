...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public final Object collectWithContextUndispatched(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext, Continuation<? super Unit> continuation) {
        Object objWithContextUndispatched$default = ChannelFlowKt.withContextUndispatched$default(coroutineContext, ChannelFlowKt.withUndispatchedContextCollector(flowCollector, continuation.get$context()), null, new C27432(this, null), continuation, 4, null);
    ...
    @Metadata(m1292d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0005H\u008a@"}, m1293d2 = {"<anonymous>", "", "S", "T", "it", "Lkotlinx/coroutines/flow/FlowCollector;"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", m1305f = "ChannelFlow.kt", m1306i = {}, m1307l = {SyslogAppender.LOG_LOCAL3}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
    static final class C27432 extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        Object L$0;
        int label;
        final ChannelFlowOperator<S, T> this$0;

        C27432(ChannelFlowOperator<S, T> channelFlowOperator, Continuation<? super C27432> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C27432 c27432 = new C27432(this.this$0, continuation);
            c27432.L$0 = obj;
            return c27432;
        }
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C27432) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
