...
@DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$3", m1305f = "Zip.kt", m1306i = {}, m1307l = {273}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
public final class C2726xd7c321e8<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    final Flow[] $flows;
    final Function5 $transform$inlined;
    private Object L$0;
    int label;

    public C2726xd7c321e8(Flow[] flowArr, Continuation continuation, Function5 function5) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C2726xd7c321e8 c2726xd7c321e8 = new C2726xd7c321e8(this.$flows, continuation, this.$transform$inlined);
        c2726xd7c321e8.L$0 = obj;
        return c2726xd7c321e8;
    }

    @Override
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C2726xd7c321e8) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$3$1", m1305f = "Zip.kt", m1306i = {}, m1307l = {UiPosIndexEnum.PAYMENT_DOU_YIN_IC}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
