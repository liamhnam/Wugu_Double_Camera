...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m1305f = "Builders.kt", m1306i = {0}, m1307l = {UiPosIndexEnum.PAYMENT_XIE_CHENG_IC}, m1308m = "collectTo", m1309n = {"scope"}, m1310s = {"L$0"})
    static final class C26331 extends ContinuationImpl {
        Object L$0;
        int label;
        Object result;
        final CallbackFlowBuilder<T> this$0;

        C26331(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C26331> continuation) {
            super(continuation);
    ...
    */
    protected java.lang.Object collectTo(kotlinx.coroutines.channels.ProducerScope<? super T> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.CallbackFlowBuilder.C26331
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 r0 = (kotlinx.coroutines.flow.CallbackFlowBuilder.C26331) r0
            int r1 = r0.label
