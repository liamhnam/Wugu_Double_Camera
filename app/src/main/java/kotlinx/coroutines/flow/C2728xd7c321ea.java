...
@DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$5", m1305f = "Zip.kt", m1306i = {}, m1307l = {273}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
public final class C2728xd7c321ea<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    final Flow[] $flows;
    final Function7 $transform$inlined;
    private Object L$0;
    int label;

    public C2728xd7c321ea(Flow[] flowArr, Continuation continuation, Function7 function7) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C2728xd7c321ea c2728xd7c321ea = new C2728xd7c321ea(this.$flows, continuation, this.$transform$inlined);
        c2728xd7c321ea.L$0 = obj;
        return c2728xd7c321ea;
    }

    @Override
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C2728xd7c321ea) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$5$1", m1305f = "Zip.kt", m1306i = {}, m1307l = {UiPosIndexEnum.PAYMENT_DOU_YIN_IC}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
