...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1", m1305f = "Limit.kt", m1306i = {0}, m1307l = {124}, m1308m = "collect", m1309n = {"collector$iv"}, m1310s = {"L$0"})
    public static final class C26741 extends ContinuationImpl {
        Object L$0;
        int label;
        Object result;

        public C26741(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1.C26741
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1.C26741) r0
            int r1 = r0.label
