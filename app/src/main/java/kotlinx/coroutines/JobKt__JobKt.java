...
public final class JobKt__JobKt {
    ...
    public static final Job m3287Job(Job job) {
        return JobKt.Job(job);
    }

    public static Job m3288Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m3287Job(job);
