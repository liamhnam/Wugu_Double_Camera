...
public final class DebugProbesImpl {
    ...
    private static final SequenceNumberRefVolatile debugProbesImpl$SequenceNumberRefVolatile;
    ...
    static {
        ...
        debugProbesImpl$SequenceNumberRefVolatile = new Object(0L) {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (objNewInstance != null) {
            objM1772constructorimpl = Result.m1772constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m1778isFailureimpl(objM1772constructorimpl)) {
                objM1772constructorimpl = null;
            }
            return (Function1) objM1772constructorimpl;
        }
    ...
    private final void startWeakRefCleanerThread() {
        weakRefCleanerThread = ThreadsKt.thread$default(false, true, null, "Coroutines Debugger Cleaner", 0, new Function0<Unit>() {
            @Override
            public Unit invoke() {
                invoke2();
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(final Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> create) {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C2628x8808a3e8()), new Function1<CoroutineOwner<?>, R>() {
                {
                    super(1);
                }
    ...
    private final void dumpCoroutinesSynchronized(PrintStream out) {
        ...
        try {
            ...
            for (CoroutineOwner coroutineOwner : SequencesKt.sortedWith(SequencesKt.filter(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new Function1<CoroutineOwner<?>, Boolean>() {
                @Override
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM1772constructorimpl = Result.m1772constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1772constructorimpl = Result.m1772constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM1772constructorimpl;
    ...
    private final Pair<Integer, Integer> findContinuationStartIndex(int indexOfResumeWith, StackTraceElement[] actualTrace, List<StackTraceElement> coroutineTrace) {
        for (int i = 0; i < 3; i++) {
            ...
            if (iFindIndexOfFrame != -1) {
                return TuplesKt.m1300to(Integer.valueOf(iFindIndexOfFrame), Integer.valueOf(i));
            }
        }
        return TuplesKt.m1300to(-1, 0);
    }
    ...
    public final List<DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C2628x8808a3e8()), new Function1<CoroutineOwner<?>, DebugCoroutineInfo>() {
                @Override
    ...
    public final List<DebuggerInfo> dumpDebuggerInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C2628x8808a3e8()), new Function1<CoroutineOwner<?>, DebuggerInfo>() {
                @Override
