...
public final class DebugCoroutineInfoImpl {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl", m1305f = "DebugCoroutineInfoImpl.kt", m1306i = {}, m1307l = {80}, m1308m = "yieldFrames", m1309n = {}, m1310s = {})
    static final class C26261 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        C26261(Continuation<? super C26261> continuation) {
            super(continuation);
        }
    ...
    private final List<StackTraceElement> creationStackTrace() {
        ...
        return stackTraceFrame == null ? CollectionsKt.emptyList() : SequencesKt.toList(SequencesKt.sequence(new C26251(stackTraceFrame, null)));
    }

    @Metadata(m1292d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m1293d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", "Ljava/lang/StackTraceElement;"}, m1294k = 3, m1295mv = {1, 6, 0}, m1297xi = 48)
    @DebugMetadata(m1304c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$creationStackTrace$1", m1305f = "DebugCoroutineInfoImpl.kt", m1306i = {}, m1307l = {75}, m1308m = "invokeSuspend", m1309n = {}, m1310s = {})
    static final class C26251 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super StackTraceElement>, Continuation<? super Unit>, Object> {
        final StackTraceFrame $bottom;
        private Object L$0;
        int label;

        C26251(StackTraceFrame stackTraceFrame, Continuation<? super C26251> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C26251 c26251 = DebugCoroutineInfoImpl.this.new C26251(this.$bottom, continuation);
            c26251.L$0 = obj;
            return c26251;
        }
        ...
        public final Object invoke(SequenceScope<? super StackTraceElement> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C26251) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    public final java.lang.Object yieldFrames(kotlin.sequences.SequenceScope<? super java.lang.StackTraceElement> r6, kotlin.coroutines.jvm.internal.CoroutineStackFrame r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl.C26261
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$yieldFrames$1 r0 = (kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl.C26261) r0
            int r1 = r0.label
