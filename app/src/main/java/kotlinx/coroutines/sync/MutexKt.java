...
public final class MutexKt {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.sync.MutexKt", m1305f = "Mutex.kt", m1306i = {0, 0, 0}, m1307l = {UiPosIndexEnum.HOME_COUNTDOWN}, m1308m = "withLock", m1309n = {"$this$withLock", "owner", "action"}, m1310s = {"L$0", "L$1", "L$2"})
    static final class C27641<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    */
    public static final <T> java.lang.Object withLock(kotlinx.coroutines.sync.Mutex r4, java.lang.Object r5, kotlin.jvm.functions.Function0<? extends T> r6, kotlin.coroutines.Continuation<? super T> r7) throws java.lang.Throwable {
        /*
            boolean r0 = r7 instanceof kotlinx.coroutines.sync.MutexKt.C27641
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.sync.MutexKt$withLock$1 r0 = (kotlinx.coroutines.sync.MutexKt.C27641) r0
            int r1 = r0.label
