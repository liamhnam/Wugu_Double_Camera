...
public final class SemaphoreKt {
    ...
    @DebugMetadata(m1304c = "kotlinx.coroutines.sync.SemaphoreKt", m1305f = "Semaphore.kt", m1306i = {0, 0}, m1307l = {85}, m1308m = "withPermit", m1309n = {"$this$withPermit", "action"}, m1310s = {"L$0", "L$1"})
    static final class C27651<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        Object result;
    ...
    */
    public static final <T> java.lang.Object withPermit(kotlinx.coroutines.sync.Semaphore r4, kotlin.jvm.functions.Function0<? extends T> r5, kotlin.coroutines.Continuation<? super T> r6) throws java.lang.Throwable {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.sync.SemaphoreKt.C27651
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.sync.SemaphoreKt$withPermit$1 r0 = (kotlinx.coroutines.sync.SemaphoreKt.C27651) r0
            int r1 = r0.label
