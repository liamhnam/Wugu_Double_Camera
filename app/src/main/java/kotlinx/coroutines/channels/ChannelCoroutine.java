...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    @Override
    public Object mo3299receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo3299receiveCatchingJP2dKIU(continuation);
    ...
    @Override
    public Object mo3300tryReceivePtdJZtk() {
        return this._channel.mo3300tryReceivePtdJZtk();
    }

    @Override
    public Object mo3301trySendJP2dKIU(E element) {
        return this._channel.mo3301trySendJP2dKIU(element);
    }
