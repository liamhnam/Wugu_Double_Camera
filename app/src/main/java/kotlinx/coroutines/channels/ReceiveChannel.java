...
public interface ReceiveChannel<E> {
    ...
    Object mo3299receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    Object mo3300tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo3300tryReceivePtdJZtk = receiveChannel.mo3300tryReceivePtdJZtk();
            if (ChannelResult.m3316isSuccessimpl(objMo3300tryReceivePtdJZtk)) {
                return (E) ChannelResult.m3312getOrThrowimpl(objMo3300tryReceivePtdJZtk);
            }
            Throwable thM3310exceptionOrNullimpl = ChannelResult.m3310exceptionOrNullimpl(objMo3300tryReceivePtdJZtk);
            if (thM3310exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM3310exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            /*
                boolean r0 = r5 instanceof kotlinx.coroutines.channels.ReceiveChannel.C26211
                if (r0 == 0) goto L14
                r0 = r5
                kotlinx.coroutines.channels.ReceiveChannel$receiveOrNull$1 r0 = (kotlinx.coroutines.channels.ReceiveChannel.C26211) r0
                int r1 = r0.label
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo3299receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
