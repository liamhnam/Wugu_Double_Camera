...
public interface SendChannel<E> {
    ...
    Object mo3301trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m3316isSuccessimpl(objMo3301trySendJP2dKIU)) {
                return true;
            }
            Throwable thM3310exceptionOrNullimpl = ChannelResult.m3310exceptionOrNullimpl(objMo3301trySendJP2dKIU);
