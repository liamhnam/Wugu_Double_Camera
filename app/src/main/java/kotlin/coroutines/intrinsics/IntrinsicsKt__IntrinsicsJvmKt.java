...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnintercepted(final Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> completion) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new RestrictedContinuationImpl(continuationProbeCoroutineCreated, function1) {
        ...
        return new ContinuationImpl(continuationProbeCoroutineCreated, context, function1) {
            final Function1 $this_createCoroutineUnintercepted$inlined;
            private int label;
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, final R r, Continuation<? super T> completion) {
        ...
        final CoroutineContext context = continuationProbeCoroutineCreated.getContext();
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new RestrictedContinuationImpl(continuationProbeCoroutineCreated, function2, r) {
        ...
        return new ContinuationImpl(continuationProbeCoroutineCreated, context, function2, r) {
            final Object $receiver$inlined;
            final Function2 $this_createCoroutineUnintercepted$inlined;
            private int label;
    ...
    private static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(final Continuation<? super T> continuation, final Function1<? super Continuation<? super T>, ? extends Object> function1) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new RestrictedContinuationImpl(continuation, function1) {
                ...
                protected java.lang.Object invokeSuspend(java.lang.Object r3) {
                    ...
                    L25:
                        return r3
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlin.coroutines.intrinsics.C2160x96e8297a.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            };
        }
        return new ContinuationImpl(continuation, context, function1) {
            final Function1<Continuation<? super T>, Object> $block;
            private int label;
            ...
            protected java.lang.Object invokeSuspend(java.lang.Object r3) {
                ...
                L25:
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.coroutines.intrinsics.C2161x96e8297b.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        };
    }
}
