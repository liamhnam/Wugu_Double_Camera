...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static void m3011getEndExclusivepVg5ArA$annotations() {
    }

    @Override
    public boolean contains(Comparable comparable) {
        return m3012containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override
    public Comparable getEndExclusive() {
        return UInt.m1861boximpl(m3013getEndExclusivepVg5ArA());
    }

    @Override
    public Comparable getEndInclusive() {
        return UInt.m1861boximpl(m3014getEndInclusivepVg5ArA());
    }

    @Override
    public Comparable getStart() {
        return UInt.m1861boximpl(m3015getStartpVg5ArA());
    }
    ...
    public int m3015getStartpVg5ArA() {
        return getFirst();
    }

    public int m3014getEndInclusivepVg5ArA() {
        return getLast();
    }

    public int m3013getEndExclusivepVg5ArA() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return UInt.m1867constructorimpl(getLast() + 1);
    }

    public boolean m3012containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return ((Object) UInt.m1913toStringimpl(getFirst())) + ".." + ((Object) UInt.m1913toStringimpl(getLast()));
    }

    @Metadata(m1292d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m1293d2 = {"Lkotlin/ranges/UIntRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/UIntRange;", "getEMPTY", "()Lkotlin/ranges/UIntRange;", "kotlin-stdlib"}, m1294k = 1, m1295mv = {1, 8, 0}, m1297xi = 48)
