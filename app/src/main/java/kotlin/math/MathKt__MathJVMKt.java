...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m1315ln(double d) {
        return Math.log(d);
    }
    ...
    private static final float m1316ln(float f) {
