...
public final class DurationKt {
    ...
    private static final long m3246timesmvk6XK0(int i, long j) {
        return Duration.m3158timesUwyO8pc(j, i);
    }

    private static final long m3245timeskIfJnKk(double d, long j) {
        return Duration.m3157timesUwyO8pc(j, d);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m3120constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m3120constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m3120constructorimpl((j << 1) + ((long) i));
    }
