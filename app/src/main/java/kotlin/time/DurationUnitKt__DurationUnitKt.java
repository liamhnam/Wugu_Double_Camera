...
@Metadata(m1292d1 = {"\u0000\u001c\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\f\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0001\u001a\u0010\u0010\u0006\u001a\u00020\u00012\u0006\u0010\u0007\u001a\u00020\bH\u0001\u001a\f\u0010\u0007\u001a\u00020\b*\u00020\u0001H\u0001¨\u0006\t"}, m1293d2 = {"durationUnitByIsoChar", "Lkotlin/time/DurationUnit;", "isoChar", "", "isTimeComponent", "", "durationUnitByShortName", "shortName", "", "kotlin-stdlib"}, m1294k = 5, m1295mv = {1, 8, 0}, m1297xi = 49, m1298xs = "kotlin/time/DurationUnitKt")
    ...
    public static final String shortName(DurationUnit durationUnit) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[durationUnit.ordinal()]) {
            ...
            case 4:
                return "s";
            case 5:
                return MaterialAmountUnit.f722m;
            case 6:
                return "h";
            case 7:
                return Media.f728d;
    ...
    public static final DurationUnit durationUnitByShortName(String shortName) {
        ...
        if (iHashCode != 100) {
            if (iHashCode != 104) {
                ...
                } else if (shortName.equals(MaterialAmountUnit.f722m)) {
                    return DurationUnit.MINUTES;
                }
            } else if (shortName.equals("h")) {
                return DurationUnit.HOURS;
            }
        } else if (shortName.equals(Media.f728d)) {
