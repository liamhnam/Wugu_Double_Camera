...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        static {
            ...
            BOOL = fieldType8;
            FieldType fieldType9 = new FieldType("STRING", 8, JavaType.STRING, i) {
                @Override
                public boolean isPackable() {
                    return false;
                }
            ...
            STRING = fieldType9;
            FieldType fieldType10 = new FieldType("GROUP", 9, JavaType.MESSAGE, 3) {
                @Override
                public boolean isPackable() {
                    return false;
                }
            ...
            GROUP = fieldType10;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, JavaType.MESSAGE, i) {
                @Override
                public boolean isPackable() {
                    return false;
                }
            ...
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, i) {
                @Override
                public boolean isPackable() {
                    return false;
                }
