...
public final class StandardClassIds {
    ...
    static {
        ...
        ClassId classIdBaseId8 = StandardClassIdsKt.baseId(PDLayoutAttributeObject.BORDER_STYLE_DOUBLE);
        ...
        List = StandardClassIdsKt.collectionsId(PDListAttributeObject.OWNER_LIST);
