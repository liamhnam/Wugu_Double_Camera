...
public final class ReflectionObjectRenderer {
    ...
    public final String renderFunction(FunctionDescriptor descriptor) {
        ...
        CollectionsKt.joinTo$default(valueParameters, sb, ", ", "(", ")", 0, null, new Function1<ValueParameterDescriptor, CharSequence>() {
            @Override
