...
public final class StandardNames {
    ...
    static {
        ...
        Name nameIdentifier5 = Name.identifier(PrinterServiceType.copy);
        ...
        Name nameIdentifier8 = Name.identifier("kotlin");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier8, "identifier(\"kotlin\")");
        BUILT_INS_PACKAGE_NAME = nameIdentifier8;
        FqName fqName3 = FqName.topLevel(nameIdentifier8);
    ...
    public static final class FqNames {
        ...
        static {
            ...
            _double = fqNames.fqNameUnsafe(PDLayoutAttributeObject.BORDER_STYLE_DOUBLE);
            ...
            list = fqNames.collectionsFqName(PDListAttributeObject.OWNER_LIST);
