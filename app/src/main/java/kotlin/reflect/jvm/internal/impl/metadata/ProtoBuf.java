    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
                            ...
                            try {
                                ...
                                switch (tag) {
                                    ...
                                    case SyslogAppender.LOG_LOCAL1:
                                        ...
                                        break;
                                    case 146:
                                        ?? builder = (this.bitField0_ & 16) == 16 ? this.inlineClassUnderlyingType_.toBuilder() : null;
                                        Type type = (Type) codedInputStream.readMessage(Type.PARSER, extensionRegistryLite);
                                    ...
                                    case 162:
                                        ...
                                        z = true;
                                        break;
                                    case SyslogAppender.LOG_LOCAL5:
                                        if ((i & 256) != 256) {
                                        ...
                                        z = true;
                                        break;
                                    case PowerState.Code.resetInit:
                                        ...
                                        break;
                                    case 242:
                                        ?? builder2 = (this.bitField0_ & 64) == 64 ? this.typeTable_.toBuilder() : null;
                                    ...
                                    case ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION:
                                        ...
                                        z = true;
                                        break;
                                    case WGL4Names.NUMBER_OF_MAC_GLYPHS:
                                        ?? builder3 = (this.bitField0_ & 128) == 128 ? this.versionRequirementTable_.toBuilder() : null;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getContextReceiverTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(PowerState.Code.resetInit);
        ...
        public int getSerializedSize() {
            ...
            for (int i14 = 0; i14 < this.versionRequirement_.size(); i14++) {
                iComputeInt32SizeNoTag5 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i14).intValue());
            }
            int size = iComputeMessageSize4 + iComputeInt32SizeNoTag5 + (getVersionRequirementList().size() * 2);
            if ((this.bitField0_ & 128) == 128) {
