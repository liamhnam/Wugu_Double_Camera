...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(TuplesKt.m1300to(JvmClassMappingKt.getJavaObjectType(kClass), JvmClassMappingKt.getJavaPrimitiveType(kClass)));
        }
        ...
        while (it2.hasNext()) {
            ...
            arrayList2.add(TuplesKt.m1300to(JvmClassMappingKt.getJavaPrimitiveType(kClass2), JvmClassMappingKt.getJavaObjectType(kClass2)));
        }
        ...
        for (Object obj : listListOf2) {
            ...
            arrayList3.add(TuplesKt.m1300to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        ...
        if (cls.isPrimitive()) {
            ...
            if (name != null) {
                switch (name.hashCode()) {
                    case -1325958191:
                        if (name.equals(Cups.PageBorder._double)) {
                            return "D";
                        }
                        break;
                    case 104431:
    ...
    public static final List<Type> getParameterizedTypeArguments(Type type) {
        ...
        if (parameterizedType.getOwnerType() != null) {
            return SequencesKt.toList(SequencesKt.flatMap(SequencesKt.generateSequence(type, new Function1<ParameterizedType, ParameterizedType>() {
                @Override
            ...
            }), new Function1<ParameterizedType, Sequence<? extends Type>>() {
                @Override
