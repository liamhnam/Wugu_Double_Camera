...
public final class ReflectionTypes {
    ...
    public ReflectionTypes(final ModuleDescriptor module, NotFoundClasses notFoundClasses) {
        ...
        this.kotlinReflectScope$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<MemberScope>() {
            {
                super(0);
            }
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor contributedClassifier = getKotlinReflectScope().mo3072getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
