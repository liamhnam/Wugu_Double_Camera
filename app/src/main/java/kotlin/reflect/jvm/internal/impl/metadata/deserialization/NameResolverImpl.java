...
public final class NameResolverImpl implements NameResolver {
    ...
    public String getQualifiedClassName(int i) {
        ...
        return listComponent1.isEmpty() ? strJoinToString$default : CollectionsKt.joinToString$default(listComponent1, MqttTopic.TOPIC_LEVEL_SEPARATOR, null, null, 0, null, null, 62, null) + '/' + strJoinToString$default;
    }
