...
public final class JavaAnnotationTargetMapper {
    ...
    private static final Map<String, EnumSet<KotlinTarget>> targetNameLists = MapsKt.mapOf(TuplesKt.m1300to("PACKAGE", EnumSet.noneOf(KotlinTarget.class)), TuplesKt.m1300to("TYPE", EnumSet.of(KotlinTarget.CLASS, KotlinTarget.FILE)), TuplesKt.m1300to("ANNOTATION_TYPE", EnumSet.of(KotlinTarget.ANNOTATION_CLASS)), TuplesKt.m1300to("TYPE_PARAMETER", EnumSet.of(KotlinTarget.TYPE_PARAMETER)), TuplesKt.m1300to("FIELD", EnumSet.of(KotlinTarget.FIELD)), TuplesKt.m1300to("LOCAL_VARIABLE", EnumSet.of(KotlinTarget.LOCAL_VARIABLE)), TuplesKt.m1300to("PARAMETER", EnumSet.of(KotlinTarget.VALUE_PARAMETER)), TuplesKt.m1300to("CONSTRUCTOR", EnumSet.of(KotlinTarget.CONSTRUCTOR)), TuplesKt.m1300to("METHOD", EnumSet.of(KotlinTarget.FUNCTION, KotlinTarget.PROPERTY_GETTER, KotlinTarget.PROPERTY_SETTER)), TuplesKt.m1300to("TYPE_USE", EnumSet.of(KotlinTarget.TYPE)));
    private static final Map<String, KotlinRetention> retentionNameList = MapsKt.mapOf(TuplesKt.m1300to("RUNTIME", KotlinRetention.RUNTIME), TuplesKt.m1300to("CLASS", KotlinRetention.BINARY), TuplesKt.m1300to("SOURCE", KotlinRetention.SOURCE));
    ...
    public final ConstantValue<?> mapJavaTargetArguments$descriptors_jvm(List<? extends JavaAnnotationArgument> arguments) {
        ...
        return new ArrayValue(arrayList4, new Function1<ModuleDescriptor, KotlinType>() {
            @Override
