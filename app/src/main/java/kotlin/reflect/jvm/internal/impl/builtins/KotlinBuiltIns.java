...
public abstract class KotlinBuiltIns {
    ...
    private static void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 96:
            case 103:
            case ErrorCode.PrinterError.EPS_PRNERR_JPG_LIMIT:
            case 108:
            case 145:
            case 146:
            case 148:
            ...
            case 97:
            case 99:
            case ErrorCode.PrinterError.EPS_PRNERR_TRAYCLOSE:
            case 109:
            case 110:
            case 111:
            case UiPosIndexEnum.HOME_REPLACE_BG_TAB:
            case 114:
            case 115:
            case 116:
            case 117:
            ...
            case 119:
            case 120:
            case DNPPhotoPrint.OVERCOAT_FINISH_PMATTE12:
            case DNPPhotoPrint.OVERCOAT_FINISH_PMATTE13:
            case 123:
            case 124:
            case 125:
            ...
            case SyslogAppender.LOG_LOCAL1:
            case 137:
            case TsExtractor.TS_STREAM_TYPE_DTS:
            case 139:
            case PowerState.Code.resetMbrGraceful:
            case 141:
            case PageAttribute.MediaTypeID.EPS_MTID_PLOOFING_WHITE_MAT:
            case 143:
            case SyslogAppender.LOG_LOCAL2:
            case 147:
            case 149:
            case PowerState.Code.resetSoftGraceful:
            case 151:
            case SyslogAppender.LOG_LOCAL3:
            case 153:
            case 154:
            case 155:
            case 161:
            ...
            case 101:
                ...
                break;
            case UiPosIndexEnum.HOME_COUNTDOWN:
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() {
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo3072getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3070getDeclarationDescriptor = kotlinType.getConstructor().mo3070getDeclarationDescriptor();
        return (classifierDescriptorMo3070getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo3070getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo3070getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3070getDeclarationDescriptor = kotlinType.getConstructor().mo3070getDeclarationDescriptor();
        return (classifierDescriptorMo3070getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo3070getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo3070getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo3070getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    private static boolean isNotNullConstructedFromGivenClass(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(ErrorCode.PrinterError.EPS_PRNERR_TRAYCLOSE);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(106);
        }
    ...
    public static boolean isSpecialClassWithNoSupertypes(ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(ErrorCode.PrinterError.EPS_PRNERR_JPG_LIMIT);
        }
    ...
    public static boolean isNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(SyslogAppender.LOG_LOCAL1);
        }
    ...
    public static boolean isNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(PowerState.Code.resetMbrGraceful);
        }
    ...
    public static boolean isUnit(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(PageAttribute.MediaTypeID.EPS_MTID_PLOOFING_WHITE_MAT);
        }
