...
public final class UtilKt {
    ...
    static Class loadClass$default(ClassLoader classLoader, ClassId classId, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 0;
        }
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        ...
        if (i > 0) {
            str3 = StringsKt.repeat("[", i) + Matrix.MATRIX_TYPE_RANDOM_LT + str3 + ';';
        }
    ...
    private static final Annotation toAnnotationInstance(AnnotationDescriptor annotationDescriptor) {
        ...
        while (it.hasNext()) {
            ...
            Pair pairM1300to = runtimeValue != null ? TuplesKt.m1300to(name.asString(), runtimeValue) : null;
            if (pairM1300to != null) {
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo3070getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo3070getDeclarationDescriptor();
