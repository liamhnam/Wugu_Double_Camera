...
public abstract class ByteString implements Iterable<Byte> {
    ...
    public ByteString concat(ByteString byteString) {
        ...
        if (((long) size) + ((long) size2) >= 2147483647L) {
            throw new IllegalArgumentException(new StringBuilder(53).append("ByteString would be too long: ").append(size).append(MqttTopic.SINGLE_LEVEL_WILDCARD).append(size2).toString());
        }
