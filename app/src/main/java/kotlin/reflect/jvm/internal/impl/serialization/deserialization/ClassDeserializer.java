...
public final class ClassDeserializer {
    ...
    public ClassDeserializer(DeserializationComponents components) {
        ...
        this.classes = components.getStorageManager().createMemoizedFunctionWithNullableValues(new Function1<ClassKey, ClassDescriptor>() {
            {
                super(1);
            }
    ...
    public static ClassDescriptor deserializeClass$default(ClassDeserializer classDeserializer, ClassId classId, ClassData classData, int i, Object obj) {
        if ((i & 2) != 0) {
            classData = null;
        }
