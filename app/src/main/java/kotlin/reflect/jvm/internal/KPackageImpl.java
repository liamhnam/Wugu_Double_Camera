...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    final class Data extends KDeclarationContainerImpl.Data {
        ...
        public Data() {
            super();
            this.kotlinClass = ReflectProperties.lazySoft(new Function0<ReflectKotlinClass>() {
                {
                    super(0);
                }
            ...
            this.scope = ReflectProperties.lazySoft(new Function0<MemberScope>() {
                {
                    super(0);
                }
            ...
            this.multifileFacade = ReflectProperties.lazy(new Function0<Class<?>>() {
                {
                    super(0);
                }
            ...
            this.metadata = ReflectProperties.lazy(new Function0<Triple<? extends JvmNameResolver, ? extends ProtoBuf.Package, ? extends JvmMetadataVersion>>() {
                {
                    super(0);
                }
            ...
            this.members = ReflectProperties.lazySoft(new Function0<Collection<? extends KCallableImpl<?>>>() {
                {
                    super(0);
                }
    ...
    public KPackageImpl(Class<?> jClass, String str) {
        ...
        ReflectProperties.LazyVal<Data> lazyValLazy = ReflectProperties.lazy(new Function0<Data>() {
            {
                super(0);
            }
