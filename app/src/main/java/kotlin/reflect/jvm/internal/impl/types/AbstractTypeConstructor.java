...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    public AbstractTypeConstructor(StorageManager storageManager) {
        ...
        this.supertypes = storageManager.createLazyValueWithPostCompute(new Function0<Supertypes>() {
            {
                super(0);
            }
            ...
            public final void invoke2(AbstractTypeConstructor.Supertypes supertypes) {
                ...
                Function1<TypeConstructor, Iterable<? extends KotlinType>> function1 = new Function1<TypeConstructor, Iterable<? extends KotlinType>>() {
                    {
                        super(1);
                    }
                ...
                List listFindLoopsInSupertypesAndDisconnect = supertypeLoopChecker.findLoopsInSupertypesAndDisconnect(abstractTypeConstructor, allSupertypes, function1, new Function1<KotlinType, Unit>() {
                    {
                        super(1);
                    }
                ...
                if (this.this$0.getShouldReportCyclicScopeWithCompanionWarning()) {
                    ...
                    Function1<TypeConstructor, Iterable<? extends KotlinType>> function12 = new Function1<TypeConstructor, Iterable<? extends KotlinType>>() {
                        {
                            super(1);
                        }
                    ...
                    supertypeLoopChecker2.findLoopsInSupertypesAndDisconnect(abstractTypeConstructor4, listFindLoopsInSupertypesAndDisconnect, function12, new Function1<KotlinType, Unit>() {
                        {
                            super(1);
                        }
    ...
    @Override
    public List<KotlinType> mo3071getSupertypes() {
    ...
    final class ModuleViewTypeConstructor implements TypeConstructor {
        ...
        final AbstractTypeConstructor this$0;
        ...
        public ModuleViewTypeConstructor(final AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            ...
            this.refinedSupertypes$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<List<? extends KotlinType>>() {
                {
                    super(0);
                }
                ...
                public final List<? extends KotlinType> invoke() {
                    return KotlinTypeRefinerKt.refineTypes(this.this$0.kotlinTypeRefiner, abstractTypeConstructor.mo3071getSupertypes());
                }
            });
        }
        ...
        public ClassifierDescriptor mo3070getDeclarationDescriptor() {
            return this.this$0.mo3070getDeclarationDescriptor();
        }
    ...
    public final Collection<KotlinType> computeNeighbours(TypeConstructor typeConstructor, boolean z) {
        ...
        Collection<KotlinType> supertypes = typeConstructor.mo3071getSupertypes();
