...
public interface JavaClassFinder {
    ...
    public static final class Request {
        ...
        public Request(ClassId classId, byte[] bArr, JavaClass javaClass, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class DefaultImpls {
        public static JavaPackage findPackage$default(JavaClassFinder javaClassFinder, FqName fqName, boolean z, int i, Object obj) {
            if (obj != null) {
