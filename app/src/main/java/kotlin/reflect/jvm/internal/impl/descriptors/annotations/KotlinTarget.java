...
public final class KotlinTarget {
    ...
    public static final KotlinTarget CLASS = new KotlinTarget("CLASS", 0, Name.LABEL, false, 2, null);
    ...
    public static final KotlinTarget CLASS_ONLY = new KotlinTarget("CLASS_ONLY", 18, Name.LABEL, false);
    ...
    private static final KotlinTarget[] $VALUES = $values();
    public static final Companion Companion = new Companion(null);
    private static final HashMap<String, KotlinTarget> map = new HashMap<>();

    private static final KotlinTarget[] $values() {
    ...
    KotlinTarget(String str, int i, String str2, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m1300to(annotationUseSiteTarget, kotlinTarget13), TuplesKt.m1300to(AnnotationUseSiteTarget.FIELD, kotlinTarget9), TuplesKt.m1300to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget8), TuplesKt.m1300to(AnnotationUseSiteTarget.FILE, kotlinTarget12), TuplesKt.m1300to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget11), TuplesKt.m1300to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget10), TuplesKt.m1300to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget13), TuplesKt.m1300to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget13), TuplesKt.m1300to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget9));
    }
