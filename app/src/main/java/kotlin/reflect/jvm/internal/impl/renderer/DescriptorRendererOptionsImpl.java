...
public final class DescriptorRendererOptionsImpl implements DescriptorRendererOptions {
    ...
    private final ReadWriteProperty typeNormalizer$delegate = property(new Function1<KotlinType, KotlinType>() {
        @Override
    ...
    private final ReadWriteProperty defaultParameterValueRenderer$delegate = property(new Function1<ValueParameterDescriptor, String>() {
        @Override
    ...
    private final <T> ReadWriteProperty<DescriptorRendererOptionsImpl, T> property(final T t) {
        ...
        return new ObservableProperty<T>(t) {
            @Override
