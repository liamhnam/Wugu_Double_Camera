...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public NewCapturedType(CaptureStatus captureStatus, NewCapturedTypeConstructor newCapturedTypeConstructor, UnwrappedType unwrappedType, Annotations annotations, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public NewCapturedType refine(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return new NewCapturedType(captureStatus, newCapturedTypeConstructorRefine, unwrappedType != null ? kotlinTypeRefiner.refineType((KotlinTypeMarker) unwrappedType).unwrap() : null, getAnnotations(), isMarkedNullable(), false, 32, null);
    }
}
