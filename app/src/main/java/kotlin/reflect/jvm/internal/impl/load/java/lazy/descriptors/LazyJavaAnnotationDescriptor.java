...
public final class LazyJavaAnnotationDescriptor implements AnnotationDescriptor, PossiblyExternalAnnotationDescriptor {
    ...
    private final LazyJavaResolverContext f2707c;
    ...
    public LazyJavaAnnotationDescriptor(LazyJavaResolverContext c, JavaAnnotation javaAnnotation, boolean z) {
        ...
        this.fqName$delegate = c.getStorageManager().createNullableLazyValue(new Function0<FqName>() {
            {
                super(0);
            }
        ...
        this.type$delegate = c.getStorageManager().createLazyValue(new Function0<SimpleType>() {
            ...
            public final SimpleType invoke() {
                ...
                ClassDescriptor classDescriptorMapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(JavaToKotlinClassMapper.INSTANCE, fqName, this.this$0.f2707c.getModule().getBuiltIns(), null, 4, null);
                if (classDescriptorMapJavaToKotlin$default == null) {
                    JavaClass javaClassResolve = this.this$0.javaAnnotation.resolve();
                    classDescriptorMapJavaToKotlin$default = javaClassResolve != null ? this.this$0.f2707c.getComponents().getModuleClassResolver().resolveClass(javaClassResolve) : null;
                    if (classDescriptorMapJavaToKotlin$default == null) {
        ...
        this.allValueArguments$delegate = c.getStorageManager().createLazyValue(new Function0<Map<Name, ? extends ConstantValue<?>>>() {
            ...
            public final Map<Name, ? extends ConstantValue<?>> invoke() {
                ...
                for (JavaAnnotationArgument javaAnnotationArgument : arguments) {
                    ...
                    Pair pairM1300to = constantValueResolveAnnotationArgument != null ? TuplesKt.m1300to(name, constantValueResolveAnnotationArgument) : null;
                    if (pairM1300to != null) {
    ...
    public LazyJavaAnnotationDescriptor(LazyJavaResolverContext lazyJavaResolverContext, JavaAnnotation javaAnnotation, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final ConstantValue<?> resolveFromAnnotation(JavaAnnotation javaAnnotation) {
        return new AnnotationValue(new LazyJavaAnnotationDescriptor(this.f2707c, javaAnnotation, false, 4, null));
    }
    ...
    private final ConstantValue<?> resolveFromArray(Name name, List<? extends JavaAnnotationArgument> list) {
        ...
        if (annotationParameterByName == null || (arrayType = annotationParameterByName.getType()) == null) {
            arrayType = this.f2707c.getComponents().getModule().getBuiltIns().getArrayType(Variance.INVARIANT, ErrorUtils.createErrorType("Unknown array element type"));
        }
    ...
    private final ConstantValue<?> resolveFromJavaClassObjectType(JavaType javaType) {
        return KClassValue.Companion.create(this.f2707c.getTypeResolver().transformJavaType(javaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, null, 3, null)));
    }
    ...
    public final ClassDescriptor createTypeForMissingDependencies(FqName fqName) {
        ModuleDescriptor module = this.f2707c.getModule();
        ClassId classId = ClassId.topLevel(fqName);
        Intrinsics.checkNotNullExpressionValue(classId, "topLevel(fqName)");
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(module, classId, this.f2707c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses());
    }
