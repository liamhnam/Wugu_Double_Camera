...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        final FunctionDescriptorImpl this$0;
        ...
        @Override
        public FunctionDescriptor.CopyBuilder setTypeParameters(List list) {
    ...
    protected FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        if (copyConfiguration.copyOverrides && !getOriginal().getOverriddenDescriptors().isEmpty()) {
            if (copyConfiguration.substitution.isEmpty()) {
                ...
                functionDescriptorImplCreateSubstitutedCopy.lazyOverriddenFunctionsTask = new Function0<Collection<FunctionDescriptor>>() {
                    @Override
