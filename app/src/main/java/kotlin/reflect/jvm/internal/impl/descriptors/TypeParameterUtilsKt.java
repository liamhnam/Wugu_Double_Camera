...
public final class TypeParameterUtilsKt {
    public static final List<TypeParameterDescriptor> computeConstructorTypeParameters(ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        List list = SequencesKt.toList(SequencesKt.flatMap(SequencesKt.filter(SequencesKt.takeWhile(DescriptorUtilsKt.getParents(classifierDescriptorWithTypeParameters2), new Function1<DeclarationDescriptor, Boolean>() {
            @Override
        ...
        }), new Function1<DeclarationDescriptor, Sequence<? extends TypeParameterDescriptor>>() {
            @Override
    ...
    public static final PossiblyInnerType buildPossiblyInnerType(KotlinType kotlinType) {
        ...
        return buildPossiblyInnerType(kotlinType, classifierDescriptorMo3070getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo3070getDeclarationDescriptor : null, 0);
    }
