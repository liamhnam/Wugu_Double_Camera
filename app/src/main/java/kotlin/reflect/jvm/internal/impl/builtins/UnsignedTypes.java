...
public final class UnsignedTypes {
    ...
    static {
        ...
        unsignedArrayTypeToArrayCall = MapsKt.hashMapOf(TuplesKt.m1300to(UnsignedArrayType.UBYTEARRAY, Name.identifier("ubyteArrayOf")), TuplesKt.m1300to(UnsignedArrayType.USHORTARRAY, Name.identifier("ushortArrayOf")), TuplesKt.m1300to(UnsignedArrayType.UINTARRAY, Name.identifier("uintArrayOf")), TuplesKt.m1300to(UnsignedArrayType.ULONGARRAY, Name.identifier("ulongArrayOf")));
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ClassifierDescriptor classifierDescriptorMo3070getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo3070getDeclarationDescriptor = type.getConstructor().mo3070getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo3070getDeclarationDescriptor);
    }
