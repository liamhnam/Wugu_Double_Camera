...
public final class BinaryClassAnnotationAndConstantLoaderImpl extends AbstractBinaryClassAnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> {
    ...
    abstract class AbstractAnnotationArgumentVisitor implements KotlinJvmBinaryClass.AnnotationArgumentVisitor {
        ...
        public KotlinJvmBinaryClass.AnnotationArrayArgumentVisitor visitArray(Name name) {
            return new C2321x4262547b(BinaryClassAnnotationAndConstantLoaderImpl.this, name, this);
        }
        ...
        public KotlinJvmBinaryClass.AnnotationArgumentVisitor visitAnnotation(final Name name, ClassId classId) {
            ...
            return new KotlinJvmBinaryClass.AnnotationArgumentVisitor(this, name, arrayList) {
                private final KotlinJvmBinaryClass.AnnotationArgumentVisitor $$delegate_0;
                final ArrayList<AnnotationDescriptor> $list;
                final Name $name;
                final BinaryClassAnnotationAndConstantLoaderImpl.AbstractAnnotationArgumentVisitor this$0;
