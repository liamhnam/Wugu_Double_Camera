...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    static final KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(GivenFunctionsMemberScope.class), "allDescriptors", "getAllDescriptors()Ljava/util/List;"))};
    ...
    public GivenFunctionsMemberScope(StorageManager storageManager, ClassDescriptor containingClass) {
        ...
        this.allDescriptors$delegate = storageManager.createLazyValue(new Function0<List<? extends DeclarationDescriptor>>() {
            {
                super(0);
            }
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo3071getSupertypes = this.containingClass.getTypeConstructor().mo3071getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo3071getSupertypes, "containingClass.typeConstructor.supertypes");
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            for (Map.Entry entry2 : linkedHashMap2.entrySet()) {
                ...
                overridingUtil.generateOverridesInFunctionGroup(name2, list4, arrayListEmptyList, this.containingClass, new NonReportingOverrideStrategy() {
                    @Override
