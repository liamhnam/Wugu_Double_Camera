    ...
    */
    ...
    private TypeProjection unsafeSubstitute(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor, int i) throws SubstitutionException {
        ...
        if (type instanceof TypeWithEnhancement) {
            ...
            Object objSubstitute = substitute(enhancement, typeProjection.getProjectionKind());
            UnwrappedType unwrappedTypeUnwrap = typeProjectionUnsafeSubstitute.getType().unwrap();
            boolean z = objSubstitute instanceof TypeWithEnhancement;
            ?? enhancement2 = objSubstitute;
            if (z) {
                enhancement2 = ((TypeWithEnhancement) objSubstitute).getEnhancement();
            }
        ...
        TypeProjection typeProjectionMo3075get = this.substitution.mo3075get(type);
        TypeProjection typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance = typeProjectionMo3075get != null ? projectedTypeForConflictedTypeWithUnsafeVariance(type, typeProjectionMo3075get, typeParameterDescriptor, typeProjection) : null;
        ...
        if (typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance != null) {
            ...
            if (!CapturedTypeConstructorKt.isCaptured(type)) {
                int i3 = C24762.f2733x4790888d[varianceConflictTypeConflictType.ordinal()];
                if (i3 == 1) {
    ...
    static class C24762 {
        ...
        static final int[] f2733x4790888d;
        ...
        static {
            ...
            try {
                f2733x4790888d[VarianceConflictType.IN_IN_OUT_POSITION.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2733x4790888d[VarianceConflictType.NO_CONFLICT.ordinal()] = 3;
        ...
        if (annotations.hasAnnotation(StandardNames.FqNames.unsafeVariance)) {
            return new FilteredAnnotations(annotations, new Function1<FqName, Boolean>() {
                private static void $$$reportNull$$$0(int i) {
                    throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", NamingTable.TAG, "kotlin/reflect/jvm/internal/impl/types/TypeSubstitutor$1", "invoke"));
                }
    ...
    private TypeProjection substituteCompoundType(TypeProjection typeProjection, int i) throws SubstitutionException {
        ...
        Variance projectionKind = typeProjection.getProjectionKind();
        if (type.getConstructor().mo3070getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
    ...
    private List<TypeProjection> substituteTypeArguments(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i) throws SubstitutionException {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            int i3 = C24762.f2733x4790888d[conflictType(typeParameterDescriptor.getVariance(), typeProjectionUnsafeSubstitute.getProjectionKind()).ordinal()];
            if (i3 != 1 && i3 != 2) {
