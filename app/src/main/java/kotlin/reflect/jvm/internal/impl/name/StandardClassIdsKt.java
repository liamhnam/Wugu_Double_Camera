...
public final class StandardClassIdsKt {
    ...
    public static final ClassId unsignedId(ClassId classId) {
        return new ClassId(StandardClassIds.INSTANCE.getBASE_KOTLIN_PACKAGE(), Name.identifier(PDBorderStyleDictionary.STYLE_UNDERLINE + classId.getShortClassName().getIdentifier()));
    }
    ...
    public static final <K, V> Map<V, K> inverseMap(Map<K, ? extends V> map) {
        ...
        while (it.hasNext()) {
            ...
            Pair pairM1300to = TuplesKt.m1300to(entry.getValue(), entry.getKey());
