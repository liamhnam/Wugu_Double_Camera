...
public final class ReflectJvmMapping {
    ...
    public static void getJavaConstructor$annotations(KFunction kFunction) {
    }
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Member memberMo3057getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo3057getMember();
        if (memberMo3057getMember instanceof Method) {
            return (Method) memberMo3057getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo3057getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo3057getMember();
        if (memberMo3057getMember instanceof Constructor) {
            return (Constructor) memberMo3057getMember;
        }
        return null;
    }
