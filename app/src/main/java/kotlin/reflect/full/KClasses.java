...
public final class KClasses {
    ...
    public static void getDefaultType$annotations(KClass kClass) {
    }

    public static void getFunctions$annotations(KClass kClass) {
    }

    public static void getMemberExtensionFunctions$annotations(KClass kClass) {
    }

    public static void getMemberExtensionProperties$annotations(KClass kClass) {
    }

    public static void getMemberFunctions$annotations(KClass kClass) {
    }

    public static void getMemberProperties$annotations(KClass kClass) {
    }

    public static void getPrimaryConstructor$annotations(KClass kClass) {
    }

    public static void getStaticFunctions$annotations(KClass kClass) {
    }

    public static void getStaticProperties$annotations(KClass kClass) {
    }

    public static void getSuperclasses$annotations(KClass kClass) {
    }
    ...
    public static final <T> KFunction<T> getPrimaryConstructor(KClass<T> kClass) {
        ...
        while (true) {
            ...
            next = it.next();
            if (((ConstructorDescriptor) ((KFunctionImpl) ((KFunction) next)).getDescriptor()).isPrimary()) {
                break;
            }
        }
    ...
    public static final KClass<?> getCompanionObject(KClass<?> kClass) {
        ...
        while (true) {
            ...
            next = it.next();
            if (((KClassImpl) ((KClass) next)).getDescriptor().isCompanionObject()) {
                break;
            }
        }
        return (KClass) next;
    ...
    public static final KType getDefaultType(final KClass<?> kClass) {
        ...
        return new KTypeImpl(defaultType, new Function0<Type>() {
            {
                super(0);
            }
    ...
    public static final Collection<KType> getAllSupertypes(KClass<?> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        Object objDfs = DFS.dfs(kClass.getSupertypes(), new DFS.Neighbors() {
            @Override
        ...
        }, new DFS.VisitedWithSet(), new DFS.NodeHandlerWithListResult<KType, KType>() {
            @Override
    ...
    public static final boolean isSubclassOf(KClass<?> kClass, final KClass<?> base) {
        ...
        if (!Intrinsics.areEqual(kClass, base)) {
            ...
            final C21841 c21841 = new PropertyReference1() {
                @Override
            ...
            Boolean boolIfAny = DFS.ifAny(listListOf, new DFS.Neighbors() {
                @Override
                public final Iterable getNeighbors(Object obj) {
                    return (Iterable) c21841.invoke(obj);
                }
            }, new Function1<KClass<?>, Boolean>() {
                {
                    super(1);
                }
