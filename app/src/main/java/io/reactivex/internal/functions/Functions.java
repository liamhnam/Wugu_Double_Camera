...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        final BiFunction<? super T1, ? super T2, ? extends R> f2569f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f2569f = biFunction;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2569f.apply(objArr[0], objArr[1]);
        }
    }

    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {

        final Function3<T1, T2, T3, R> f2570f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f2570f = function3;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2570f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2]);
        }
    }

    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {

        final Function4<T1, T2, T3, T4, R> f2571f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f2571f = function4;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2571f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3]);
        }
    }

    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {

        private final Function5<T1, T2, T3, T4, T5, R> f2572f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f2572f = function5;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2572f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3], (T5) objArr[4]);
        }
    }

    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {

        final Function6<T1, T2, T3, T4, T5, T6, R> f2573f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f2573f = function6;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2573f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3], (T5) objArr[4], (T6) objArr[5]);
        }
    }

    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {

        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f2574f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f2574f = function7;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2574f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3], (T5) objArr[4], (T6) objArr[5], (T7) objArr[6]);
        }
    }

    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {

        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f2575f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f2575f = function8;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2575f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3], (T5) objArr[4], (T6) objArr[5], (T7) objArr[6], (T8) objArr[7]);
        }
    }

    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {

        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f2576f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f2576f = function9;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            ...
            return this.f2576f.apply((T1) objArr[0], (T2) objArr[1], (T3) objArr[2], (T4) objArr[3], (T5) objArr[4], (T6) objArr[5], (T7) objArr[6], (T8) objArr[7], (T9) objArr[8]);
        }
    }
