...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        @Override
        public final T poll() {
            Iterator<? extends T> it = this.f2601it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return (T) ObjectHelper.requireNonNull(this.f2601it.next(), "Iterator.next() returned a null value");
        }
    ...
    static final class IteratorSubscription<T> extends BaseRangeSubscription<T> {
        ...
        */
        void slowPath(long r9) {
            /*
                r8 = this;
                java.util.Iterator<? extends T> r0 = r8.f2601it
