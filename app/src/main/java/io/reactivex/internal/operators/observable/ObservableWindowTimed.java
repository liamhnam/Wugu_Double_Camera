...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
                ...
                if (z2) {
                    ...
                    if (j >= this.maxSize) {
                        ...
                        if (this.restartTimerOnMaxSize) {
                            ...
                            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.timer, disposable, disposableSchedulePeriodically)) {
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
            ...
            while (!this.terminated) {
                ...
                if (z2) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f2646w);
                        subjectWork.f2646w.onComplete();
        ...
        static final class SubjectWork<T> {
            ...
            final UnicastSubject<T> f2646w;

            SubjectWork(UnicastSubject<T> unicastSubject, boolean z) {
                this.f2646w = unicastSubject;
                this.open = z;
            }
        }
        ...
        final class CompletionTask implements Runnable {
            ...
            private final UnicastSubject<T> f2645w;

            CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f2645w = unicastSubject;
            }

            @Override
            public void run() {
                WindowSkipObserver.this.complete(this.f2645w);
            }
        }
    }
}
