    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f2637v1 == null) {
                    this.f2637v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f2637v1 == null;
                if (this.f2638v2 == null) {
                    this.f2638v2 = spscLinkedArrayQueue2.poll();
                }
                T t = this.f2638v2;
                boolean z4 = t == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f2637v1, t)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onNext(false);
                            this.downstream.onComplete();
                            return;
