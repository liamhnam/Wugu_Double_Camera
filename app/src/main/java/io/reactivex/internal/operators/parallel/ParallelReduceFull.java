...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    static final class ParallelReduceFullMainSubscriber<T> extends DeferredScalarSubscription<T> {
        ...
        SlotPair<T> addValue(T t) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.current, null, slotPair)) {
                        continue;
                    }
                }
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.current, slotPair, null);
            }
            if (iTryAcquireSlot == 0) {
                slotPair.first = t;
            } else {
        ...
        void innerError(Throwable th) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.error, null, th)) {
                cancel();
