...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        ...
        try {
            CpuInfo.BDA33 bda33 = (Object) ((Callable) obj).call();
            CompletableSource completableSource = bda33 != null ? (CompletableSource) ObjectHelper.requireNonNull(function.apply(bda33), "The mapper returned a null CompletableSource") : null;
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            CpuInfo.BDA33 bda33 = (Object) ((Callable) obj).call();
            MaybeSource maybeSource = bda33 != null ? (MaybeSource) ObjectHelper.requireNonNull(function.apply(bda33), "The mapper returned a null MaybeSource") : null;
            if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            CpuInfo.BDA33 bda33 = (Object) ((Callable) obj).call();
            SingleSource singleSource = bda33 != null ? (SingleSource) ObjectHelper.requireNonNull(function.apply(bda33), "The mapper returned a null SingleSource") : null;
