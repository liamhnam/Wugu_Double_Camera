    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.inner, switchMapInnerObserver, null) && this.errors.addThrowable(th)) {
                if (this.delayErrors) {
                    if (this.done) {
        ...
        void innerComplete(SwitchMapInnerObserver switchMapInnerObserver) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.inner, switchMapInnerObserver, null) && this.done) {
                Throwable thTerminate = this.errors.terminate();
                if (thTerminate == null) {
                    this.downstream.onComplete();
                } else {
