    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f2639v1 == null) {
                    this.f2639v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f2639v1 == null;
                if (this.f2640v2 == null) {
                    this.f2640v2 = spscLinkedArrayQueue2.poll();
                }
                T t = this.f2640v2;
                boolean z4 = t == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f2639v1, t)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onSuccess(false);
                            return;
                        } else {
