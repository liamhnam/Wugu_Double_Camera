...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.current, publishObserver, publishObserver2)) {
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            while (true) {
                ...
                if (publishObserver == null || publishObserver.isDisposed()) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.curr, publishObserver, publishObserver2)) {
                        publishObserver = publishObserver2;
                    } else {
                        continue;
                    }
