...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> future) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.first, future2, future));
    }
    ...
    void setRest(Future<?> future) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.rest, future2, future));
    }
}
