...
public final class ComputationScheduler extends Scheduler implements SchedulerMultiWorkerSupport {
    ...
    public void start() {
        ...
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.pool, NONE, fixedSchedulerPool)) {
            return;
        }
        fixedSchedulerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.pool, fixedSchedulerPool, fixedSchedulerPool2));
        fixedSchedulerPool.shutdown();
    }
