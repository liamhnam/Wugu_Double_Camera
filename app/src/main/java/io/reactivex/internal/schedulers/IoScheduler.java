...
public final class IoScheduler extends Scheduler {
    ...
    public void start() {
        ...
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m143m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
