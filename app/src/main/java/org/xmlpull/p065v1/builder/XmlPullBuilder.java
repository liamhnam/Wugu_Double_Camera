...
import org.xmlpull.p065v1.builder.impl.XmlPullBuilderImpl;
...
public abstract class XmlPullBuilder {
    ...
    public static XmlPullBuilder newInstance() throws XmlBuilderException {
        ...
        try {
            ...
            throw new XmlBuilderException(new StringBuffer("could not create XmlPull factory:").append(e).toString(), e);
        }
    }
    ...
    public XmlDocument parseInputStream(InputStream inputStream, String str) throws XmlBuilderException {
        try {
            ...
            throw new XmlBuilderException(new StringBuffer("could not start parsing input stream (encoding=").append(str).append(")").toString(), e);
        }
    }
    ...
    public XmlElement parseFragementFromInputStream(InputStream inputStream, String str) throws XmlBuilderException {
        try {
            ...
            try {
                ...
                throw new XmlBuilderException(new StringBuffer("IO error when starting to parse input stream (encoding=").append(str).append(")").toString(), e);
            }
        } catch (XmlPullParserException e2) {
    ...
    public void serializeToOutputStream(Object obj, OutputStream outputStream, String str) throws XmlBuilderException {
        try {
            ...
            throw new XmlBuilderException(new StringBuffer("could not serialize node to output stream (encoding=").append(str).append(")").toString(), e);
        }
    }
