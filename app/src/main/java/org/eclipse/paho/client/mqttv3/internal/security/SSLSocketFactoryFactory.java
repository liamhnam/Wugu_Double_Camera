...
public class SSLSocketFactoryFactory {
    ...
    private static final byte[] key = {-99, SnmpConstants.TRPV2_REQ_MSG, -39, -128, 5, -72, -119, -100};
    ...
    private SSLContext getSSLContext(String str) throws MqttSecurityException {
        ...
        try {
            ...
            if (logger3 != null) {
                ...
                objArr3[1] = property != null ? property : Configurator.NULL;
            ...
            if (logger4 != null) {
                ...
                objArr4[1] = keyStorePassword != null ? obfuscate(keyStorePassword) : Configurator.NULL;
            ...
            if (logger5 != null) {
                ...
                objArr5[1] = keyStoreType != null ? keyStoreType : Configurator.NULL;
                ...
                try {
                    ...
                    if (logger6 != null) {
                        ...
                        if (defaultAlgorithm == null) {
                            defaultAlgorithm = Configurator.NULL;
                        }
            ...
            if (logger8 != null) {
                ...
                objArr8[1] = trustStore != null ? trustStore : Configurator.NULL;
            ...
            if (logger9 != null) {
                ...
                objArr9[1] = trustStorePassword != null ? obfuscate(trustStorePassword) : Configurator.NULL;
            ...
            if (logger10 != null) {
                ...
                objArr10[1] = trustStoreType != null ? trustStoreType : Configurator.NULL;
