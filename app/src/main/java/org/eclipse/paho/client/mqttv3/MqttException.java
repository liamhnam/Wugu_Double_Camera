...
public class MqttException extends Exception {
    ...
    public String toString() {
        String string = new StringBuffer(String.valueOf(getMessage())).append(" (").append(this.reasonCode).append(")").toString();
        return this.cause != null ? new StringBuffer(String.valueOf(string)).append(" - ").append(this.cause.toString()).toString() : string;
    }
}
