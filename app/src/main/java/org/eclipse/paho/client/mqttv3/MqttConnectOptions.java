...
public class MqttConnectOptions {
    ...
    public Properties getDebug() {
        ...
        properties.put("UserName", getUserName() == null ? Configurator.NULL : getUserName());
        properties.put("WillDestination", getWillDestination() == null ? Configurator.NULL : getWillDestination());
