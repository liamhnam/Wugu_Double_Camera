...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
    ...
    private void disconnected(Bundle bundle) {
        ...
        IMqttToken iMqttTokenRemoveMqttToken = removeMqttToken(bundle);
    ...
    private void messageDeliveredAction(Bundle bundle) {
        IMqttToken iMqttTokenRemoveMqttToken = removeMqttToken(bundle);
        if (iMqttTokenRemoveMqttToken == null || this.callback == null || ((Status) bundle.getSerializable(MqttServiceConstants.CALLBACK_STATUS)) != Status.OK || !(iMqttTokenRemoveMqttToken instanceof IMqttDeliveryToken)) {
            return;
        }
        this.callback.deliveryComplete((IMqttDeliveryToken) iMqttTokenRemoveMqttToken);
    }
    ...
    private synchronized IMqttToken removeMqttToken(Bundle bundle) {
        ...
        IMqttToken iMqttToken = this.tokenMap.get(i);
