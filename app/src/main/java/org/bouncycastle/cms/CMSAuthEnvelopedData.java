...
public class CMSAuthEnvelopedData implements Encodable {
    ...
    public CMSAuthEnvelopedData(ContentInfo contentInfo) throws CMSException {
        ...
        this.recipientInfoStore = this.authAttrs != null ? CMSEnvelopedHelper.buildRecipientInformationStore(recipientInfos, this.authEncAlg, cMSSecureReadable, new AuthAttributesProvider() {
            @Override
