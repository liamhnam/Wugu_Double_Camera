...
public class UTF8 {
    ...
    static {
        byte[] bArr = new byte[UiPosIndexEnum.HOME_COUNTDOWN];
        ...
        fill(bArr2, UiPosIndexEnum.HOME_COUNTDOWN, UiPosIndexEnum.HOME_COUNTDOWN, (byte) 8);
        fill(bArr2, UiPosIndexEnum.HOME_REPLACE_BG_TAB, 115, (byte) 9);
        ...
        byte[] bArr3 = {0, 0, 0, 0, SnmpConstants.ASN_EXTENSION_ID, SnmpConstants.SNMP_ERR_UNDOFAILED, SnmpConstants.SNMP_ERR_UNDOFAILED, SnmpConstants.SNMP_ERR_UNDOFAILED, 7, 7, 7};
