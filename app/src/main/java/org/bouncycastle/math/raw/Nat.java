...
public abstract class Nat {
    ...
    private static final long f3622M = 4294967295L;
    ...
    public static boolean m1447eq(int i, int[] iArr, int[] iArr2) {
        for (int i2 = i - 1; i2 >= 0; i2--) {
            if (iArr[i2] != iArr2[i2]) {
                return false;
            }
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        long j3 = 0;
        while (i4 < i) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, i4, iArr2, i3)) & 4294967295L) + (((long) iArr2[i10]) & 4294967295L);
            int i11 = i10 + 1;
            iArr2[i10] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (((long) iArr2[i11]) & 4294967295L);
            iArr2[i11] = (int) j4;
            j3 = j4 >>> 32;
            i4++;
            i10 = i11 + 1;
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i9 = 2;
        while (i2 < i) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, iArr2)) & 4294967295L) + (((long) iArr2[i9]) & 4294967295L);
            int i10 = i9 + 1;
