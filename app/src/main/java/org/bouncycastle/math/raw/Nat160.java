...
public abstract class Nat160 {
    ...
    private static final long f3624M = 4294967295L;
    ...
    public static boolean m1449eq(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 5; i < i2; i2 = 5) {
            ...
            int i5 = i + 2;
            long j16 = j5;
            long j17 = (j15 >>> 32) + (j12 * j3) + (((long) iArr3[i5]) & 4294967295L);
            iArr3[i5] = (int) j17;
            int i6 = i + 3;
            long j18 = (j17 >>> 32) + (j12 * j4) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) j18;
            int i7 = i + 4;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j27 = (j20 & 4294967295L) + (j * j23);
                int i12 = (int) j27;
                iArr2[4] = (i12 << 1) | i11;
                long j28 = (j21 & 4294967295L) + (j27 >>> 32) + (j23 * j6);
                long j29 = j25 + (j28 >>> 32) + (j23 * j10);
                long j30 = (4294967295L & j24) + (j29 >>> 32) + (j23 * j16);
                long j31 = j26 + (j30 >>> 32);
                int i13 = (int) j28;
                ...
                int i18 = (int) j31;
                iArr2[8] = i17 | (i18 << 1);
                iArr2[9] = (i18 >>> 31) | ((iArr2[9] + ((int) (j31 >>> 32))) << 1);
                return;
            }
            i3 = i4;
            i2 = i6;
