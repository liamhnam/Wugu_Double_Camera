...
public class SecP384R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3574q = SecP384R1FieldElement.f3577Q;
    ...
    public SecP384R1Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawXCoord()).f3578x, 0, iArr, i3);
            int i5 = i3 + 12;
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawYCoord()).f3578x, 0, iArr, i5);
            i3 = i5 + 12;
        }
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i10 = 0; i10 < 12; i10++) {
                        ...
                        iArrCreate2[i10] = iArrCreate2[i10] ^ (iArr2[(i7 + 12) + i10] & i9);
                    }
                    i7 += 24;
                }
