...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f3508x, this.f3509y.negate(), this.f3510zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f3540x, iArrCreate);
        int[] iArrCreate2 = Nat160.create();
        SecP160R2Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f3540x, iArrCreate3);
        SecP160R2Field.reduce32(Nat160.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP160R2Field.multiply(iArrCreate, secP160R2FieldElement2.f3540x, iArrCreate);
        ...
        SecP160R2Field.square(iArrCreate3, secP160R2FieldElement4.f3540x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f3540x, iArrCreate, secP160R2FieldElement4.f3540x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f3540x, iArrCreate, secP160R2FieldElement4.f3540x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(iArrCreate);
        SecP160R2Field.subtract(iArrCreate, secP160R2FieldElement4.f3540x, secP160R2FieldElement5.f3540x);
        SecP160R2Field.multiply(secP160R2FieldElement5.f3540x, iArrCreate3, secP160R2FieldElement5.f3540x);
        SecP160R2Field.subtract(secP160R2FieldElement5.f3540x, iArrCreate4, secP160R2FieldElement5.f3540x);
