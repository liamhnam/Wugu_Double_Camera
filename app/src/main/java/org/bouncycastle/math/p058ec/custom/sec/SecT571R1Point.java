...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f3508x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f3509y;
        SecT571FieldElement secT571FieldElement7 = (SecT571FieldElement) this.f3510zs[0];
        ...
        long[] jArrPrecompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f3591x);
        if (jArrPrecompMultiplicand == null) {
            jArr = secT571FieldElement5.f3591x;
            jArr2 = secT571FieldElement8.f3591x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f3591x, jArrPrecompMultiplicand, jArrCreate642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f3591x, jArrPrecompMultiplicand, jArrCreate644);
            jArr = jArrCreate642;
            jArr2 = jArrCreate644;
        }
        long[] jArrPrecompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f3591x);
        long[] jArr4 = secT571FieldElement4.f3591x;
        if (jArrPrecompMultiplicand2 == null) {
            jArr3 = secT571FieldElement6.f3591x;
        } else {
            SecT571Field.multiplyPrecomp(jArr4, jArrPrecompMultiplicand2, jArrCreate64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f3591x, jArrPrecompMultiplicand2, jArrCreate643);
            jArr4 = jArrCreate64;
            jArr3 = jArrCreate643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(jArrCreate64, jArrCreate642, secT571FieldElement11.f3591x);
            ...
            SecT571Field.multiplyPrecomp(jArrCreate644, jArrPrecompMultiplicand3, secT571FieldElement12.f3591x);
            if (jArrPrecompMultiplicand2 != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement12.f3591x, jArrPrecompMultiplicand2, secT571FieldElement12.f3591x);
            }
            ...
            SecT571Field.add(secT571FieldElement6.f3591x, secT571FieldElement7.f3591x, jArrCreate644);
            SecT571Field.multiplyAddToExt(jArrCreate644, secT571FieldElement12.f3591x, jArrCreateExt64);
            SecT571FieldElement secT571FieldElement13 = new SecT571FieldElement(jArrCreate644);
            SecT571Field.reduce(jArrCreateExt64, secT571FieldElement13.f3591x);
            if (jArrPrecompMultiplicand != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement12.f3591x, jArrPrecompMultiplicand, secT571FieldElement12.f3591x);
            }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f3508x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f3509y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.f3510zs[0];
        long[] jArrCreate64 = Nat576.create64();
        long[] jArrCreate642 = Nat576.create64();
        long[] jArrPrecompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f3591x);
        long[] jArr2 = secT571FieldElement2.f3591x;
        if (jArrPrecompMultiplicand == null) {
            jArr = secT571FieldElement3.f3591x;
        } else {
            SecT571Field.multiplyPrecomp(jArr2, jArrPrecompMultiplicand, jArrCreate64);
            SecT571Field.square(secT571FieldElement3.f3591x, jArrCreate642);
            jArr2 = jArrCreate64;
            jArr = jArrCreate642;
        }
        long[] jArrCreate643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f3591x, jArrCreate643);
        ...
        SecT571Field.square(jArrCreate643, secT571FieldElement4.f3591x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(jArrCreate643);
        if (jArrPrecompMultiplicand != null) {
            SecT571Field.multiply(secT571FieldElement5.f3591x, jArr, secT571FieldElement5.f3591x);
        }
        long[] jArr3 = secT571FieldElement.f3591x;
        if (jArrPrecompMultiplicand != null) {
        ...
        SecT571Field.addBothTo(secT571FieldElement4.f3591x, secT571FieldElement5.f3591x, jArrCreate642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f3509y;
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) this.f3510zs[0];
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] jArrCreate64 = Nat576.create64();
        long[] jArrCreate642 = Nat576.create64();
        long[] jArrCreate643 = Nat576.create64();
        long[] jArrCreate644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f3591x, jArrCreate64);
        SecT571Field.square(secT571FieldElement4.f3591x, jArrCreate642);
        SecT571Field.square(secT571FieldElement5.f3591x, jArrCreate643);
        SecT571Field.multiply(secT571FieldElement4.f3591x, secT571FieldElement5.f3591x, jArrCreate644);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f3591x, jArrPrecompMultiplicand, jArrCreate643);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement2.f3591x, jArrPrecompMultiplicand, jArrCreate64);
        ...
        SecT571Field.square(jArrCreate643, secT571FieldElement7.f3591x);
        SecT571Field.multiply(secT571FieldElement7.f3591x, jArrCreate64, secT571FieldElement7.f3591x);
        SecT571FieldElement secT571FieldElement8 = new SecT571FieldElement(jArrCreate64);
        SecT571Field.multiply(jArrCreate643, jArrCreate642, secT571FieldElement8.f3591x);
        SecT571Field.multiplyPrecomp(secT571FieldElement8.f3591x, jArrPrecompMultiplicand, secT571FieldElement8.f3591x);
        SecT571FieldElement secT571FieldElement9 = new SecT571FieldElement(jArrCreate642);
        SecT571Field.add(jArrCreate643, jArrCreate642, secT571FieldElement9.f3591x);
        SecT571Field.square(secT571FieldElement9.f3591x, secT571FieldElement9.f3591x);
        Nat.zero64(18, jArrCreateExt64);
        SecT571Field.multiplyAddToExt(secT571FieldElement9.f3591x, jArrCreate644, jArrCreateExt64);
        SecT571Field.addOne(secT571FieldElement6.f3591x, jArrCreate644);
        SecT571Field.multiplyAddToExt(jArrCreate644, secT571FieldElement8.f3591x, jArrCreateExt64);
        SecT571Field.reduce(jArrCreateExt64, secT571FieldElement9.f3591x);
