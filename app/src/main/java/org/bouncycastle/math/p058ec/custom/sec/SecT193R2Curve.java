...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawXCoord()).f3586x, 0, jArr, i3);
            int i5 = i3 + 4;
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawYCoord()).f3586x, 0, jArr, i5);
            i3 = i5 + 4;
        }
        return new AbstractECLookupTable() {
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i9 = 0; i9 < 4; i9++) {
                        ...
                        jArrCreate642[i9] = jArrCreate642[i9] ^ (jArr2[(i7 + 4) + i9] & j);
                    }
                    i7 += 8;
                }
            ...
            public ECPoint lookupVar(int i6) {
                ...
                for (int i8 = 0; i8 < 4; i8++) {
                    long j = jArrCreate64[i8];
                    long[] jArr2 = jArr;
                    jArrCreate64[i8] = j ^ jArr2[i7 + i8];
                    jArrCreate642[i8] = jArrCreate642[i8] ^ jArr2[(i7 + 4) + i8];
                }
                return createPoint(jArrCreate64, jArrCreate642);
            }
        };
