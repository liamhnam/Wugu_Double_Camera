...
public class Curve25519Field {
    ...
    private static final long f3514M = 4294967295L;

    private static final int f3516P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    static final int[] f3515P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    ...
    private static int addPTo(int[] iArr) {
        ...
        long j2 = jDecAt + (4294967295L & ((long) iArr[7])) + faceunity.FUAITYPE_HUMAN_PROCESSOR_2D_DANCE;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat256.add(iArr, f3515P, iArr2);
            Nat.shiftDownBit(8, iArr2, 0);
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f3515P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f3515P) == 0);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = jIncAt + ((4294967295L & ((long) iArr[7])) - faceunity.FUAITYPE_HUMAN_PROCESSOR_2D_DANCE);
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
