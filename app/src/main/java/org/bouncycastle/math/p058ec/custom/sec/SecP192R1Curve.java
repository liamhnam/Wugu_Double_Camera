...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3546q = SecP192R1FieldElement.f3550Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f3551x, 0, iArr, i3);
            int i5 = i3 + 6;
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f3551x, 0, iArr, i5);
            i3 = i5 + 6;
        }
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i10 = 0; i10 < 6; i10++) {
                        ...
                        iArrCreate2[i10] = iArrCreate2[i10] ^ (iArr2[(i7 + 6) + i10] & i9);
                    }
                    i7 += 12;
                }
