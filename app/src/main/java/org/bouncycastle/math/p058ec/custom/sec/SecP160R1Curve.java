...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3530q = SecP160R1FieldElement.f3534Q;
    ...
    public SecP160R1Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f3535x, 0, iArr, i3);
            int i5 = i3 + 5;
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f3535x, 0, iArr, i5);
            i3 = i5 + 5;
        }
