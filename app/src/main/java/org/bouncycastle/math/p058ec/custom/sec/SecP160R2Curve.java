...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3536q = SecP160R2FieldElement.f3539Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f3540x, 0, iArr, i3);
            int i5 = i3 + 5;
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f3540x, 0, iArr, i5);
            i3 = i5 + 5;
        }
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i10 = 0; i10 < 5; i10++) {
                        ...
                        iArrCreate2[i10] = iArrCreate2[i10] ^ (iArr2[(i7 + 5) + i10] & i9);
                    }
                    i7 += 10;
                }
