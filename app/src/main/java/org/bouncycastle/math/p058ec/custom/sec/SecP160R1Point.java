...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f3508x;
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f3509y;
        ...
        SecP160R1FieldElement secP160R1FieldElement5 = (SecP160R1FieldElement) this.f3510zs[0];
        ...
        if (zIsOne) {
            iArr = secP160R1FieldElement3.f3535x;
            iArr2 = secP160R1FieldElement4.f3535x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement5.f3535x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement3.f3535x, iArrCreate);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement5.f3535x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement4.f3535x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R1FieldElement.f3535x;
            iArr4 = secP160R1FieldElement2.f3535x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement6.f3535x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement.f3535x, iArrCreateExt);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement6.f3535x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement2.f3535x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R1Field.square(iArrCreate, secP160R1FieldElement7.f3535x);
        SecP160R1Field.subtract(secP160R1FieldElement7.f3535x, iArrCreate5, secP160R1FieldElement7.f3535x);
        SecP160R1FieldElement secP160R1FieldElement8 = new SecP160R1FieldElement(iArrCreate5);
        SecP160R1Field.subtract(iArrCreate2, secP160R1FieldElement7.f3535x, secP160R1FieldElement8.f3535x);
        SecP160R1Field.multiplyAddToExt(secP160R1FieldElement8.f3535x, iArrCreate, iArrCreateExt);
        SecP160R1Field.reduce(iArrCreateExt, secP160R1FieldElement8.f3535x);
        SecP160R1FieldElement secP160R1FieldElement9 = new SecP160R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP160R1Field.multiply(secP160R1FieldElement9.f3535x, secP160R1FieldElement5.f3535x, secP160R1FieldElement9.f3535x);
        }
        if (!zIsOne2) {
            SecP160R1Field.multiply(secP160R1FieldElement9.f3535x, secP160R1FieldElement6.f3535x, secP160R1FieldElement9.f3535x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R1Point(this.curve, this.f3508x, this.f3509y.negate(), this.f3510zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f3509y;
        if (secP160R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f3508x;
        SecP160R1FieldElement secP160R1FieldElement3 = (SecP160R1FieldElement) this.f3510zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R1Field.square(secP160R1FieldElement.f3535x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R1FieldElement3.isOne();
        int[] iArr = secP160R1FieldElement3.f3535x;
        if (!zIsOne) {
            SecP160R1Field.square(secP160R1FieldElement3.f3535x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R1Field.subtract(secP160R1FieldElement2.f3535x, iArr, iArrCreate);
        SecP160R1Field.add(secP160R1FieldElement2.f3535x, iArr, iArrCreate2);
        ...
        SecP160R1Field.square(iArrCreate2, secP160R1FieldElement4.f3535x);
        SecP160R1Field.subtract(secP160R1FieldElement4.f3535x, iArrCreate3, secP160R1FieldElement4.f3535x);
        SecP160R1Field.subtract(secP160R1FieldElement4.f3535x, iArrCreate3, secP160R1FieldElement4.f3535x);
        SecP160R1FieldElement secP160R1FieldElement5 = new SecP160R1FieldElement(iArrCreate3);
        SecP160R1Field.subtract(iArrCreate3, secP160R1FieldElement4.f3535x, secP160R1FieldElement5.f3535x);
        SecP160R1Field.multiply(secP160R1FieldElement5.f3535x, iArrCreate2, secP160R1FieldElement5.f3535x);
        SecP160R1Field.subtract(secP160R1FieldElement5.f3535x, iArrCreate, secP160R1FieldElement5.f3535x);
        SecP160R1FieldElement secP160R1FieldElement6 = new SecP160R1FieldElement(iArrCreate2);
        SecP160R1Field.twice(secP160R1FieldElement.f3535x, secP160R1FieldElement6.f3535x);
        if (!zIsOne) {
            SecP160R1Field.multiply(secP160R1FieldElement6.f3535x, secP160R1FieldElement3.f3535x, secP160R1FieldElement6.f3535x);
        }
