...
public abstract class WNafUtil {
    private static final int[] DEFAULT_WINDOW_SIZE_CUTOFFS = {13, 41, DNPPhotoPrint.OVERCOAT_FINISH_PMATTE12, 337, 897, 2305};
    ...
    public static WNafPreCompInfo precompute(final ECPoint eCPoint, final int i, final boolean z) {
        ...
        return (WNafPreCompInfo) curve.precompute(eCPoint, PRECOMP_NAME, new PreCompCallback() {
            ...
            */
            public org.bouncycastle.math.p058ec.PreCompInfo precompute(org.bouncycastle.math.p058ec.PreCompInfo r14) {
                /*
                    Method dump skipped, instruction units count: 303
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p058ec.WNafUtil.C31662.precompute(org.bouncycastle.math.ec.PreCompInfo):org.bouncycastle.math.ec.PreCompInfo");
            }
        });
    }
