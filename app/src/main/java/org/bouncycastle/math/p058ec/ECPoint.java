...
public abstract class ECPoint {
    ...
    protected ECFieldElement f3508x;

    protected ECFieldElement f3509y;

    protected ECFieldElement[] f3510zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f3510zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            if (eCFieldElement.isZero()) {
                ECFieldElement eCFieldElementSquare = this.f3509y.square();
                if (!zIsOne) {
                    b = b.multiply(eCFieldElement4.square());
                }
                return eCFieldElementSquare.equals(b);
            }
            ECFieldElement eCFieldElement5 = this.f3509y;
        ...
        public AbstractF2m tau() {
            ...
            ECFieldElement eCFieldElement = this.f3508x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f3509y.square());
            } else {
                if (coordinateSystem != 1) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f3509y.square(), new ECFieldElement[]{this.f3510zs[0].square()});
            }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            ECFieldElement eCFieldElement = this.f3508x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f3509y.squarePow(i));
            } else {
                if (coordinateSystem != 1) {
                    if (coordinateSystem != 5) {
                        if (coordinateSystem != 6) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f3509y.squarePow(i), new ECFieldElement[]{this.f3510zs[0].squarePow(i)});
            }
            return (AbstractF2m) eCPointCreateRawPoint;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply4 = this.f3508x;
            ECFieldElement eCFieldElement = eCPoint.f3508x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement2 = this.f3509y;
                ECFieldElement eCFieldElement3 = eCPoint.f3509y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f3509y;
                ECFieldElement eCFieldElementMultiply5 = this.f3510zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.f3509y;
                ECFieldElement eCFieldElement6 = eCPoint.f3510zs[0];
            ...
            ECFieldElement eCFieldElement7 = this.f3509y;
            ECFieldElement eCFieldElement8 = this.f3510zs[0];
            ECFieldElement eCFieldElement9 = eCPoint.f3509y;
            ECFieldElement eCFieldElement10 = eCPoint.f3510zs[0];
        ...
        public ECPoint negate() {
            ...
            int curveCoordinateSystem = getCurveCoordinateSystem();
            if (curveCoordinateSystem == 0) {
                return new F2m(this.curve, eCFieldElement, this.f3509y.add(eCFieldElement));
            }
            if (curveCoordinateSystem == 1) {
                return new F2m(this.curve, eCFieldElement, this.f3509y.add(eCFieldElement), new ECFieldElement[]{this.f3510zs[0]});
            }
            if (curveCoordinateSystem == 5) {
                return new F2m(this.curve, eCFieldElement, this.f3509y.addOne());
            }
            if (curveCoordinateSystem != 6) {
                throw new IllegalStateException("unsupported coordinate system");
            }
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementMultiply = this.f3508x;
            if (eCFieldElementMultiply.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f3509y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f3509y;
                ECFieldElement eCFieldElement = this.f3510zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f3508x;
            ECFieldElement eCFieldElement3 = eCPoint.f3510zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f3509y;
            ECFieldElement eCFieldElement5 = this.f3510zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f3509y;
    ...
    public static class C3163Fp extends AbstractFp {
        C3163Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        }

        C3163Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }
        ...
        */
        public org.bouncycastle.math.p058ec.ECPoint add(org.bouncycastle.math.p058ec.ECPoint r17) {
            /*
                Method dump skipped, instruction units count: 532
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p058ec.ECPoint.C3163Fp.add(org.bouncycastle.math.ec.ECPoint):org.bouncycastle.math.ec.ECPoint");
        }
        ...
        @Override
        protected ECPoint detach() {
            return new C3163Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        protected ECFieldElement getJacobianModifiedW() {
            ECFieldElement eCFieldElement = this.f3510zs[1];
            if (eCFieldElement != null) {
                return eCFieldElement;
            }
            ECFieldElement[] eCFieldElementArr = this.f3510zs;
            ECFieldElement eCFieldElementCalculateJacobianModifiedW = calculateJacobianModifiedW(this.f3510zs[0], null);
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new C3163Fp(curve, this.f3508x, this.f3509y.negate(), this.f3510zs) : new C3163Fp(curve, this.f3508x, this.f3509y.negate());
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f3509y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
            ...
            ECFieldElement eCFieldElement2 = this.f3508x;
            ...
            return new C3163Fp(curve, eCFieldElementAdd2, eCFieldElement2.subtract(eCFieldElementAdd2).multiply(eCFieldElementSubtract2).subtract(eCFieldElement));
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f3509y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement a2 = curve.getA();
            ECFieldElement eCFieldElementMultiply = this.f3508x;
            ECFieldElement eCFieldElementFromBigInteger = this.f3510zs.length < 1 ? curve.fromBigInteger(ECConstants.ONE) : this.f3510zs[0];
            ...
            if (coordinateSystem == 0) {
                ...
                return new C3163Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementSquare2), eCFieldElementSubtract.multiply(eCFieldElementSquare2.multiply(eCFieldElementInvert)));
            }
            if (coordinateSystem == 1) {
                return new C3163Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementFromBigInteger), eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger.multiply(eCFieldElementFromBigInteger.square())});
            }
            if (coordinateSystem == 2) {
                return new C3163Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger});
            }
            if (coordinateSystem == 4) {
                return new C3163Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a2});
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                return new C3163Fp(curve, eCFieldElementSubtract2, eCFieldElementDivide.multiply(eCFieldElement2.subtract(eCFieldElementSubtract2)).subtract(eCFieldElement));
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement3 = this.f3510zs[0];
                ...
                return new C3163Fp(curve, eCFieldElementMultiply3, eCFieldElementFour.subtract(eCFieldElementSubtract3).multiply(eCFieldElementAdd).subtract(two(eCFieldElementTwo2.square())), new ECFieldElement[]{two(zIsOne ? two(eCFieldElementTwo2) : eCFieldElementTwo.square()).multiply(eCFieldElementMultiply2)});
            }
            if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
            ...
            return new C3163Fp(curve, eCFieldElementSubtract4, eCFieldElementSubtract5, new ECFieldElement[]{eCFieldElementTwo3});
        }

        protected C3163Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f3508x;
            ECFieldElement eCFieldElement2 = this.f3509y;
            ECFieldElement eCFieldElement3 = this.f3510zs[0];
            ...
            return new C3163Fp(getCurve(), eCFieldElementSubtract, eCFieldElementSubtract2, new ECFieldElement[]{eCFieldElementTwo, eCFieldElementTwo4});
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f3508x;
            ECFieldElement eCFieldElement3 = eCPoint.f3508x;
            ECFieldElement eCFieldElement4 = eCPoint.f3509y;
            ...
            return new C3163Fp(curve, eCFieldElementAdd, eCFieldElement2.subtract(eCFieldElementAdd).multiply(eCFieldElementSubtract4).subtract(eCFieldElement));
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f3508x = eCFieldElement;
        this.f3509y = eCFieldElement2;
        this.f3510zs = eCFieldElementArr;
    }
    ...
    public boolean isInfinity() {
        if (this.f3508x != null && this.f3509y != null) {
            ECFieldElement[] eCFieldElementArr = this.f3510zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f3510zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f3510zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f3510zs[i]);
        }
        stringBuffer.append(')');
