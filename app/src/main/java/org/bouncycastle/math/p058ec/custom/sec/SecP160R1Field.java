...
public class SecP160R1Field {
    ...
    private static final long f3531M = 4294967295L;

    private static final int f3533P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv = -2147483647;

    static final int[] f3532P = {Integer.MAX_VALUE, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f3532P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f3532P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f3532P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f3532P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f3532P) == 0);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mulWordsAdd(-2147483647, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f3532P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f3532P))) {
            Nat.addWordTo(5, -2147483647, iArr2);
        }
    }
}
