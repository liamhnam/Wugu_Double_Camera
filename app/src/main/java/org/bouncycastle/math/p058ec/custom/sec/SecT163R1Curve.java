...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        ...
        this.f3493a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f3494b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawXCoord()).f3585x, 0, jArr, i3);
            int i5 = i3 + 3;
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawYCoord()).f3585x, 0, jArr, i5);
            i3 = i5 + 3;
        }
