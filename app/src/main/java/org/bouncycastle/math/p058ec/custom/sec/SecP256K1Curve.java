...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3563q = SecP256K1FieldElement.f3566Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f3567x, 0, iArr, i3);
            int i5 = i3 + 8;
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f3567x, 0, iArr, i5);
            i3 = i5 + 8;
        }
