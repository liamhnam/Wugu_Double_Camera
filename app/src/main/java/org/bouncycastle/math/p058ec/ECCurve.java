...
import org.bouncycastle.math.p058ec.endo.ECEndomorphism;
import org.bouncycastle.math.p058ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    protected ECFieldElement f3493a;

    protected ECFieldElement f3494b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        synchronized BigInteger[] getSi() {
            if (this.f3495si == null) {
                this.f3495si = Tnaf.getSi(this);
            }
            return this.f3495si;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f3494b.isOne() && (this.f3493a.isZero() || this.f3493a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f3493a).multiply(eCFieldElementFromBigInteger).add(this.f3494b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f3493a = fromBigInteger(bigInteger);
            this.f3494b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f3493a = eCFieldElement;
            this.f3494b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.f3499m, this.f3496k1, this.f3497k2, this.f3498k3, this.f3493a, this.f3494b, this.order, this.cofactor);
        }

        @Override
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
            final int i3 = (this.f3499m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f3496k1} : new int[]{this.f3496k1, this.f3497k2, this.f3498k3};
            final long[] jArr = new long[i2 * i3 * 2];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f3504x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f3504x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            return new AbstractECLookupTable() {
                private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f3499m, iArr, new LongArray(jArr2)), new ECFieldElement.F2m(F2m.this.f3499m, iArr, new LongArray(jArr3)));
                }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f3499m, this.f3496k1, this.f3497k2, this.f3498k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f3497k2 == 0 && this.f3498k3 == 0;
        }
    ...
    public static class C3160Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C3163Fp infinity;

        BigInteger f3500q;

        BigInteger f3501r;

        public C3160Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, null, null);
        }

        public C3160Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f3500q = bigInteger;
            this.f3501r = ECFieldElement.C3161Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C3163Fp(this, null, null);
            this.f3493a = fromBigInteger(bigInteger2);
            this.f3494b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C3160Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f3500q = bigInteger;
            this.f3501r = bigInteger2;
            this.infinity = new ECPoint.C3163Fp(this, null, null);
            this.f3493a = eCFieldElement;
            this.f3494b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        @Override
        protected ECCurve cloneCurve() {
            return new C3160Fp(this.f3500q, this.f3501r, this.f3493a, this.f3494b, this.order, this.cofactor);
        }

        @Override
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C3163Fp(this, eCFieldElement, eCFieldElement2);
        }

        @Override
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C3163Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        @Override
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C3161Fp(this.f3500q, this.f3501r, bigInteger);
        }

        @Override
        public int getFieldSize() {
            return this.f3500q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.C3163Fp(this, fromBigInteger(eCPoint.f3508x.toBigInteger()), fromBigInteger(eCPoint.f3509y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f3510zs[0].toBigInteger())});
        }
