...
public class SecP128R1Field {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(4, iArr, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f3526P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(4, iArr2, Nat128.add(iArr, f3526P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f3526P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(4, iArr, f3526P) == 0);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((iArr[3] >>> 1) < 2147483646 || !Nat128.gte(iArr, f3526P)) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(4, iArr, 0, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f3526P))) {
            addPInvTo(iArr2);
        }
    }
}
