...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f3541q = SecP192K1FieldElement.f3544Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f3493a = fromBigInteger(ECConstants.ZERO);
        this.f3494b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f3545x, 0, iArr, i3);
            int i5 = i3 + 6;
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f3545x, 0, iArr, i5);
            i3 = i5 + 6;
        }
