...
public class SecP160R2Field {
    ...
    private static final int f3538P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv33 = 21389;

    static final int[] f3537P = {-21389, -2, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f3537P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f3537P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f3537P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f3537P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f3537P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat160.mul33DWordAdd(PInv33, Nat160.mul33Add(PInv33, iArr, 5, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f3537P))) {
            Nat.add33To(5, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mul33WordAdd(PInv33, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f3537P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f3537P))) {
            Nat.add33To(5, PInv33, iArr2);
        }
    }
}
