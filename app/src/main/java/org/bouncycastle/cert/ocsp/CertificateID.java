...
public class CertificateID {
    ...
    public CertificateID(DigestCalculator digestCalculator, X509CertificateHolder x509CertificateHolder, BigInteger bigInteger) throws OCSPException {
        this.f2906id = createCertID(digestCalculator, x509CertificateHolder, new ASN1Integer(bigInteger));
    }
    ...
    public static CertificateID deriveCertificateID(CertificateID certificateID, BigInteger bigInteger) {
        return new CertificateID(new CertID(certificateID.f2906id.getHashAlgorithm(), certificateID.f2906id.getIssuerNameHash(), certificateID.f2906id.getIssuerKeyHash(), new ASN1Integer(bigInteger)));
    }

    public boolean equals(Object obj) {
        if (obj instanceof CertificateID) {
            return this.f2906id.toASN1Primitive().equals(((CertificateID) obj).f2906id.toASN1Primitive());
        }
        return false;
    }

    public ASN1ObjectIdentifier getHashAlgOID() {
        return this.f2906id.getHashAlgorithm().getAlgorithm();
    }

    public byte[] getIssuerKeyHash() {
        return this.f2906id.getIssuerKeyHash().getOctets();
    }

    public byte[] getIssuerNameHash() {
        return this.f2906id.getIssuerNameHash().getOctets();
    }

    public BigInteger getSerialNumber() {
        return this.f2906id.getSerialNumber().getValue();
    }

    public int hashCode() {
        return this.f2906id.toASN1Primitive().hashCode();
    }
    ...
    public boolean matchesIssuer(X509CertificateHolder x509CertificateHolder, DigestCalculatorProvider digestCalculatorProvider) throws OCSPException {
        try {
            return createCertID(digestCalculatorProvider.get(this.f2906id.getHashAlgorithm()), x509CertificateHolder, this.f2906id.getSerialNumber()).equals(this.f2906id);
