...
public class RespID {
    ...
    public RespID(ResponderID responderID) {
        this.f2907id = responderID;
    }

    public RespID(X500Name x500Name) {
        this.f2907id = new ResponderID(x500Name);
    }
    ...
    public RespID(SubjectPublicKeyInfo subjectPublicKeyInfo, DigestCalculator digestCalculator) throws OCSPException {
        try {
            ...
            outputStream.close();
            this.f2907id = new ResponderID(new DEROctetString(digestCalculator.getDigest()));
        } catch (Exception e) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RespID) {
            return this.f2907id.equals(((RespID) obj).f2907id);
        }
        return false;
    }

    public int hashCode() {
        return this.f2907id.hashCode();
    }
