...
public class TimeStampResponse {
    ...
    public byte[] getEncoded(String str) throws IOException {
        return ASN1Encoding.f2807DL.equals(str) ? this.timeStampToken == null ? new DLSequence(this.resp.getStatus()).getEncoded(str) : new DLSequence(new ASN1Encodable[]{this.resp.getStatus(), this.timeStampToken.toCMSSignedData().toASN1Structure()}).getEncoded(str) : this.resp.getEncoded(str);
    }
