...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f3760v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f3760v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f3760v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f3760v = IntUtils.clone(gF2Vector.f3760v);
    }
    ...
    public Vector add(Vector vector) {
        ...
        int[] iArrClone = IntUtils.clone(gF2Vector.f3760v);
        for (int length = iArrClone.length - 1; length >= 0; length--) {
            iArrClone[length] = iArrClone[length] ^ this.f3760v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f3760v, gF2Vector.f3760v);
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        System.arraycopy(this.f3760v, 0, gF2Vector.f3760v, 0, i2);
        if (i3 != 0) {
            gF2Vector.f3760v[i2] = ((1 << i3) - 1) & this.f3760v[i2];
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        if (i4 != 0) {
            while (true) {
                ...
                int[] iArr = gF2Vector.f3760v;
                int[] iArr2 = this.f3760v;
                int i7 = i3 + 1;
                iArr[i6] = (iArr2[i3] >>> i4) | (iArr2[i7] << (32 - i4));
                i6++;
                i3 = i7;
            }
            int[] iArr3 = gF2Vector.f3760v;
            int[] iArr4 = this.f3760v;
            int i8 = i3 + 1;
            int i9 = iArr4[i3] >>> i4;
            iArr3[i2] = i9;
            if (i8 < iArr4.length) {
            ...
            System.arraycopy(this.f3760v, i3, gF2Vector.f3760v, 0, i5);
        }
        return gF2Vector;
    }
    ...
    public int getBit(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        return (this.f3760v[i2] & (1 << i3)) >>> i3;
    }

    @Override
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f3760v, (this.length + 7) >> 3);
    }
    ...
    @Override
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f3760v);
    }

    @Override
    public boolean isZero() {
        for (int length = this.f3760v.length - 1; length >= 0; length--) {
            if (this.f3760v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f3760v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }
