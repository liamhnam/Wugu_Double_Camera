...
public class GF2mField {
    ...
    public String elementToStr(int i) {
        ...
        for (int i2 = 0; i2 < this.degree; i2++) {
            string = ((((byte) i) & 1) == 0 ? new StringBuilder(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES) : new StringBuilder(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)).append(string).toString();
            i >>>= 1;
        }
        return string;
    }
