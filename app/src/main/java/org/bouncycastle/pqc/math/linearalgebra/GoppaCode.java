...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        private GF2Matrix f3763h;

        private Permutation f3764p;

        private GF2Matrix f3765s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f3765s = gF2Matrix;
            this.f3763h = gF2Matrix2;
            this.f3764p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        private GF2Matrix f3766g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f3766g = gF2Matrix;
            this.setJ = iArr;
        }
