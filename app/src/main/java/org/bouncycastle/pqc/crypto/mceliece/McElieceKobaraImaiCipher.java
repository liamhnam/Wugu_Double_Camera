...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private SecureRandom f3709sr;

    private int f3710t;

    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PrivateKeyParameters.getDigest());
        this.f3708n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f3707k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f3710t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f3708n = mcElieceCCA2PublicKeyParameters.getN();
        this.f3707k = mcElieceCCA2PublicKeyParameters.getK();
        this.f3710t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f3709sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f3709sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i2 = this.f3707k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f3708n, this.f3710t).bitLength() - 1) >> 3;
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f3708n, bArr));
        ...
        byte[] bArrDecode = Conversions.decode(this.f3708n, this.f3710t, gF2Vector);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f3707k, bArr9), Conversions.encode(this.f3708n, this.f3710t, bArr8)).getEncoded();
