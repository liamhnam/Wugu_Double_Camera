...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i4] = new Treehash[i5 - this.f3648K[i4]];
            if (i4 > 0) {
                int i6 = i4 - 1;
                bArr2[i6] = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, i5, this.mdLength);
                treehashArr2[i6] = new Treehash[this.heightOfTrees[i4] - this.f3648K[i4]];
            }
        ...
        while (i8 >= 0) {
            GMSSRootCalc gMSSRootCalcGenerateCurrentAuthpathAndRoot = i8 == this.numLayer + (-1) ? generateCurrentAuthpathAndRoot(null, vectorArr[i8], bArr5[i8], i8) : generateCurrentAuthpathAndRoot(bArr3[i8 + 1], vectorArr[i8], bArr5[i8], i8);
            int i9 = 0;
            ...
            vectorArr3[i8] = gMSSRootCalcGenerateCurrentAuthpathAndRoot.getRetain();
            treehashArr[i8] = gMSSRootCalcGenerateCurrentAuthpathAndRoot.getTreehash();
            System.arraycopy(gMSSRootCalcGenerateCurrentAuthpathAndRoot.getRoot(), 0, bArr3[i8], 0, this.mdLength);
            i8--;
            bArr = bArr;
            vectorArr = vectorArr;
        }
        ...
        while (i10 >= 0) {
            ...
            vectorArr4[i10] = gMSSRootCalcGenerateNextAuthpathAndRoot.getRetain();
            treehashArr2[i10] = gMSSRootCalcGenerateNextAuthpathAndRoot.getTreehash();
            System.arraycopy(gMSSRootCalcGenerateNextAuthpathAndRoot.getRoot(), 0, bArr6[i10], 0, this.mdLength);
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f3648K[i], this.digestProvider);
