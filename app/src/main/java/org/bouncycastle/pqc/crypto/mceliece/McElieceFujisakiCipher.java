...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private SecureRandom f3702sr;

    private int f3703t;

    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PrivateKeyParameters.getDigest());
        this.f3701n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f3703t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f3701n = mcElieceCCA2PublicKeyParameters.getN();
        this.f3700k = mcElieceCCA2PublicKeyParameters.getK();
        this.f3703t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f3702sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f3702sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i = (this.f3701n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f3701n, bArr2));
        ...
        if (Conversions.encode(this.f3701n, this.f3703t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        GF2Vector gF2Vector = new GF2Vector(this.f3700k, this.f3702sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f3701n, this.f3703t, bArr2)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
