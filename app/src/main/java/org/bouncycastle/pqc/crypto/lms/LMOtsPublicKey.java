...
class LMOtsPublicKey implements Encodable {
    ...
    private final byte[] f3669I;

    private final byte[] f3670K;
    ...
    LMSContext createOtsContext(LMOtsSignature lMOtsSignature) {
        ...
        LmsUtils.byteArray(this.f3669I, digest);
        LmsUtils.u32str(this.f3671q, digest);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f3671q != lMOtsPublicKey.f3671q) {
            return false;
        }
        ...
        if (Arrays.equals(this.f3669I, lMOtsPublicKey.f3669I)) {
            return Arrays.equals(this.f3670K, lMOtsPublicKey.f3670K);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.parameter.getType()).bytes(this.f3669I).u32str(this.f3671q).bytes(this.f3670K).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.parameter;
        return ((((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f3669I)) * 31) + this.f3671q) * 31) + Arrays.hashCode(this.f3670K);
    }
}
