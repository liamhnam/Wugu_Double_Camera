...
public class ComputeInField {
    ...
    private short[][] f3743A;

    short[] f3744x;

    private void computeZerosAbove() throws RuntimeException {
        for (int length = this.f3743A.length - 1; length > 0; length--) {
            for (int i = length - 1; i >= 0; i--) {
                short[][] sArr = this.f3743A;
    ...
    */
    ...
    private void substitute() throws IllegalStateException {
        short sInvElem = GF2Field.invElem(this.f3743A[r0.length - 1][r0.length - 1]);
        if (sInvElem == 0) {
            throw new IllegalStateException("The equation system is not solvable");
        }
        short[] sArr = this.f3744x;
        short[][] sArr2 = this.f3743A;
        sArr[sArr2.length - 1] = GF2Field.multElem(sArr2[sArr2.length - 1][sArr2.length], sInvElem);
        for (int length = this.f3743A.length - 2; length >= 0; length--) {
            short[][] sArr3 = this.f3743A;
            short sAddElem = sArr3[length][sArr3.length];
            for (int length2 = sArr3.length - 1; length2 > length; length2--) {
                sAddElem = GF2Field.addElem(sAddElem, GF2Field.multElem(this.f3743A[length][length2], this.f3744x[length2]));
            }
            short sInvElem2 = GF2Field.invElem(this.f3743A[length][length]);
            if (sInvElem2 == 0) {
                throw new IllegalStateException("Not solvable equation system");
            }
            this.f3744x[length] = GF2Field.multElem(sAddElem, sInvElem2);
        }
    }
    ...
    public short[][] inverse(short[][] sArr) {
        try {
            this.f3743A = (short[][]) Array.newInstance((Class<?>) Short.TYPE, sArr.length, sArr.length * 2);
            int i = 0;
    ...
    public short[][] multiplyMatrix(short[][] sArr, short[][] sArr2) throws RuntimeException {
        ...
        this.f3743A = (short[][]) Array.newInstance((Class<?>) Short.TYPE, sArr.length, sArr2[0].length);
        for (int i = 0; i < sArr.length; i++) {
            for (int i2 = 0; i2 < sArr2.length; i2++) {
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        ...
        try {
            this.f3743A = (short[][]) Array.newInstance((Class<?>) Short.TYPE, sArr.length, sArr.length + 1);
            this.f3744x = new short[sArr.length];
            for (int i = 0; i < sArr.length; i++) {
                for (int i2 = 0; i2 < sArr[0].length; i2++) {
                    this.f3743A[i][i2] = sArr[i][i2];
                }
            }
            for (int i3 = 0; i3 < sArr2.length; i3++) {
                short[] sArr3 = this.f3743A[i3];
