...
public class WinternitzOTSVerify {
    ...
    public byte[] Verify(byte[] bArr, byte[] bArr2) {
        ...
        int i7 = winternitzOTSVerify.f3659w;
        int i8 = (i6 + (i7 - 1)) / i7;
        int log = winternitzOTSVerify.getLog((i8 << i7) + 1);
        int i9 = winternitzOTSVerify.f3659w;
        ...
        if (8 % i9 == 0) {
            ...
            while (i17 < i4) {
                ...
                while (i19 < i13) {
                    ...
                    bArr3[i23] = (byte) (bArr3[i23] >>> winternitzOTSVerify.f3659w);
                    i18++;
                    i19++;
                    i15 = i21;
                    i17 = i23;
            ...
            if (i9 < 8) {
                ...
                while (i34 < i29) {
                    ...
                    int i36 = i5;
                    long j2 = 0;
                    while (i36 < winternitzOTSVerify.f3659w) {
                        j2 ^= (long) ((bArr3[i35] & UByte.MAX_VALUE) << (i36 << 3));
                        i35++;
                        i36++;
                        log = log;
                    }
                ...
                int i43 = log;
                int i44 = i30;
                int i45 = winternitzOTSVerify.mdsize % winternitzOTSVerify.f3659w;
                int i46 = 0;
                while (i46 < i45) {
                    j ^= (long) ((bArr3[i31] & UByte.MAX_VALUE) << (i46 << 3));
                    i31++;
                    i46++;
                    i32 = i32;
                    i33 = i33;
                ...
                while (i49 < i48) {
                    ...
                    int i53 = winternitzOTSVerify.f3659w;
                    j >>>= i53;
                    i47++;
                    i49 += i53;
                    i32 = i51;
                }
                int i54 = (i8 << winternitzOTSVerify.f3659w) - i32;
                int i55 = 0;
                while (i55 < i43) {
                    int i56 = winternitzOTSVerify.mdsize;
                    hashSignatureBlock(bArr2, i47 * i56, i44 - (i54 & i44), bArr4, i47 * i56);
                    int i57 = winternitzOTSVerify.f3659w;
                    i54 >>>= i57;
                    i47++;
                    i55 += i57;
                }
                ...
                if (i9 < 57) {
                    ...
                    while (i60 <= i58) {
                        ...
                        int i64 = i60 % 8;
                        int i65 = i58;
                        int i66 = i60 + winternitzOTSVerify.f3659w;
                        int i67 = (i66 + 7) >>> 3;
                        long j3 = 0;
                        int i68 = 0;
                        while (i63 < i67) {
                            j3 ^= (long) ((bArr3[i63] & UByte.MAX_VALUE) << (i68 << 3));
                            i68++;
                            i63++;
                            i67 = i67;
                            i66 = i66;
                    ...
                    if (i75 < winternitzOTSVerify.mdsize) {
                        ...
                        while (true) {
                            ...
                            j ^= (long) ((bArr3[i75] & UByte.MAX_VALUE) << (i77 << 3));
                            i77++;
                            i75++;
                        }
                        long j8 = i59;
                    ...
                    int i79 = (i74 << winternitzOTSVerify.f3659w) - i61;
                    int i80 = 0;
                    while (i80 < log) {
                        ...
                        int i83 = winternitzOTSVerify.f3659w;
                        i79 >>>= i83;
                        i62++;
                        i80 += i83;
                    }
    ...
    public int getSignatureLength() {
        ...
        return digestSize * (i2 + (((log + r3) - 1) / this.f3659w));
    }
}
