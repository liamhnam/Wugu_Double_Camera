...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(bArrMinMaxIPs[0], bArrMinMaxIPs[2]), min(bArrMinMaxIPs[1], bArrMinMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m1339or(bArrMinMaxIPs[0], bArrMinMaxIPs[2]), m1339or(bArr4, bArr6)));
    }
    ...
    private static byte[] m1339or(byte[] bArr, byte[] bArr2) {
