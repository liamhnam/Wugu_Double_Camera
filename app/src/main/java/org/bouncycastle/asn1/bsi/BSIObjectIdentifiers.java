...
public interface BSIObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(IppVersionsSupported.num1p1);
        ...
        ecdsa_plain_SHA1 = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        ecka_eg_X963kdf_SHA1 = aSN1ObjectIdentifierBranch4.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        ecka_eg_SessionKDF_3DES = aSN1ObjectIdentifierBranch5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
