...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        cryptlib_algorithm = aSN1ObjectIdentifierBranch;
        cryptlib_algorithm_blowfish_ECB = aSN1ObjectIdentifierBranch.branch(IppVersionsSupported.num1p1);
