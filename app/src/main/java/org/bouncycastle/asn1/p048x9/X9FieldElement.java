...
public class X9FieldElement extends ASN1Object {
    ...
    protected ECFieldElement f2903f;
    ...
    public X9FieldElement(BigInteger bigInteger, ASN1OctetString aSN1OctetString) {
        this(new ECFieldElement.C3161Fp(bigInteger, new BigInteger(1, aSN1OctetString.getOctets())));
    }

    public X9FieldElement(ECFieldElement eCFieldElement) {
        this.f2903f = eCFieldElement;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f2903f.toBigInteger(), converter.getByteLength(this.f2903f)));
    }
}
