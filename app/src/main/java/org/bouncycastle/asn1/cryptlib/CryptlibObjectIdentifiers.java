...
public class CryptlibObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE).branch("5");
        ecc = aSN1ObjectIdentifierBranch;
        curvey25519 = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    }
}
