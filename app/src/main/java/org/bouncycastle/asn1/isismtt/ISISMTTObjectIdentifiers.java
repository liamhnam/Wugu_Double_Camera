...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_cp_accredited = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        id_isismtt_at_dateOfCertGen = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
