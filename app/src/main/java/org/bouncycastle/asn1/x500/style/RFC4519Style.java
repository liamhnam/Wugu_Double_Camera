...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f2864c;

    public static final ASN1ObjectIdentifier f2865cn;

    public static final ASN1ObjectIdentifier f2866dc;
    ...
    public static final ASN1ObjectIdentifier f2867l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    public static final ASN1ObjectIdentifier f2868o;

    public static final ASN1ObjectIdentifier f2869ou;
    ...
    public static final ASN1ObjectIdentifier f2870sn;

    public static final ASN1ObjectIdentifier f2871st;
    ...
    static {
        ...
        f2867l = aSN1ObjectIdentifierIntern16;
        ...
        hashtable.put(aSN1ObjectIdentifierIntern2, Media.f727c);
        ...
        hashtable.put(aSN1ObjectIdentifierIntern16, MaterialAmountUnit.f721l);
        hashtable.put(aSN1ObjectIdentifierIntern17, "member");
        hashtable.put(aSN1ObjectIdentifierIntern18, NamingTable.TAG);
        ...
        hashtable2.put(Media.f727c, aSN1ObjectIdentifierIntern2);
        ...
        hashtable2.put(MaterialAmountUnit.f721l, aSN1ObjectIdentifierIntern16);
        hashtable2.put("member", aSN1ObjectIdentifierIntern17);
        hashtable2.put(NamingTable.TAG, aSN1ObjectIdentifierIntern18);
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals((ASN1Primitive) f2866dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals((ASN1Primitive) f2864c) || aSN1ObjectIdentifier.equals((ASN1Primitive) serialNumber) || aSN1ObjectIdentifier.equals((ASN1Primitive) dnQualifier) || aSN1ObjectIdentifier.equals((ASN1Primitive) telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
