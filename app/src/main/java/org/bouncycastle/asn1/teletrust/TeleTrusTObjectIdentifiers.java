...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        ripemd160 = aSN1ObjectIdentifier.branch(IppVersionsSupported.num2p1);
        ripemd128 = aSN1ObjectIdentifier.branch(IppVersionsSupported.num2p2);
        ...
        ecSignWithSha1 = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = aSN1ObjectIdentifierBranch3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ellipticCurve = aSN1ObjectIdentifierBranch4;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifierBranch4.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        versionOne = aSN1ObjectIdentifierBranch5;
        brainpoolP160r1 = aSN1ObjectIdentifierBranch5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
