...
public class TeleTrusTNamedCurves {
    ...
    public static ASN1ObjectIdentifier getOID(short s, boolean z) {
        return getOID("brainpoolP" + ((int) s) + (z ? "t" : PDPageLabelRange.STYLE_ROMAN_LOWER) + IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    }
}
