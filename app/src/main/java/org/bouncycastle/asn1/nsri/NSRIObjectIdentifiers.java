...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad_null = aSN1ObjectIdentifierBranch.branch(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES);
        id_pad_1 = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_aria128_ecb = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
