...
public class ASN1OutputStream {
    ...
    private OutputStream f2808os;

    public ASN1OutputStream(OutputStream outputStream) {
        this.f2808os = outputStream;
    }
    ...
    public static ASN1OutputStream create(OutputStream outputStream, String str) {
        return str.equals(ASN1Encoding.DER) ? new DEROutputStream(outputStream) : str.equals(ASN1Encoding.f2807DL) ? new DLOutputStream(outputStream) : new ASN1OutputStream(outputStream);
    }
    ...
    DEROutputStream getDERSubStream() {
        return new DEROutputStream(this.f2808os);
    }

    ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f2808os);
    }

    final void write(int i) throws IOException {
        this.f2808os.write(i);
    }

    final void write(byte[] bArr, int i, int i2) throws IOException {
        this.f2808os.write(bArr, i, i2);
    }
