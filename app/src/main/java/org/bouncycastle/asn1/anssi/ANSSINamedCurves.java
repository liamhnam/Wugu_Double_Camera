...
public class ANSSINamedCurves {
    static X9ECParametersHolder FRP256v1 = new X9ECParametersHolder() {
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve eCCurveConfigureCurve = ANSSINamedCurves.configureCurve(new ECCurve.C3160Fp(bigIntegerFromHex, bigIntegerFromHex2, bigIntegerFromHex3, bigIntegerFromHex4, bigIntegerValueOf));
