...
public interface GMObjectIdentifiers {
    ...
    static {
        ...
        sm2encrypt_recommendedParameters = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        sm2encrypt_specifiedParameters = aSN1ObjectIdentifierBranch.branch(ExifInterface.GPS_MEASUREMENT_2D);
        sm2encrypt_with_sm3 = aSN1ObjectIdentifierBranch.branch(IppVersionsSupported.num2p1);
        sm2encrypt_with_sha1 = aSN1ObjectIdentifierBranch.branch(IppVersionsSupported.num2p2);
