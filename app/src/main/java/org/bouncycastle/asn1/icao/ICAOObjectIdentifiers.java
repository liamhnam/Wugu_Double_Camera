...
public interface ICAOObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_icao_mrtd = aSN1ObjectIdentifierBranch;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_icao_mrtd_security = aSN1ObjectIdentifierBranch2;
        id_icao_ldsSecurityObject = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        id_icao_extensions_namechangekeyrollover = aSN1ObjectIdentifierBranch3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    }
}
