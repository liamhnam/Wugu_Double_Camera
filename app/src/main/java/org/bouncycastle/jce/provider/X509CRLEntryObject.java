...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f3470c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f3470c.equals(((X509CRLEntryObject) obj).f3470c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f3470c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f3470c.getRevocationDate().getDate();
    }

    @Override
    public BigInteger getSerialNumber() {
        return this.f3470c.getUserCertificate().getValue();
    }

    @Override
    public boolean hasExtensions() {
        return this.f3470c.getExtensions() != null;
    }
