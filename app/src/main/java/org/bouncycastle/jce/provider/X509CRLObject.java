...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f3471c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CRLException {
        if (!this.f3471c.getSignatureAlgorithm().equals(this.f3471c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f3471c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f3471c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f3471c.equals(x509CRLObject.f3471c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f3471c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f3471c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f3471c.getIssuer().toASN1Primitive()));
    }

    @Override
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f3471c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f3471c.getNextUpdate() != null) {
            return this.f3471c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f3471c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f3471c.getSignature().getOctets();
    }

    @Override
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f3471c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f3471c.getThisUpdate().getDate();
    }

    @Override
    public int getVersion() {
        return this.f3471c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f3471c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f3471c.getIssuer();
