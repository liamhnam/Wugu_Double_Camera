...
public class ECNamedCurveTable {
    public static Enumeration getNames() {
        return org.bouncycastle.asn1.p048x9.ECNamedCurveTable.getNames();
    }
    ...
    */
    public static org.bouncycastle.jce.spec.ECNamedCurveParameterSpec getParameterSpec(java.lang.String r8) {
        /*
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p052ec.CustomNamedCurves.getByName(r8)
            if (r0 != 0) goto L20
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p052ec.CustomNamedCurves.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> Lf
        Lf:
            if (r0 != 0) goto L20
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p048x9.ECNamedCurveTable.getByName(r8)
            if (r0 != 0) goto L20
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p048x9.ECNamedCurveTable.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> L20
        L20:
            if (r0 != 0) goto L24
            r8 = 0
            return r8
