...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_PK_DH = aSN1ObjectIdentifierBranch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifierBranch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_CA_DH = aSN1ObjectIdentifierBranch3;
        id_CA_DH_3DES_CBC_CBC = aSN1ObjectIdentifierBranch3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        id_CA_ECDH_3DES_CBC_CBC = aSN1ObjectIdentifierBranch4.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifier.branch("2.2.2");
        id_TA = aSN1ObjectIdentifierBranch5;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = aSN1ObjectIdentifierBranch5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_TA_RSA = aSN1ObjectIdentifierBranch6;
        id_TA_RSA_v1_5_SHA_1 = aSN1ObjectIdentifierBranch6.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        id_TA_ECDSA_SHA_1 = aSN1ObjectIdentifierBranch7.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
