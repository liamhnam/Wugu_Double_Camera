...
class X509CRLObject extends X509CRLImpl {
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                encoded = this.f3442c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e) {
                encoded = null;
                x509CRLException = new X509CRLException(e);
            }
            X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f3442c, this.sigAlgName, this.sigAlgParams, this.isIndirect, encoded, x509CRLException);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f3442c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f3442c.getSignature())) {
                return false;
            }
