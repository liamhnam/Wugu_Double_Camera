...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f3451iv);
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.f3451iv != null) {
            ...
            try {
                ...
                algorithmParametersCreateParametersInstance.init(new IvParameterSpec(this.f3451iv));
            } catch (Exception e) {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof IvParameterSpec) {
            this.f3451iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
            keyParameter = new ParametersWithIV(keyParameter, this.f3451iv);
        }
