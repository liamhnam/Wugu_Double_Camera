...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class C3113EC extends KeyPairGeneratorSpi {
        ...
        public C3113EC(String str, ProviderConfiguration providerConfiguration) {
            super(str);
            this.engine = new ECKeyPairGenerator();
            this.ecParams = null;
            this.strength = 239;
    ...
    public static class ECDH extends C3113EC {
        public ECDH() {
            super("ECDH", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDHC extends C3113EC {
        public ECDHC() {
            super("ECDHC", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDSA extends C3113EC {
        public ECDSA() {
            super("ECDSA", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECMQV extends C3113EC {
        public ECMQV() {
