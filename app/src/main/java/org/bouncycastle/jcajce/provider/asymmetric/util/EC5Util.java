...
import org.bouncycastle.asn1.p048x9.ECNamedCurveTable;
import org.bouncycastle.asn1.p048x9.X962Parameters;
import org.bouncycastle.asn1.p048x9.X9ECParameters;
import org.bouncycastle.crypto.p052ec.CustomNamedCurves;
...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C3160Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C3160Fp c3160Fp = new ECCurve.C3160Fp(((ECFieldFp) field).getP(), a2, b);
            return customCurves.containsKey(c3160Fp) ? (ECCurve) customCurves.get(c3160Fp) : c3160Fp;
        }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p058ec.ECPoint eCPoint) {
        org.bouncycastle.math.p058ec.ECPoint eCPointNormalize = eCPoint.normalize();
        return new ECPoint(eCPointNormalize.getAffineXCoord().toBigInteger(), eCPointNormalize.getAffineYCoord().toBigInteger());
    }

    public static org.bouncycastle.math.p058ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p058ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p058ec.ECPoint eCPointConvertPoint = convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator());
