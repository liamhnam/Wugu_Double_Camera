...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    private BigInteger f3430y;

    BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f3430y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f3430y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f3430y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f3430y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f3430y = dSAPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (this.dsaSpec == null) {
            ...
            aSN1Integer = new ASN1Integer(this.f3430y);
        } else {
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f3430y, getParams())).append("]").append(strLineSeparator);
