...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    private ECPoint f3405_P;

    private ECPoint f3406_Q;
    private ECCurve.C3160Fp _curve;
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{new DualECPoints(128, c3160Fp.createPoint(bigInteger, bigInteger2), c3160Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, c3160Fp.createPoint(bigInteger5, bigInteger6), c3160Fp.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c3160Fp.createPoint(bigInteger9, bigInteger10), c3160Fp.createPoint(bigInteger11, bigInteger12), 1)};
        ECCurve.C3160Fp c3160Fp = (ECCurve.C3160Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C3160Fp c3160Fp2 = (ECCurve.C3160Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C3160Fp c3160Fp3 = (ECCurve.C3160Fp) NISTNamedCurves.getByName("P-521").getCurve();
    }
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L71:
            ...
            goto L2f
        L74:
            org.bouncycastle.math.ec.ECPoint r2 = r1.f3405_P
            if (r2 == 0) goto L8a
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f3407_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f3407_s);
        int length3 = 0;
        Arrays.fill(bArr, (byte) 0);
        int length4 = 0;
        for (int i = 0; i < length2; i++) {
            bigInteger = getScalarMultipleXCoord(this.f3405_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f3406_Q, bigInteger).toByteArray();
        ...
        if (length4 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f3405_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f3406_Q, bigInteger).toByteArray();
        ...
        this.f3407_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f3405_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f3407_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f3407_s, this._seedlen), getEntropy(), bArr), this._seedlen);
