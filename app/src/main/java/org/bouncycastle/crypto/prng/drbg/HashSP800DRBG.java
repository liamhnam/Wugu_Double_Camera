...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    private byte[] f3410_C;

    private byte[] f3411_V;
    ...
    static {
        ...
        seedlens = hashtable;
        hashtable.put(McElieceCCA2KeyGenParameterSpec.SHA1, Integers.valueOf(UiPosIndexEnum.KEYBOARD_DEL));
        hashtable.put(McElieceCCA2KeyGenParameterSpec.SHA224, Integers.valueOf(UiPosIndexEnum.KEYBOARD_DEL));
        hashtable.put("SHA-256", Integers.valueOf(UiPosIndexEnum.KEYBOARD_DEL));
        hashtable.put(SPHINCSKeyParameters.SHA512_256, Integers.valueOf(UiPosIndexEnum.KEYBOARD_DEL));
        hashtable.put("SHA-512/224", Integers.valueOf(UiPosIndexEnum.KEYBOARD_DEL));
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (bArr2 != null) {
            byte[] bArr3 = this.f3411_V;
            byte[] bArr4 = new byte[bArr3.length + 1 + bArr2.length];
            bArr4[0] = 2;
            System.arraycopy(bArr3, 0, bArr4, 1, bArr3.length);
            System.arraycopy(bArr2, 0, bArr4, this.f3411_V.length + 1, bArr2.length);
            addTo(this.f3411_V, hash(bArr4));
        }
        byte[] bArrHashgen = hashgen(this.f3411_V, length);
        byte[] bArr5 = this.f3411_V;
        byte[] bArr6 = new byte[bArr5.length + 1];
        System.arraycopy(bArr5, 0, bArr6, 1, bArr5.length);
        bArr6[0] = 3;
        addTo(this.f3411_V, hash(bArr6));
        addTo(this.f3411_V, this.f3410_C);
        addTo(this.f3411_V, new byte[]{(byte) (r6 >> 24), (byte) (r6 >> 16), (byte) (r6 >> 8), (byte) this._reseedCounter});
        this._reseedCounter++;
    ...
    public void reseed(byte[] bArr) {
        byte[] bArrHash_df = Utils.hash_df(this._digest, Arrays.concatenate(ONE, this.f3411_V, getEntropy(), bArr), this._seedLength);
        this.f3411_V = bArrHash_df;
        byte[] bArr2 = new byte[bArrHash_df.length + 1];
        bArr2[0] = 0;
        System.arraycopy(bArrHash_df, 0, bArr2, 1, bArrHash_df.length);
        this.f3410_C = Utils.hash_df(this._digest, bArr2, this._seedLength);
        this._reseedCounter = 1L;
    }
}
