...
public class X931RNG {
    ...
    private final byte[] f3398DT;

    private final byte[] f3399I;

    private final byte[] f3400R;
    ...
    public X931RNG(BlockCipher blockCipher, byte[] bArr, EntropySource entropySource) {
        ...
        this.f3399I = new byte[blockCipher.getBlockSize()];
        this.f3400R = new byte[blockCipher.getBlockSize()];
    }
    ...
    int generate(byte[] bArr, boolean z) {
        ...
        int length = bArr.length / this.f3400R.length;
        for (int i = 0; i < length; i++) {
            this.engine.processBlock(this.f3398DT, 0, this.f3399I, 0);
            process(this.f3400R, this.f3399I, this.f3401V);
            process(this.f3401V, this.f3400R, this.f3399I);
            byte[] bArr2 = this.f3400R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * i, bArr2.length);
            increment(this.f3398DT);
        }
        int length2 = bArr.length - (this.f3400R.length * length);
        if (length2 > 0) {
            this.engine.processBlock(this.f3398DT, 0, this.f3399I, 0);
            process(this.f3400R, this.f3399I, this.f3401V);
            process(this.f3401V, this.f3400R, this.f3399I);
            byte[] bArr3 = this.f3400R;
