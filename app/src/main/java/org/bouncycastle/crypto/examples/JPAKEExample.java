...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", Cups.AuthInfoRequired.password.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", Cups.AuthInfoRequired.password.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
