...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    private BigInteger f3350y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f3350y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f3350y) && super.equals(obj);
    }
    ...
    @Override
    public int hashCode() {
        return this.f3350y.hashCode() ^ super.hashCode();
    }
}
