...
public abstract class GCMUtil {
    ...
    private static final int f3317E1 = -520093696;
    ...
    public static void multiply(long[] jArr, long[] jArr2) {
        ...
        long jImplMul642 = implMul64(j2, j4) << 1;
        long jReverse7 = Longs.reverse(implMul64(jReverse ^ jReverse2, jReverse3 ^ jReverse4));
        long jImplMul643 = ((implMul64(j ^ j2, j3 ^ j4) << 1) ^ ((jReverse6 ^ jImplMul64) ^ jImplMul642)) ^ ((jImplMul642 << 62) ^ (jImplMul642 << 57));
