...
public final class DigestFactory {
    ...
    static {
        ...
        cloneMap = map;
        map.put(createMD5().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new MD5Digest((MD5Digest) digest);
            }
        });
        map.put(createSHA1().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new MD5Digest((MD5Digest) digest);
            }
        });
        map.put(createSHA224().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA224Digest((SHA224Digest) digest);
            }
        });
        map.put(createSHA256().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA256Digest((SHA256Digest) digest);
            }
        });
        map.put(createSHA384().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA384Digest((SHA384Digest) digest);
            }
        });
        map.put(createSHA512().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA512Digest((SHA512Digest) digest);
            }
        });
        map.put(createSHA3_224().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA3Digest((SHA3Digest) digest);
            }
        });
        map.put(createSHA3_256().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA3Digest((SHA3Digest) digest);
            }
        });
        map.put(createSHA3_384().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA3Digest((SHA3Digest) digest);
            }
        });
        map.put(createSHA3_512().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHA3Digest((SHA3Digest) digest);
            }
        });
        map.put(createSHAKE128().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHAKEDigest((SHAKEDigest) digest);
            }
        });
        map.put(createSHAKE256().getAlgorithmName(), new Cloner() {
            @Override
            public Digest createClone(Digest digest) {
                return new SHAKEDigest((SHAKEDigest) digest);
            }
