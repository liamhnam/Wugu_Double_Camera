...
public class SM2Engine {
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        return C30541.$SwitchMap$org$bouncycastle$crypto$engines$SM2Engine$Mode[this.mode.ordinal()] != 1 ? Arrays.concatenate(encoded, bArr2, bArr3) : Arrays.concatenate(encoded, bArr3, bArr2);
    }
