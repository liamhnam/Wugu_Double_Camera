...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    private byte[] theD;
    private static final byte[] EK_d = {34, 47, 36, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SnmpConstants.CONS_SEQ};
    private static final byte[] EK_d32 = {34, 47, 37, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SnmpConstants.CONS_SEQ};
    private static final byte[] EK_d64 = {35, 47, 36, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SnmpConstants.CONS_SEQ};
    private static final byte[] EK_d128 = {35, 47, 37, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SnmpConstants.CONS_SEQ};
    ...
    protected void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        ...
        iArr[15] = MAKEU31(bArr[15], (byte) (this.theD[15] | (bArr[31] & SnmpConstants.SNMP_ERR_UNDOFAILED)), bArr[30], bArr[29]);
    }
}
