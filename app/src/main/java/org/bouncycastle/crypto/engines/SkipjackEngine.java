...
public class SkipjackEngine implements BlockCipher {
    ...
    private int m1429g(int i, int i2) {
        int i3 = (i2 >> 8) & 255;
        int i4 = i2 & 255;
        short[] sArr = ftable;
    ...
    private int m1430h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            int i9 = 0;
            while (i9 < 8) {
                int iM1430h = m1430h(i7, i4);
                int i10 = (i5 ^ iM1430h) ^ (i7 + 1);
                i7--;
                i9++;
                int i11 = i6;
                i6 = i3;
