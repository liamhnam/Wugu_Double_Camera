...
public class HC256Engine implements StreamCipher {
    ...
    private byte[] f3171iv;
    private byte[] key;

    private int[] f3172p = new int[1024];

    private int[] f3173q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr4 = this.f3171iv;
        if (bArr4.length < 32) {
            byte[] bArr5 = new byte[32];
            System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
            byte[] bArr6 = this.f3171iv;
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f3171iv[i3] & UByte.MAX_VALUE) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f3172p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f3173q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f3171iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f3171iv = new byte[0];
