...
public class ThreefishEngine implements BlockCipher {
    ...
    private long[] f3210kw;

    private long[] f3211t = new long[5];
    ...
    private static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f3212kw;
            long[] jArr4 = this.f3213t;
    ...
    private static abstract class ThreefishCipher {
        ...
        protected final long[] f3212kw;

        protected final long[] f3213t;
    ...
    public ThreefishEngine(int i) {
        ...
        this.f3210kw = new long[(i3 * 2) + 1];
        if (i == 256) {
            threefish256Cipher = new Threefish256Cipher(this.f3210kw, this.f3211t);
        } else if (i == 512) {
            threefish256Cipher = new Threefish512Cipher(this.f3210kw, this.f3211t);
        } else {
            if (i != 1024) {
                throw new IllegalArgumentException("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            }
            threefish256Cipher = new Threefish1024Cipher(this.f3210kw, this.f3211t);
        }
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i >= i2) {
                long[] jArr2 = this.f3210kw;
                jArr2[i2] = j;
                System.arraycopy(jArr2, 0, jArr2, i2 + 1, i2);
                return;
            } else {
                long[] jArr3 = this.f3210kw;
                long j2 = jArr[i];
                jArr3[i] = j2;
                j ^= j2;
                i++;
