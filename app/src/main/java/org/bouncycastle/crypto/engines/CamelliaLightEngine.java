...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, SnmpConstants.SNMP_VAR_ENDOFMIBVIEW, 44, -20, -77, 39, SnmpConstants.ASN_PRIVATE, -27, -28, -123, 87, 53, -22, 12, -82, SnmpConstants.COUNTER, 35, -17, 107, -109, SnmpConstants.NSAP_ADDRESS, 25, SnmpConstants.GETBULK_REQ_MSG, 33, -19, 14, 79, 78, 29, 101, -110, -67, -122, -72, -81, -113, 124, -21, SnmpConstants.ASN_EXTENSION_ID, -50, 62, SnmpConstants.CONS_SEQ, -36, 95, 94, -59, 11, 26, SnmpConstants.INFORM_REQ_MSG, MdbAddr.DEF_ADDR, 57, -54, -43, SnmpConstants.UINTEGER32, 93, Base64.padSymbol, -39, 1, 90, -42, 81, 86, 108, 77, -117, 13, -102, 102, -5, -52, -80, 45, 116, SnmpConstants.SNMP_ERR_INCONSISTENTNAME, 43, 32, -16, -79, -124, -103, -33, 76, -53, -62, 52, 126, 118, 5, 109, -73, -87, 49, -47, 23, 4, -41, SnmpConstants.SNMP_ERR_DECODINGASN_EXC, 88, 58, 97, -34, 27, 17, 28, 50, SnmpConstants.SNMP_ERR_UNDOFAILED, -100, 22, 83, 24, -14, 34, -2, SnmpConstants.OPAQUE, -49, -78, -61, -75, 122, -111, 36, 8, -24, SnmpConstants.GET_RPRT_MSG, 96, -4, 105, 80, -86, -48, SnmpConstants.GET_REQ_MSG, 125, SnmpConstants.GETNEXT_REQ_MSG, -119, 98, -105, 84, 91, 30, -107, -32, -1, 100, -46, 16, -60, 0, 72, SnmpConstants.SET_REQ_MSG, -9, 117, -37, -118, 3, -26, -38, 9, Utf8.REPLACEMENT_BYTE, -35, -108, -121, 92, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, ByteCompanionObject.MAX_VALUE, -65, -30, 82, -101, -40, 38, -56, 55, -58, 59, SnmpConstants.SNMP_VAR_NOSUCHINSTANCE, -106, 111, 75, SnmpConstants.SNMP_ERR_DECODING_EXC, -66, 99, 46, -23, 121, SnmpConstants.TRPV2_REQ_MSG, -116, -97, 110, PSSSigner.TRAILER_IMPLICIT, -114, 41, -11, -7, -74, 47, -3, -76, 89, 120, -104, 6, 106, -25, SnmpConstants.COUNTER64, 113, -70, -44, 37, -85, SnmpConstants.GAUGE, -120, SnmpConstants.GET_RSP_MSG, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, 54, 73, 42, 104, 60, 56, -15, SnmpConstants.TRP_REQ_MSG, 64, 40, -45, 123, -69, -55, SnmpConstants.TIMETICKS, -63, SnmpConstants.SNMP_ERR_DECODINGPKTLNGTH_EXC, -29, -83, -12, 119, -57, -128, -98};
    private int[] subkey = new int[96];

    private int[] f3148kw = new int[8];

    private int[] f3147ke = new int[12];
    ...
    private void camelliaFLs(int[] iArr, int[] iArr2, int i) {
        int iLeftRotate = iArr[1] ^ leftRotate(iArr[0] & iArr2[i + 0], 1);
        iArr[1] = iLeftRotate;
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f3147ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyis128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f3147ke, 4);
                ...
                roldq(15, iArr2, 0, this.f3147ke, 0);
                ...
                roldq(17, iArr2, 0, this.f3148kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f3147ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f3147ke, 4);
            ...
            roldq(17, iArr2, 0, this.f3148kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f3148kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f3148kw, 0);
    }
