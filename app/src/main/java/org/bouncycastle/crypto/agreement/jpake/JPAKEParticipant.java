...
public class JPAKEParticipant {
    ...
    private BigInteger f2922b;
    private final Digest digest;

    private final BigInteger f2923g;
    private BigInteger gx1;
    private BigInteger gx2;
    private BigInteger gx3;
    private BigInteger gx4;

    private final BigInteger f2924p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    private final BigInteger f2925q;
    private final SecureRandom random;
    private int state;

    private BigInteger f2926x1;

    private BigInteger f2927x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(cArr, Cups.AuthInfoRequired.password);
        ...
        this.f2924p = jPAKEPrimeOrderGroup.getP();
        this.f2925q = jPAKEPrimeOrderGroup.getQ();
        this.f2923g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f2924p, this.f2925q, this.gx4, this.f2927x2, bigIntegerCalculateS, this.f2922b);
        this.f2926x1 = null;
        this.f2927x2 = null;
        this.f2922b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f2926x1 = JPAKEUtil.generateX1(this.f2925q, this.random);
        this.f2927x2 = JPAKEUtil.generateX2(this.f2925q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f2924p, this.f2923g, this.f2926x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f2924p, this.f2923g, this.f2927x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f2924p, this.f2925q, this.f2923g, this.gx1, this.f2926x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f2924p, this.f2925q, this.f2923g, this.gx2, this.f2927x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f2924p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f2925q, this.f2927x2, JPAKEUtil.calculateS(this.password));
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f2924p, this.f2925q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f2924p, this.f2925q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f2924p, this.f2925q, this.f2923g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f2924p, this.f2925q, this.f2923g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f2924p, this.gx3, this.gx1, this.gx2);
        this.f2922b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f2924p, this.f2925q, bigIntegerCalculateGA, this.f2922b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
