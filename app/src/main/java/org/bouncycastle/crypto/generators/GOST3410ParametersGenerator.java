...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                BigInteger bigInteger7 = new BigInteger(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES);
    ...
    private long procedure_Aa(long j, long j2, BigInteger[] bigIntegerArr, int i) {
        ...
        long jNextInt = j;
        while (true) {
            if (jNextInt >= 0 && jNextInt <= faceunity.FUAITYPE_HUMAN_PROCESSOR_2D_SLIM) {
                break;
            }
        ...
        long jNextInt2 = j2;
        while (true) {
            if (jNextInt2 >= 0 && jNextInt2 <= faceunity.FUAITYPE_HUMAN_PROCESSOR_2D_SLIM && jNextInt2 / 2 != 0) {
                break;
            }
    ...
    private void procedure_B(int i, int i2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            BigInteger bigInteger5 = new BigInteger(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES);
