...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f3232h = macSize;
        this.f3233k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f3232h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f3233k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f3233k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f3232h, i8);
            System.arraycopy(this.f3233k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f3232h));
