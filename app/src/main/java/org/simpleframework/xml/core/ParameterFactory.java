...
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i) throws Exception {
        ...
        if (annotation2 != null) {
            return (Parameter) constructor2.newInstance(constructor, annotation, annotation2, this.format, Integer.valueOf(i));
        }
        return (Parameter) constructor2.newInstance(constructor, annotation, this.format, Integer.valueOf(i));
    }
