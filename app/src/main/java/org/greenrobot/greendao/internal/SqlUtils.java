...
public class SqlUtils {
    ...
    public static StringBuilder appendProperty(StringBuilder sb, String str, Property property) {
        ...
        sb.append(Typography.quote).append(property.columnName).append(Typography.quote);
        return sb;
    }
    ...
    public static String createSqlSelect(String str, String str2, String[] strArr, boolean z) {
        ...
        sb.append(Typography.quote).append(str).append(Typography.quote).append(' ').append(str2).append(' ');
        return sb.toString();
    }
