...
public abstract class AbstractDaoTest<D extends AbstractDao<T, K>, T, K> extends DbTest {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            setUpTableForDao();
            InternalUnitTestDaoAccess<T, K> internalUnitTestDaoAccess = new InternalUnitTestDaoAccess<>(this.f3787db, this.daoClass, this.identityScopeForDao);
    ...
    protected void setUpTableForDao() throws Exception {
        try {
            this.daoClass.getMethod("createTable", Database.class, Boolean.TYPE).invoke(null, this.f3787db, false);
        } catch (NoSuchMethodException unused) {
            DaoLog.m1470i("No createTable method");
        }
    }
    ...
    protected void clearIdentityScopeIfAny() {
        ...
        if (identityScope != null) {
            identityScope.clear();
            DaoLog.m1466d("Identity scope cleared");
        } else {
            DaoLog.m1466d("No identity scope to clear");
        }
    }
