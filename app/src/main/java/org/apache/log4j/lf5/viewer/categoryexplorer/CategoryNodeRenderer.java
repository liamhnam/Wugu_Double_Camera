...
public class CategoryNodeRenderer extends DefaultTreeCellRenderer {
    public static final Color FATAL_CHILDREN = new Color(PsExtractor.PRIVATE_STREAM_1, UiPosIndexEnum.HOME_REPLACE_BG_TAB, 0);
    ...
    protected String buildToolTip(CategoryNode categoryNode) {
        ...
        stringBuffer.append(" LogRecords. Right-click for more info.");
