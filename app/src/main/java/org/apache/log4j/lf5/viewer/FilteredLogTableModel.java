...
public class FilteredLogTableModel extends AbstractTableModel {
    ...
    protected String[] _colNames = {"Date", PDActionThread.SUB_TYPE, "Message #", "Level", "NDC", "Category", "Message", HttpHeaders.LOCATION, "Thrown"};
    ...
    protected Object getColumn(int i, LogRecord logRecord) {
        ...
        switch (i) {
            ...
            default:
                throw new IllegalArgumentException(new StringBuffer("The column number ").append(i).append("must be between 0 and 8").toString());
        }
    }
