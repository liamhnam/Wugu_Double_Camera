...
public class ConfigurationManager {
    ...
    protected void load() {
        ...
        if (file.exists()) {
            try {
                ...
                System.err.println(new StringBuffer("Unable process configuration file at ").append(getFilename()).append(". Error Message=").append(e.getMessage()).toString());
            }
        }
    }
    ...
    protected void processCategories(Document document) {
        ...
        ?? EqualsIgnoreCase = getValue(elementsByTagName.item(0).getAttributes(), "name").equalsIgnoreCase(FIRST_CATEGORY_NAME);
    ...
    protected void deleteConfigurationFile() {
        try {
            ...
            System.err.println(new StringBuffer("Cannot delete ").append(getFilename()).append(" because a security violation occured.").toString());
        }
    }
