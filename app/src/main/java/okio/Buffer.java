...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public static UnsafeCursor readUnsafe$default(Buffer buffer, UnsafeCursor unsafeCursor, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static UnsafeCursor readAndWriteUnsafe$default(Buffer buffer, UnsafeCursor unsafeCursor, int i, Object obj) {
        if ((i & 1) != 0) {
            unsafeCursor = _UtilKt.getDEFAULT__new_UnsafeCursor();
        }
    ...
    public static Buffer copyTo$default(Buffer buffer, OutputStream outputStream, long j, long j2, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            j = 0;
        }
        long j3 = j;
    ...
    public static Buffer copyTo$default(Buffer buffer, Buffer buffer2, long j, long j2, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
    ...
    public static Buffer copyTo$default(Buffer buffer, Buffer buffer2, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
    ...
    public static Buffer writeTo$default(Buffer buffer, OutputStream outputStream, long j, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            j = buffer.size;
        }
    ...
    public final byte m3497deprecated_getByte(long index) {
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b & 128) == 0) {
            ...
            i = b & SnmpConstants.ASN_EXTENSION_ID;
            i2 = 2;
            i3 = 128;
        } else if ((b & 240) == 224) {
            i = b & SnmpConstants.SNMP_ERR_UNDOFAILED;
            i2 = 3;
            i3 = 2048;
        } else {
            if ((b & 248) != 240) {
        ...
        for (int i4 = 1; i4 < i2; i4++) {
            long j2 = i4;
            byte b2 = getByte(j2);
            if ((b2 & SnmpConstants.ASN_PRIVATE) != 128) {
                skip(j2);
                return Utf8.REPLACEMENT_CODE_POINT;
            }
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v >= 100000000) {
            i = v < 1000000000000L ? v < RealConnection.IDLE_CONNECTION_HEALTHY_NS ? v < C1041C.NANOS_PER_SECOND ? 9 : 10 : v < 100000000000L ? 11 : 12 : v < 1000000000000000L ? v < 10000000000000L ? 13 : v < 100000000000000L ? 14 : 15 : v < 100000000000000000L ? v < 10000000000000000L ? 16 : 17 : v < 1000000000000000000L ? 18 : 19;
        } else if (v >= 10000) {
            ...
            if (segment != null) {
                ...
                while (j2 < size5) {
                    ...
                    for (int i2 = (int) ((((long) segment.pos) + j) - j2); i2 < iMin2; i2++) {
                        if (bArr2[i2] == b2 && _BufferKt.rangeEquals(segment, i2 + 1, bArrInternalArray$okio2, 1, size4)) {
