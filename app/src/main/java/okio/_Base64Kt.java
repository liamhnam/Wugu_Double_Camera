...
@Metadata(m1292d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0012\n\u0002\b\b\n\u0002\u0010\u000e\n\u0002\b\u0003\u001a\u000e\u0010\t\u001a\u0004\u0018\u00010\u0001*\u00020\nH\u0000\u001a\u0016\u0010\u000b\u001a\u00020\n*\u00020\u00012\b\b\u0002\u0010\f\u001a\u00020\u0001H\u0000\"\u001c\u0010\u0000\u001a\u00020\u00018\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0002\u0010\u0003\u001a\u0004\b\u0004\u0010\u0005\"\u001c\u0010\u0006\u001a\u00020\u00018\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0007\u0010\u0003\u001a\u0004\b\b\u0010\u0005¨\u0006\r"}, m1293d2 = {"BASE64", "", "getBASE64$annotations", "()V", "getBASE64", "()[B", "BASE64_URL_SAFE", "getBASE64_URL_SAFE$annotations", "getBASE64_URL_SAFE", "decodeBase64ToArray", "", "encodeBase64", "map", "okio"}, m1294k = 2, m1295mv = {1, 6, 0}, m1297xi = 48)
public final class _Base64Kt {
    ...
    public static final String encodeBase64(byte[] bArr, byte[] map) {
        ...
        while (i < length) {
            ...
            int i8 = i7 + 1;
            bArr2[i7] = map[((b2 & SnmpConstants.SNMP_ERR_UNDOFAILED) << 2) | ((b3 & UByte.MAX_VALUE) >> 6)];
            i2 = i8 + 1;
        ...
        if (length2 == 1) {
            ...
            bArr2[i13] = map[(b7 & SnmpConstants.SNMP_ERR_UNDOFAILED) << 2];
            bArr2[i13 + 1] = (byte) 61;
        }
