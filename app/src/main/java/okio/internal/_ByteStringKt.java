...
public final class _ByteStringKt {
    ...
    public static final String commonHex(ByteString byteString) {
        ...
        for (byte b : byteString.getData()) {
            ...
            i = i2 + 1;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & SnmpConstants.SNMP_ERR_UNDOFAILED];
        }
