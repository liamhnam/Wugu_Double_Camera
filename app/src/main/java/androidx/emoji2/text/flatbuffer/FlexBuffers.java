...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                return (int) FlexBuffers.readUInt(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (int) FlexBuffers.readDouble(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 5) {
                return Integer.parseInt(asString());
            }
            if (i == 6) {
                ReadBuf readBuf = this.f200bb;
                return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
            }
            if (i == 7) {
                ReadBuf readBuf2 = this.f200bb;
                return (int) FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
            }
            if (i == 8) {
                ReadBuf readBuf3 = this.f200bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return FlexBuffers.readLong(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f200bb, this.end, this.parentWidth);
            }
            if (i == 10) {
                return asVector().size();
            }
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f200bb, this.end, this.parentWidth);
            }
            if (i != 1) {
                if (i != 2) {
                    if (i == 5) {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f200bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f200bb;
                int i = this.byteWidth;
                return this.f200bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i, i));
            }
            if (!isKey()) {
                return "";
            }
            int iIndirect2 = FlexBuffers.indirect(this.f200bb, this.end, this.byteWidth);
            int i2 = iIndirect2;
            while (this.f200bb.get(i2) != 0) {
                i2++;
            }
            return this.f200bb.getString(iIndirect2, i2 - iIndirect2);
        }
        ...
        public boolean asBoolean() {
            return isBoolean() ? this.f200bb.get(this.end) != 0 : asUInt() != 0;
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f199bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f199bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f199bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f199bb.get(this.end + i);
        }

        @Override
        public String toString() {
            return this.f199bb.getString(this.end, size());
        }

        @Override
        public StringBuilder toString(StringBuilder sb) {
            sb.append(Typography.quote);
            sb.append(this.f199bb.getString(this.end, size()));
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f199bb.get(i) != 0) {
                i++;
            }
            return this.f199bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f199bb, FlexBuffers.indirect(this.f199bb, i, this.byteWidth), FlexBuffers.readInt(this.f199bb, i + this.byteWidth, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f199bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f199bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f199bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j))));
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f199bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f199bb, FlexBuffers.indirect(this.vec.f199bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
