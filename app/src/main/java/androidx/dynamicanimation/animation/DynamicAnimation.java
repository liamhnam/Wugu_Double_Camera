...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty f194X = new ViewProperty("x") {
        @Override
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    public static final ViewProperty f195Y = new ViewProperty("y") {
        @Override
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    public static final ViewProperty f196Z = new ViewProperty("z") {
        @Override
        public void setValue(View view, float f) {
