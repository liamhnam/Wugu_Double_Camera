...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0039R.styleable.ActionBar, C0039R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0039R.styleable.ActionBar_height, 0));
