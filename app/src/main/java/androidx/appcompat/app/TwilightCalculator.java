...
class TwilightCalculator {
    ...
    private static final float f122C1 = 0.0334196f;

    private static final float f123C2 = 3.49066E-4f;

    private static final float f124C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    private static final float f125J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double dRound = ((double) (Math.round(((double) (r3 - f125J0)) - r7) + f125J0)) + ((-d2) / 360.0d) + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
