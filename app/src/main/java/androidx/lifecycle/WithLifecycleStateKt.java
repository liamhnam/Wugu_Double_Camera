...
public final class WithLifecycleStateKt {
    public static final <R> Object withStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state, zIsDispatchNeeded, immediate, new C04532(function0), continuation);
    }
    ...
    @Metadata(m1292d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, m1293d2 = {"<anonymous>", "R", "invoke", "()Ljava/lang/Object;"}, m1294k = 3, m1295mv = {1, 8, 0}, m1297xi = 176)
    public static final class C04532<R> extends Lambda implements Function0<R> {
        final Function0<R> $block;

        public C04532(Function0<? extends R> function0) {
            super(0);
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(final Lifecycle lifecycle, final Lifecycle.State state, boolean z, final CoroutineDispatcher coroutineDispatcher, final Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        final ?? r2 = new LifecycleEventObserver() {
            @Override
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(state)) {
                    ...
                    try {
                        ...
                        objM1772constructorimpl = Result.m1772constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM1772constructorimpl = Result.m1772constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(objM1772constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m1772constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
            coroutineDispatcher.mo3346dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() {
                @Override
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() {
            ...
            public final void invoke2(Throwable th) {
                if (coroutineDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    final C0452xfdb59cc4 c0452xfdb59cc4 = r2;
                    coroutineDispatcher2.mo3346dispatch(emptyCoroutineContext, new Runnable() {
                        @Override
                        public final void run() {
                            lifecycle2.removeObserver(c0452xfdb59cc4);
                        }
                    });
                    return;
                }
