...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    */
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (z2 || this.mCurState < 1) {
            ...
            for (int i7 = i; i7 < i2; i7++) {
                Iterator<FragmentTransaction.C0402Op> it = arrayList.get(i7).mOps.iterator();
                while (it.hasNext()) {
        ...
        if (USE_STATE_MANAGER) {
            ...
            for (int i8 = i; i8 < i2; i8++) {
                ...
                if (zBooleanValue) {
                    ...
                    Iterator<FragmentTransaction.C0402Op> it2 = backStackRecord2.mOps.iterator();
                    while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0402Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        ((Fragment) fragmentContainer.getTag(C0351R.id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
    ...
    void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if (obj instanceof ActivityResultRegistryOwner) {
            ...
            this.mStartActivityForResult = activityResultRegistry.register(str + "StartActivityForResult", new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                @Override
            ...
            this.mRequestPermissions = activityResultRegistry.register(str + "RequestPermissions", new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() {
                @Override
