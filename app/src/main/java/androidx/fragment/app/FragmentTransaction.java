...
public abstract class FragmentTransaction {
    ...
    void addOp(C0402Op c0402Op) {
        this.mOps.add(c0402Op);
        c0402Op.mEnterAnim = this.mEnterAnim;
        c0402Op.mExitAnim = this.mExitAnim;
        c0402Op.mPopEnterAnim = this.mPopEnterAnim;
        c0402Op.mPopExitAnim = this.mPopExitAnim;
    }
