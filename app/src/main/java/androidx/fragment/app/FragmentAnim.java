...
class FragmentAnim {
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0351R.animator.fragment_open_enter : C0351R.animator.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0351R.animator.fragment_fade_enter : C0351R.animator.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0351R.animator.fragment_close_enter : C0351R.animator.fragment_close_exit;
    }
