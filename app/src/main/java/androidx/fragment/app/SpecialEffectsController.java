...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        ...
        viewGroup.setTag(C0351R.id.special_effects_controller_view_tag, specialEffectsControllerCreateController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            void applyState(View view) {
                int i = C04213.f206xe493b431[ordinal()];
                if (i == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C04213.f205xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
    ...
    static class C04213 {
        ...
        static final int[] f205xb9e640f0;

        static final int[] f206xe493b431;
        ...
        static {
            ...
            try {
                f205xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f205xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f206xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f206xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f206xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
