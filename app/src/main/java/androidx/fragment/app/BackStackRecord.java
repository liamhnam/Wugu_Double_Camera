...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(i);
            switch (c0402Op.mCmd) {
                case 0:
            ...
            printWriter.print(" ");
            printWriter.println(c0402Op.mFragment);
            if (z) {
                if (c0402Op.mEnterAnim != 0 || c0402Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0402Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0402Op.mExitAnim));
                }
                if (c0402Op.mPopEnterAnim != 0 || c0402Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0402Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0402Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0402Op c0402Op = this.mOps.get(i2);
                if (c0402Op.mFragment != null) {
                    c0402Op.mFragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(TAG, "Bump nesting of " + c0402Op.mFragment + " to " + c0402Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(i2);
            int i3 = c0402Op.mFragment != null ? c0402Op.mFragment.mContainerId : 0;
            if (i3 != 0 && i3 == i) {
                return true;
            }
        }
    ...
    boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(i4);
            int i5 = c0402Op.mFragment != null ? c0402Op.mFragment.mContainerId : 0;
            if (i5 != 0 && i5 != i3) {
                for (int i6 = i; i6 < i2; i6++) {
                    BackStackRecord backStackRecord = arrayList.get(i6);
                    int size2 = backStackRecord.mOps.size();
                    for (int i7 = 0; i7 < size2; i7++) {
                        FragmentTransaction.C0402Op c0402Op2 = backStackRecord.mOps.get(i7);
                        if ((c0402Op2.mFragment != null ? c0402Op2.mFragment.mContainerId : 0) == i5) {
                            return true;
                        }
                    }
                }
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(i);
            Fragment fragment = c0402Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0402Op.mCmd) {
                case 1:
                    fragment.setAnimations(c0402Op.mEnterAnim, c0402Op.mExitAnim, c0402Op.mPopEnterAnim, c0402Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0402Op.mCmd);
                case 3:
                    fragment.setAnimations(c0402Op.mEnterAnim, c0402Op.mExitAnim, c0402Op.mPopEnterAnim, c0402Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0402Op.mCurrentMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0402Op.mCmd != 1 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
    ...
    void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(size);
            Fragment fragment = c0402Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0402Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0402Op.mOldMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0402Op.mCmd != 3 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    */
    androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0402Op) r5
            int r6 = r5.mCmd
            r7 = 1
            if (r6 == r7) goto Lb4
            r8 = 2
    ...
    */
    androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0402Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
    ...
    void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener onStartEnterTransitionListener) {
        for (int i = 0; i < this.mOps.size(); i++) {
            FragmentTransaction.C0402Op c0402Op = this.mOps.get(i);
            if (isFragmentPostponed(c0402Op)) {
                c0402Op.mFragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
            }
        }
    }

    private static boolean isFragmentPostponed(FragmentTransaction.C0402Op c0402Op) {
        Fragment fragment = c0402Op.mFragment;
