...
public class Debug {
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) && ((!(obj2 instanceof Integer) || !obj2.toString().equals(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES)) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getName(Context context, int id) {
        ...
        try {
            ...
            return LocationInfo.f2800NA + id;
        }
    }
