...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f168x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f169y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f168x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f169y;
    }
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f168x;
        rectF.top = this.mStartMotionPath.f169y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f168x;
        rectF2.top = this.mEndMotionPath.f169y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f168x - this.mStartMotionPath.f168x;
        float f2 = this.mEndMotionPath.f169y - this.mStartMotionPath.f169y;
        float f3 = this.mStartMotionPath.f168x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f169y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                ...
                dArr6[i16][0] = motionPathsArr[i16].f168x;
                dArr6[i16][1] = motionPathsArr[i16].f169y;
            }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f4 = this.mStartMotionPath.f168x + ((this.mEndMotionPath.f168x - this.mStartMotionPath.f168x) * f3);
            float f5 = f4 + 0.5f;
            int i4 = (int) f5;
            float f6 = this.mStartMotionPath.f169y + ((this.mEndMotionPath.f169y - this.mStartMotionPath.f169y) * f3) + 0.5f;
            int i5 = (int) f6;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f168x - this.mStartMotionPath.f168x;
        float f3 = this.mEndMotionPath.f169y - this.mStartMotionPath.f169y;
