...
public class MotionLabel extends View implements FloatLayout {
    ...
    public void setGravity(int gravity) {
        ...
        if ((gravity & UiPosIndexEnum.HOME_COUNTDOWN) == 0) {
            gravity |= 48;
        }
        ...
        int i = gravity & UiPosIndexEnum.HOME_COUNTDOWN;
        if (i == 48) {
            this.mTextPanY = -1.0f;
        } else if (i == 80) {
            this.mTextPanY = 1.0f;
