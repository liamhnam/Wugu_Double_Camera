...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f127id == -1 || solverVariable.f127id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f127id] == null) {
                if (solverVariable.f127id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f127id = i;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f127id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f127id = i2;
    ...
    */
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f127id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f127id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f127id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f127id) {
