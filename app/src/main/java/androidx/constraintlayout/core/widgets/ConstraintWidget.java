...
public class ConstraintWidget {
    ...
    protected int f152mX;

    protected int f153mY;
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f152mX + ", " + this.f153mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }

    public int getX() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f152mX;
        }
        return this.f152mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f153mY;
        }
        return this.f153mY;
    }
    ...
    protected int getRootX() {
        return this.f152mX + this.mOffsetX;
    }

    protected int getRootY() {
        return this.f153mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01511.f154x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    */
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C01511.f154x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    ...
    static class C01511 {
        ...
        static final int[] f154x6930e354;

        static final int[] f155x6d00e4a2;
        ...
        static {
            ...
            try {
                f155x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f155x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f155x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f154x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f154x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f152mX = constraintWidget.f152mX;
        this.f153mY = constraintWidget.f153mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f152mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f153mY);
        sb.append("\n");
