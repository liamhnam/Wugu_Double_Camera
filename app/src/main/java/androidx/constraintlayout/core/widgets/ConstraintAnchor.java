...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C01501.f151x6930e354[this.mType.ordinal()]) {
            case 1:
    ...
    static class C01501 {
        ...
        static final int[] f151x6930e354;
        ...
        static {
            ...
            try {
                f151x6930e354[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f151x6930e354[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f151x6930e354[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f151x6930e354[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f151x6930e354[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f151x6930e354[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f151x6930e354[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f151x6930e354[Type.NONE.ordinal()] = 9;
