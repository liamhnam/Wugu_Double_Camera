        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 92909918:
                    ...
                    break;
                case 97692013:
                    b = !str.equals(S_FRAME) ? (byte) -1 : SnmpConstants.SNMP_ERR_UNDOFAILED;
                    break;
                case 579057826:
                ...
                case 803192288:
                    ...
                    break;
                case 1167159411:
                    b = !str.equals(S_PIVOT_TARGET) ? (byte) -1 : SnmpConstants.SNMP_ERR_INCONSISTENTNAME;
                    break;
                case 1941332754:
                    b = !str.equals("visibility") ? (byte) -1 : SnmpConstants.SNMP_ERR_DECODING_EXC;
                    break;
                default:
                    b = -1;
                    break;
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 803192288:
                    ...
                    break;
                case 1941332754:
                    b = !str.equals("visibility") ? (byte) -1 : SnmpConstants.SNMP_ERR_UNDOFAILED;
                    break;
                default:
                    b = -1;
                    break;
