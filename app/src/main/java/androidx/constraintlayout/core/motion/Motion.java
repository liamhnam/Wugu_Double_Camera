...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f132x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f133y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f132x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f133y;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f132x;
        floatRect.top = this.mStartMotionPath.f133y;
        ...
        floatRect2.left = this.mEndMotionPath.f132x;
        floatRect2.top = this.mEndMotionPath.f133y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f132x - this.mStartMotionPath.f132x;
        float f4 = this.mEndMotionPath.f133y - this.mStartMotionPath.f133y;
        float f5 = this.mStartMotionPath.f132x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f133y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f132x;
                dArr6[i18][1] = motionPathsArr[i18].f133y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f132x + " y: " + this.mStartMotionPath.f133y + " end: x: " + this.mEndMotionPath.f132x + " y: " + this.mEndMotionPath.f133y;
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() {
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff(this.f129mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f132x + ((this.mEndMotionPath.f132x - this.mStartMotionPath.f132x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f133y + ((this.mEndMotionPath.f133y - this.mStartMotionPath.f133y) * f4) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f132x - this.mStartMotionPath.f132x;
        float f6 = this.mEndMotionPath.f133y - this.mStartMotionPath.f133y;
