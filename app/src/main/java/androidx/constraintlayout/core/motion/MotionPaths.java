...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f132x;
        float f9 = motionPaths.f133y;
        float f10 = (motionPaths2.f132x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f133y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f132x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f133y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f132x = (int) (((motionPaths.f132x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f133y = (int) (((motionPaths.f133y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f132x;
            float f11 = motionPaths.f132x;
            this.f132x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f133y;
            float f13 = motionPaths.f133y;
            this.f133y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f132x;
                float f15 = motionPaths.f132x;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f132x = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f133y;
                float f17 = motionPaths.f133y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = motionKeyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f132x;
            float f20 = motionPaths.f132x;
            this.f132x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f133y;
            float f22 = motionPaths.f133y;
            this.f133y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f132x + (this.width / 2.0f)) - motionPaths.f132x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f133y + (this.height / 2.0f)) - motionPaths.f133y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f132x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f133y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f133y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f132x;
        float f9 = motionPaths.f133y;
        float f10 = motionPaths2.f132x + (f4 / 2.0f);
        float f11 = motionPaths2.f133y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f132x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f133y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f132x = (int) (motionKeyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f133y = (int) (motionKeyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f132x;
        float f7 = motionPaths.width;
        float f8 = motionPaths.f133y;
        float f9 = motionPaths.height;
        float f10 = (motionPaths2.f132x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f133y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f132x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f133y = (int) ((f8 + f14) - f15);
        ...
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f132x + f12) - f13);
        this.f132x = f17;
        float f18 = (int) ((motionPaths.f133y + f14) - f15);
        this.f132x = f17 + ((-f11) * f16);
        this.f133y = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f132x, motionPaths.f132x);
        boolean zDiff2 = diff(this.f133y, motionPaths.f133y);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f132x;
        float fCos = this.f133y;
        float f = this.width;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f132x, this.f133y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r4];
