...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01451.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    */
    public androidx.constraintlayout.core.state.ConstraintReference bias(float r3) {
        /*
            ...
            return r2
        L5:
            int[] r0 = androidx.constraintlayout.core.state.ConstraintReference.C01451.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int i = C01451.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        switch (C01451.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
            case 1:
