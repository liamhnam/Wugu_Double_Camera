...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C01391.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
            StringBuilder sb = new StringBuilder(PDBorderStyleDictionary.STYLE_UNDERLINE);
        ...
        if (i == 4) {
            StringBuilder sb4 = new StringBuilder(Media.f729e);
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f127id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f127id - solverVariable.f127id;
    }
