...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, SnmpConstants.UINTEGER32, 13, 10, 26, 10};
    private static final byte[] PNG_CHUNK_TYPE_EXIF = {101, 88, 73, 102};
    private static final byte[] PNG_CHUNK_TYPE_IHDR = {73, 72, SnmpConstants.OPAQUE, 82};
    private static final byte[] PNG_CHUNK_TYPE_IEND = {73, SnmpConstants.NSAP_ADDRESS, 78, SnmpConstants.OPAQUE};
    private static final byte[] WEBP_SIGNATURE_1 = {82, 73, SnmpConstants.COUNTER64, SnmpConstants.COUNTER64};
    private static final byte[] WEBP_SIGNATURE_2 = {87, SnmpConstants.NSAP_ADDRESS, SnmpConstants.GAUGE, 80};
    private static final byte[] WEBP_CHUNK_TYPE_EXIF = {SnmpConstants.NSAP_ADDRESS, 88, 73, SnmpConstants.COUNTER64};
    ...
    static final byte[] EXIF_ASCII_PREFIX = {SnmpConstants.COUNTER, 83, SnmpConstants.TIMETICKS, 73, 73, 0, 0, 0};
    ...
    static {
        ...
        ExifTag[] exifTagArr7 = {new ExifTag(TAG_ORF_PREVIEW_IMAGE_START, 257, 4), new ExifTag(TAG_ORF_PREVIEW_IMAGE_LENGTH, WGL4Names.NUMBER_OF_MAC_GLYPHS, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, UiPosIndexEnum.PAYMENT_ARROW_IC, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, i7);
                        ...
                        case 10:
                            ...
                            while (i12 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i12].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
    ...
    */
    ...
    public void setAltitude(double d) {
        String str = d >= 0.0d ? PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES : IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
    ...
    public void setDateTime(Long l) {
        ...
        for (int length = string.length(); length < 3; length++) {
            string = PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES + string;
        }
