...
public final class TableInfo {
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1) {
                HashSet hashSet = new HashSet();
                while (cursorQuery.moveToNext()) {
                    if (Media.f727c.equals(cursorQuery.getString(columnIndex2))) {
                        String string = cursorQuery.getString(columnIndex);
                        boolean z = true;
    ...
    private static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
        ...
        try {
            ...
            int columnIndex3 = cursorQuery.getColumnIndex(NamingTable.TAG);
    ...
    public static final class Column {
        ...
        public int hashCode() {
            return (((((this.name.hashCode() * 31) + this.affinity) * 31) + (this.notNull ? UiPosIndexEnum.PE_BTN_NUM6_SEL : UiPosIndexEnum.PE_BG_RETAKE)) * 31) + this.primaryKeyPosition;
        }
