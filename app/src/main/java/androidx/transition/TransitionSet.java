...
public class TransitionSet extends Transition {
    ...
    @Override
    public Transition mo1527clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo1527clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo1527clone());
        }
