...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo1527clone = transition.mo1527clone();
        transitionMo1527clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo1527clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo1527clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo1527clone);
    }
    ...
    public static void m157go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    public static void m158go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo1527clone = transition.mo1527clone();
        sceneChangeSetup(viewGroup, transitionMo1527clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo1527clone);
    }
