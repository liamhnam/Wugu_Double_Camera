...
class ViewBoundsCheck {
    ...
    static final int f215GT = 1;

    static final int f216LT = 4;
    ...
    static class BoundFlags {
        ...
        boolean boundsMatch() {
            ...
            if ((i2 & UiPosIndexEnum.HOME_COUNTDOWN) != 0 && (i2 & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                return false;
            }
