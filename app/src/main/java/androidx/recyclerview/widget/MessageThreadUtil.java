...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C05061 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() {
            ...
            public void run() {
                ...
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C05061.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C05061.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C05061.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
        ...
        C05061(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C05061(mainThreadCallback);
    }

    class C05072 implements ThreadUtil.BackgroundCallback<T> {
                ...
                while (true) {
                    ...
                    if (next != null) {
                        ...
                        if (i == 1) {
                            ...
                            C05072.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C05072.this.mQueue.removeMessages(2);
                            C05072.this.mQueue.removeMessages(3);
                            C05072.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C05072.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C05072.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
        ...
        C05072(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C05072(backgroundCallback);
    }
