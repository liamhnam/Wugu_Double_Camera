...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner {
    ...
    public ComponentDialog(Context context, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ComponentDialog(Context context, int i) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() {
            ...
            public final void run() {
                ComponentDialog.m1493onBackPressedDispatcher$lambda1(this.f$0);
            }
        });
    }
    ...
    public static final void m1493onBackPressedDispatcher$lambda1(ComponentDialog this$0) {
