    ...
    public ComponentActivity() {
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() {
            ...
            public final Bundle saveState() {
                return this.f$0.m1491lambda$new$0$androidxactivityComponentActivity();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() {
            @Override
            public final void onContextAvailable(Context context) {
                this.f$0.m1492lambda$new$1$androidxactivityComponentActivity(context);
            }
        });
    }

    Bundle m1491lambda$new$0$androidxactivityComponentActivity() {
        Bundle bundle = new Bundle();
        this.mActivityResultRegistry.onSaveInstanceState(bundle);
        return bundle;
    }

    void m1492lambda$new$1$androidxactivityComponentActivity(Context context) {
