...
public final class InputConnectionCompat {
    ...
    class C02742 extends InputConnectionWrapper {
        final OnCommitContentListener val$listener;

        C02742(InputConnection inputConnection, boolean z, OnCommitContentListener onCommitContentListener) {
    ...
    static boolean lambda$createOnCommitContentListenerUsingPerformReceiveContent$0(View view, InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
        if ((i & 1) != 0) {
            try {
