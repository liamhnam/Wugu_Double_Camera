...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl23 extends Impl20 {
        ...
        public void setAppearanceLightStatusBars(boolean z) {
            if (z) {
                unsetWindowFlag(faceunity.FUAITYPE_FACEPROCESSOR_DISNEYGAN);
    ...
    private static class Impl26 extends Impl23 {
        ...
        public void setAppearanceLightNavigationBars(boolean z) {
            if (z) {
                unsetWindowFlag(faceunity.FUAITYPE_FACEPROCESSOR_FACEID);
                setWindowFlag(Integer.MIN_VALUE);
                setSystemUiFlag(16);
                return;
            }
    ...
    static class Impl30 extends Impl {
        ...
        void m140xe96d8c51(OnControllableInsetsChangedListener onControllableInsetsChangedListener, WindowInsetsController windowInsetsController, int i) {
