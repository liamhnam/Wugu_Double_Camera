...
@DebugMetadata(m1304c = "androidx.core.view.ViewGroupKt$descendants$1", m1305f = "ViewGroup.kt", m1306i = {0, 0, 0, 0, 1, 1, 1}, m1307l = {119, DNPPhotoPrint.OVERCOAT_FINISH_PMATTE12}, m1308m = "invokeSuspend", m1309n = {"$this$sequence", "$this$forEach$iv", "child", "index$iv", "$this$sequence", "$this$forEach$iv", "index$iv"}, m1310s = {"L$0", "L$1", "L$2", "I$0", "L$0", "L$1", "I$0"})
