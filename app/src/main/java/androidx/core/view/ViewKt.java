...
public final class ViewKt {
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, final Function0<Unit> action) {
        ...
        Runnable runnable = new Runnable() {
            @Override
            public final void run() {
                ViewKt.m1506postOnAnimationDelayed$lambda1(action);
            }
        };
    ...
    public static final void m1506postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
    ...
    public static final <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View view, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(view, "<this>");
