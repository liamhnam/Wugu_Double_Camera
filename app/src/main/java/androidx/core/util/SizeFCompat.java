...
public final class SizeFCompat {
    ...
    public SizeFCompat(float f, float f2) {
        this.mWidth = Preconditions.checkArgumentFinite(f, StreamInformation.KEY_WIDTH);
        this.mHeight = Preconditions.checkArgumentFinite(f2, StreamInformation.KEY_HEIGHT);
    }
