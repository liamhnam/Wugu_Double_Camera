...
public final class DisplayManagerCompat {
    ...
    public Display getDisplay(int i) {
        return Api17Impl.getDisplay((DisplayManager) this.mContext.getSystemService(IdentifyAction.display), i);
    }

    public Display[] getDisplays() {
        return Api17Impl.getDisplays((DisplayManager) this.mContext.getSystemService(IdentifyAction.display));
    }
