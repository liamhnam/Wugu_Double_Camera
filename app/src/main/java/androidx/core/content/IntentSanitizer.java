...
public class IntentSanitizer {
    ...
    static void lambda$sanitizeByFiltering$0(String str) {
    }
    ...
    static void lambda$sanitizeByThrowing$1(String str) {
    ...
    public static final class Builder {
        ...
        static boolean lambda$allowAnyComponent$10(ComponentName componentName) {
            return true;
        }

        static boolean lambda$allowExtra$12(Object obj) {
            return true;
        }

        static boolean lambda$allowExtra$14(Object obj) {
            return false;
        }

        static boolean lambda$new$0(String str) {
            return false;
        }

        static boolean lambda$new$1(Uri uri) {
            return false;
        }

        static boolean lambda$new$2(String str) {
            return false;
        }

        static boolean lambda$new$3(String str) {
            return false;
        }

        static boolean lambda$new$4(String str) {
            return false;
        }

        static boolean lambda$new$5(ComponentName componentName) {
            return false;
        }

        static boolean lambda$new$6(Uri uri) {
            return false;
        }

        static boolean lambda$new$7(ClipData clipData) {
            return false;
        }
        ...
        public Builder allowAction(Predicate<String> predicate) {
            ...
            this.mAllowedActions = this.mAllowedActions.m134or(predicate);
            return this;
        }
        ...
        public Builder allowData(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.m134or(predicate);
            return this;
        }
        ...
        public Builder allowType(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m134or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m134or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m134or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m134or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m134or(predicate);
            return this;
        }

        public Builder allowClipData(Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m134or(predicate);
            return this;
        }
        ...
        static boolean lambda$allowExtra$13(Class cls, Predicate predicate, Object obj) {
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            this.mAllowedExtras.put(str, predicate2.m134or(predicate));
            return this;
        }

        public Builder allowExtraStreamUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() {
                @Override
                public final boolean test(Object obj) {
                    return str.equals(((Uri) obj).getAuthority());
                }
