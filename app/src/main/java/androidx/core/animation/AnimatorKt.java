...
public final class AnimatorKt {
    ...
    public static Animator.AnimatorListener addListener$default(Animator animator, Function1 onEnd, Function1 onStart, Function1 onCancel, Function1 onRepeat, int i, Object obj) {
        if ((i & 1) != 0) {
            onEnd = new Function1<Animator, Unit>() {
        ...
        if ((i & 2) != 0) {
            onStart = new Function1<Animator, Unit>() {
                public final void invoke2(Animator it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                }
        ...
        if ((i & 4) != 0) {
            onCancel = new Function1<Animator, Unit>() {
                public final void invoke2(Animator it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                }
        ...
        if ((i & 8) != 0) {
            onRepeat = new Function1<Animator, Unit>() {
                public final void invoke2(Animator it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                }
