...
final class Utils {
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            return this.lowerBound != null ? "? super " + Utils.typeToString(this.lowerBound) : this.upperBound == Object.class ? LocationInfo.f2800NA : "? extends " + Utils.typeToString(this.upperBound);
        }
    }
